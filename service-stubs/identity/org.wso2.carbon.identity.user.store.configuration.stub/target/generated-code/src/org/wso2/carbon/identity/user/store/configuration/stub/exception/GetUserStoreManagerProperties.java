...
/**
 * GetUserStoreManagerProperties.java
 *
 ...
 */
            ...
            /**
            *  GetUserStoreManagerProperties bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserStoreManagerProperties
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserStoreManagerProperties",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserStoreManagerProperties",
    ...
    public static class Factory{
        ...
        */
        public static GetUserStoreManagerProperties parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserStoreManagerProperties object =
                new GetUserStoreManagerProperties();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserStoreManagerProperties".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserStoreManagerProperties)org.wso2.carbon.identity.user.store.configuration.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","className").equals(reader.getName())){
