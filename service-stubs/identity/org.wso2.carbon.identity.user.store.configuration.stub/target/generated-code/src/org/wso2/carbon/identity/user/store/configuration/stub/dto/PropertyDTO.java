 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static PropertyDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PropertyDTO object =
                new PropertyDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PropertyDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PropertyDTO)org.wso2.carbon.identity.user.store.configuration.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.configuration.store.user.identity.carbon.wso2.org/xsd","name").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.configuration.store.user.identity.carbon.wso2.org/xsd","value").equals(reader.getName())){
