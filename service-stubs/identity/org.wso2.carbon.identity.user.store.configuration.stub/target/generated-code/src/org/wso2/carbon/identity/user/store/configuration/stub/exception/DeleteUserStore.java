 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deleteUserStore",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deleteUserStore",
    ...
    public static class Factory{
        ...
        */
        public static DeleteUserStore parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteUserStore object =
                new DeleteUserStore();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deleteUserStore".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteUserStore)org.wso2.carbon.identity.user.store.configuration.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
