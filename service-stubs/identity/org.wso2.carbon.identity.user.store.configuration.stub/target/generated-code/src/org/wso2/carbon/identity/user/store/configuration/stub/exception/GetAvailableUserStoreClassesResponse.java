...
/**
 * GetAvailableUserStoreClassesResponse.java
 *
 ...
 */
            ...
            /**
            *  GetAvailableUserStoreClassesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAvailableUserStoreClassesResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://org.apache.axis2/xsd",
                "getAvailableUserStoreClassesResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAvailableUserStoreClassesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAvailableUserStoreClassesResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetAvailableUserStoreClassesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAvailableUserStoreClassesResponse object =
                new GetAvailableUserStoreClassesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAvailableUserStoreClassesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAvailableUserStoreClassesResponse)org.wso2.carbon.identity.user.store.configuration.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
