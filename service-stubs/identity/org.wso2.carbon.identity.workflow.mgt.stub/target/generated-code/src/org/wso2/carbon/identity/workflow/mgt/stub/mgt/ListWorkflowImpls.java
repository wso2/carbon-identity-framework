 ...
 */
            ...
            /**
            *  ListWorkflowImpls bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListWorkflowImpls
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listWorkflowImpls",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listWorkflowImpls",
    ...
    public static class Factory{
        ...
        */
        public static ListWorkflowImpls parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListWorkflowImpls object =
                new ListWorkflowImpls();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listWorkflowImpls".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListWorkflowImpls)org.wso2.carbon.identity.workflow.mgt.stub.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
