 ...
 */
            ...
            /**
            *  GetPrimaryOpenID bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetPrimaryOpenID
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getPrimaryOpenID",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getPrimaryOpenID",
    ...
    public static class Factory{
        ...
        */
        public static GetPrimaryOpenID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetPrimaryOpenID object =
                new GetPrimaryOpenID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getPrimaryOpenID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetPrimaryOpenID)org.wso2.carbon.identity.provider.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
