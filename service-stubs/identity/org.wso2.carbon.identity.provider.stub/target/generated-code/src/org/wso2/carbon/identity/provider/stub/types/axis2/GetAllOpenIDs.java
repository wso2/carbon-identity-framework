 ...
 */
            ...
            /**
            *  GetAllOpenIDs bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllOpenIDs
    ...
    public static class Factory{
        ...
        */
        public static GetAllOpenIDs parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllOpenIDs object =
                new GetAllOpenIDs();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllOpenIDs".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllOpenIDs)org.wso2.carbon.identity.provider.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
