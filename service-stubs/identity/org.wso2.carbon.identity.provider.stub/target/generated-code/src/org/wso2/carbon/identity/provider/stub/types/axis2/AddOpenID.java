 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static AddOpenID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddOpenID object =
                new AddOpenID();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addOpenID".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddOpenID)org.wso2.carbon.identity.provider.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
