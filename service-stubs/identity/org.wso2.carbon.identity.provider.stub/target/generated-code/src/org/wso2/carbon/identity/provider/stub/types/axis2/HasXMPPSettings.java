 ...
 */
            ...
            /**
            *  HasXMPPSettings bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class HasXMPPSettings
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":hasXMPPSettings",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "hasXMPPSettings",
    ...
    public static class Factory{
        ...
        */
        public static HasXMPPSettings parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            HasXMPPSettings object =
                new HasXMPPSettings();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"hasXMPPSettings".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (HasXMPPSettings)org.wso2.carbon.identity.provider.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
