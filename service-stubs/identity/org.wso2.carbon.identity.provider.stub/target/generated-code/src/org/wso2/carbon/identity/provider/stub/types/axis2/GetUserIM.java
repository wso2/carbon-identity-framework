 ...
 */
            ...
            /**
            *  GetUserIM bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserIM
    ...
    public static class Factory{
        ...
        */
        public static GetUserIM parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserIM object =
                new GetUserIM();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserIM".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserIM)org.wso2.carbon.identity.provider.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
