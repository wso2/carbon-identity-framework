 ...
 */
            ...
            /**
            *  GetBooleanDecision bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetBooleanDecision
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getBooleanDecision",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getBooleanDecision",
    ...
    public static class Factory{
        ...
        */
        public static GetBooleanDecision parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetBooleanDecision object =
                new GetBooleanDecision();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getBooleanDecision".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetBooleanDecision)org.wso2.carbon.identity.entitlement.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
