 ...
 */
            ...
            /**
            *  DePromotePolicy bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DePromotePolicy
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":dePromotePolicy",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "dePromotePolicy",
    ...
    public static class Factory{
        ...
        */
        public static DePromotePolicy parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DePromotePolicy object =
                new DePromotePolicy();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"dePromotePolicy".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DePromotePolicy)org.wso2.carbon.identity.entitlement.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
