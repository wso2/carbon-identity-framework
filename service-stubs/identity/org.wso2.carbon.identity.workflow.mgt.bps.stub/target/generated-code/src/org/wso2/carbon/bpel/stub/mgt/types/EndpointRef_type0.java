 ...
 */
        ...
        public  class EndpointRef_type0
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = endpointRef_type0
                ...
                */
                           ...
                           */
                           public  javax.xml.namespace.QName getService(){
                            ...
                            /**
                               ...
                               * @param param Service
                               */
                               public void setService(javax.xml.namespace.QName param){
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.bpel.stub.mgt.types.ServiceLocation localServiceLocations ;
                           ...
                           */
                           public  org.wso2.carbon.bpel.stub.mgt.types.ServiceLocation getServiceLocations(){
                               return localServiceLocations;
                           }
                            ...
                            /**
                               ...
                               */
                               public void setServiceLocations(org.wso2.carbon.bpel.stub.mgt.types.ServiceLocation param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":endpointRef_type0",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "endpointRef_type0",
                                    ...
                                    writeStartElement(null, namespace, "service", xmlWriter);
                                          ...
                                          if (localService==null){
                                              // write the nil attribute
                                                ...
                                                writeQName(localService,xmlWriter);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             
                                            if (localServiceLocations==null){
                                                 throw new org.apache.axis2.databinding.ADBException("serviceLocations cannot be null!!");
                                            }
                                           localServiceLocations.serialize(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema","serviceLocations"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
                                    ...
                                    elementList.add(localServiceLocations);
                                 if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
    ...
    public static class Factory{
        ...
        */
        public static EndpointRef_type0 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EndpointRef_type0 object =
                new EndpointRef_type0();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"endpointRef_type0".equals(type)){
                                ...
                                return (EndpointRef_type0)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list4 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema","serviceLocations").equals(reader.getName())){
                                
                                                object.setServiceLocations(org.wso2.carbon.bpel.stub.mgt.types.ServiceLocation.Factory.parse(reader));
