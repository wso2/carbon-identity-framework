 ...
 */
            ...
            /**
            *  LoadAuthorisationParams bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LoadAuthorisationParams
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":loadAuthorisationParams",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "loadAuthorisationParams",
    ...
    public static class Factory{
        ...
        */
        public static LoadAuthorisationParams parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LoadAuthorisationParams object =
                new LoadAuthorisationParams();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"loadAuthorisationParams".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LoadAuthorisationParams)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
