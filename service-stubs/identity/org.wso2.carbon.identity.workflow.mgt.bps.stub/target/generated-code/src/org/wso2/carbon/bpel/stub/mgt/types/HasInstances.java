 ...
 */
            ...
            /**
            *  HasInstances bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class HasInstances
    ...
    public static class Factory{
        ...
        */
        public static HasInstances parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            HasInstances object =
                new HasInstances();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"hasInstances".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (HasInstances)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
