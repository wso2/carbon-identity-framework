...
/**
 * FailedActivitiesForInstanceType.java
 *
 ...
 */
            ...
            /**
            *  FailedActivitiesForInstanceType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FailedActivitiesForInstanceType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = failedActivitiesForInstanceType
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":failedActivitiesForInstanceType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "failedActivitiesForInstanceType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static FailedActivitiesForInstanceType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FailedActivitiesForInstanceType object =
                new FailedActivitiesForInstanceType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"failedActivitiesForInstanceType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FailedActivitiesForInstanceType)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
