 ...
 */
            ...
            /**
            *  GetInstanceInfoIn bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetInstanceInfoIn
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getInstanceInfoIn",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getInstanceInfoIn",
    ...
    public static class Factory{
        ...
        */
        public static GetInstanceInfoIn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetInstanceInfoIn object =
                new GetInstanceInfoIn();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getInstanceInfoIn".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetInstanceInfoIn)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
