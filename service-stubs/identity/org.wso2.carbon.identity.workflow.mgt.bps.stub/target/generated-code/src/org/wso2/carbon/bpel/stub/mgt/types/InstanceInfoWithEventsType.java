...
/**
 * InstanceInfoWithEventsType.java
 *
 ...
 */
            ...
            /**
            *  InstanceInfoWithEventsType bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InstanceInfoWithEventsType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = InstanceInfoWithEventsType
                ...
                */
                        ...
                        */
                                    ...
                                    protected org.wso2.carbon.bpel.stub.mgt.types.ScopeInfoWithEventsType localRootScope ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.wso2.carbon.bpel.stub.mgt.types.ScopeInfoWithEventsType getRootScope(){
                            ...
                            /**
                               ...
                               */
                               public void setRootScope(org.wso2.carbon.bpel.stub.mgt.types.ScopeInfoWithEventsType param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":InstanceInfoWithEventsType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static InstanceInfoWithEventsType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstanceInfoWithEventsType object =
                new InstanceInfoWithEventsType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"InstanceInfoWithEventsType".equals(type)){
                                ...
                                return (InstanceInfoWithEventsType)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://wso2.org/bps/management/schema","rootScope").equals(reader.getName())){
                                                ...
                                                object.setRootScope(org.wso2.carbon.bpel.stub.mgt.types.ScopeInfoWithEventsType.Factory.parse(reader));
