 ...
 */
            ...
            /**
            *  GetSubtaskIdentifiers bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSubtaskIdentifiers
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getSubtaskIdentifiers",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getSubtaskIdentifiers",
    ...
    public static class Factory{
        ...
        */
        public static GetSubtaskIdentifiers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSubtaskIdentifiers object =
                new GetSubtaskIdentifiers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getSubtaskIdentifiers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSubtaskIdentifiers)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
