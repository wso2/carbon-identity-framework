 ...
 */
            ...
            /**
            *  RetireProcessIn bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RetireProcessIn
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":retireProcessIn",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "retireProcessIn",
    ...
    public static class Factory{
        ...
        */
        public static RetireProcessIn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetireProcessIn object =
                new RetireProcessIn();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"retireProcessIn".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetireProcessIn)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
