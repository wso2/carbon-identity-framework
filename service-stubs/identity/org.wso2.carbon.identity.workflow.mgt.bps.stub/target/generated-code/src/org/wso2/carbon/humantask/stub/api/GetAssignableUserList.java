 ...
 */
            ...
            /**
            *  GetAssignableUserList bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAssignableUserList
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAssignableUserList",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAssignableUserList",
    ...
    public static class Factory{
        ...
        */
        public static GetAssignableUserList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAssignableUserList object =
                new GetAssignableUserList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAssignableUserList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAssignableUserList)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
