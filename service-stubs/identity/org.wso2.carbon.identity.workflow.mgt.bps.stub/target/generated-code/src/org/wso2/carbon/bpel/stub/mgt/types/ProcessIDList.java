 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getPid(){
                              ...
                              /**
                               * validate the array for Pid
                               */
                              protected void validatePid(java.lang.String[] param){
                             ...
                             */
                             public void addPid(java.lang.String param){
                                   if (localPid == null){
                                   localPid = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localPid);
                               list.add(param);
                               this.localPid =
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localPidTracker){
                             if (localPid!=null) {
                                   ...
                                   for (int i = 0;i < localPid.length;i++){
                                            ...
                                            if (localPid[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "pid", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPid[i]));
                                  ...
                                  for (int i = 0;i < localPid.length;i++){
                                         ...
                                         if (localPid[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://wso2.org/bps/management/schema",
                                                                              "pid"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPid[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static ProcessIDList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProcessIDList object =
                new ProcessIDList();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProcessIDList".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProcessIDList)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://wso2.org/bps/management/schema","pid").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPid((java.lang.String[])
