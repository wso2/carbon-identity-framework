 ...
 */
            ...
            /**
            *  GetParentTaskIdentifier bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetParentTaskIdentifier
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getParentTaskIdentifier",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getParentTaskIdentifier",
    ...
    public static class Factory{
        ...
        */
        public static GetParentTaskIdentifier parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetParentTaskIdentifier object =
                new GetParentTaskIdentifier();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getParentTaskIdentifier".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetParentTaskIdentifier)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
