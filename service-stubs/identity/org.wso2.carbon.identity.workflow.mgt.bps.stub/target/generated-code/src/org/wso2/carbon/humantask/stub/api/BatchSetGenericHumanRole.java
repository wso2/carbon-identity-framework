 ...
 */
            ...
            /**
            *  BatchSetGenericHumanRole bean class
            */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns2");
                        ...
                        */
                        ...
                        /**
                        * field for OrganizationalEntity
                        */

                        
                                    protected org.wso2.carbon.humantask.stub.types.TOrganizationalEntity localOrganizationalEntity ;
                           ...
                           */
                           public  org.wso2.carbon.humantask.stub.types.TOrganizationalEntity getOrganizationalEntity(){
                               return localOrganizationalEntity;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param OrganizationalEntity
                               */
                               public void setOrganizationalEntity(org.wso2.carbon.humantask.stub.types.TOrganizationalEntity param){
                            
                                            this.localOrganizationalEntity=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":batchSetGenericHumanRole",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "batchSetGenericHumanRole",
                           xmlWriter);
                             ...
                             if (localIdentifier!=null) {
                                   ...
                                   xmlWriter.writeEndElement();
                                            ...
                                            if (localOrganizationalEntity==null){
                                                 throw new org.apache.axis2.databinding.ADBException("organizationalEntity cannot be null!!");
                                            }
                                           localOrganizationalEntity.serialize(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/bpel4people/ws-humantask/api/200803","organizationalEntity"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/bpel4people/ws-humantask/api/200803",
                                    ...
                                    elementList.add(localOrganizationalEntity);
    ...
    public static class Factory{
        ...
        */
        public static BatchSetGenericHumanRole parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BatchSetGenericHumanRole object =
                new BatchSetGenericHumanRole();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"batchSetGenericHumanRole".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BatchSetGenericHumanRole)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/bpel4people/ws-humantask/api/200803","organizationalEntity").equals(reader.getName())){
                                
                                                object.setOrganizationalEntity(org.wso2.carbon.humantask.stub.types.TOrganizationalEntity.Factory.parse(reader));
