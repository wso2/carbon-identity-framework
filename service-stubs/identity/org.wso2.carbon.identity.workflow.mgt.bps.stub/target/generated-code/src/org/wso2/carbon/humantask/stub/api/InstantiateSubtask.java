 ...
 */
            ...
            /**
            *  InstantiateSubtask bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class InstantiateSubtask
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":instantiateSubtask",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "instantiateSubtask",
    ...
    public static class Factory{
        ...
        */
        public static InstantiateSubtask parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            InstantiateSubtask object =
                new InstantiateSubtask();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"instantiateSubtask".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (InstantiateSubtask)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
