 ...
 */
                ...
                "ns1");
                        ...
                        */
                            ...
                            // Constructor
                                ...
                                protected InstanceStatus(java.lang.String value, boolean isRegisterValue) {
                                    localInstanceStatus = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localInstanceStatus, this);
                                    ...
                                    public static final java.lang.String _TERMINATED =
                                        org.apache.axis2.databinding.utils.ConverterUtil.convertToString("TERMINATED");
                                ...
                                public static final InstanceStatus ACTIVE =
                                    new InstanceStatus(_ACTIVE,true);
                            
                                public static final InstanceStatus COMPLETED =
                                    new InstanceStatus(_COMPLETED,true);
                            
                                public static final InstanceStatus TERMINATED =
                                    new InstanceStatus(_TERMINATED,true);
                            
                                public static final InstanceStatus FAILED =
                                    new InstanceStatus(_FAILED,true);
                            
                                public static final InstanceStatus SUSPENDED =
                                    new InstanceStatus(_SUSPENDED,true);
                            

                                public java.lang.String getValue() { return localInstanceStatus;}

                                public boolean equals(java.lang.Object obj) {return (obj == this);}
                                public int hashCode() { return toString().hashCode();}
                                public java.lang.String toString() {
                                
                                        return localInstanceStatus.toString();
                               ...
                               if (serializeType){
                                   ...
                                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           namespacePrefix+":InstanceStatus",
                                           xmlWriter);
                                   } else {
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                           "InstanceStatus",
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localInstanceStatus)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static InstanceStatus fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static InstanceStatus fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
        ...
        */
        public static InstanceStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"InstanceStatus" +"  cannot be null");
                                    }
