 ...
 */
            ...
            /**
            *  IsSubtaskResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsSubtaskResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isSubtaskResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isSubtaskResponse",
    ...
    public static class Factory{
        ...
        */
        public static IsSubtaskResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsSubtaskResponse object =
                new IsSubtaskResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isSubtaskResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsSubtaskResponse)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
