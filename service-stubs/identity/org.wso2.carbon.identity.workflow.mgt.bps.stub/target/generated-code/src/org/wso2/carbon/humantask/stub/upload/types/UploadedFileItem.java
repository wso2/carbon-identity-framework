 ...
 */
                ...
                package org.wso2.carbon.humantask.stub.upload.types;
        ...
        /* This type was generated from the piece of schema that had
                ...
                Namespace URI = http://services.deployer.humantask.carbon.wso2.org/xsd
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://services.deployer.humantask.carbon.wso2.org/xsd");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    namespace = "http://services.deployer.humantask.carbon.wso2.org/xsd";
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://services.deployer.humantask.carbon.wso2.org/xsd")){
                return "ns1";
            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://services.deployer.humantask.carbon.wso2.org/xsd",
                                        "dataHandler"));
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UploadedFileItem".equals(type)){
                                ...
                                return (UploadedFileItem)org.wso2.carbon.humantask.stub.upload.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.deployer.humantask.carbon.wso2.org/xsd","dataHandler").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.deployer.humantask.carbon.wso2.org/xsd","fileName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.deployer.humantask.carbon.wso2.org/xsd","fileType").equals(reader.getName())){
