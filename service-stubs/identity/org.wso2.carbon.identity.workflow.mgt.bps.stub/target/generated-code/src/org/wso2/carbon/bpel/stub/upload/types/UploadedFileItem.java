 ...
 */
                ...
                package org.wso2.carbon.bpel.stub.upload.types;
        ...
        /* This type was generated from the piece of schema that had
                ...
                Namespace URI = http://types.services.deployer.bpel.carbon.wso2.org/xsd
       ...
       public org.apache.axiom.om.OMElement getOMElement (
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://types.services.deployer.bpel.carbon.wso2.org/xsd");
                ...
                if (localDataHandlerTracker){
                                    namespace = "http://types.services.deployer.bpel.carbon.wso2.org/xsd";
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://types.services.deployer.bpel.carbon.wso2.org/xsd")){
                return "ns1";
            }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localDataHandlerTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd",
                                        "dataHandler"));
    ...
    public static class Factory{
        ...
        */
        public static UploadedFileItem parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UploadedFileItem object =
                new UploadedFileItem();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UploadedFileItem".equals(type)){
                                ...
                                return (UploadedFileItem)org.wso2.carbon.bpel.stub.upload.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd","dataHandler").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd","fileName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://types.services.deployer.bpel.carbon.wso2.org/xsd","fileType").equals(reader.getName())){
