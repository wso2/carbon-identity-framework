 ...
 */
            ...
            /**
            *  ProcessManagementException bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ProcessManagementException
    ...
    public static class Factory{
        ...
        */
        public static ProcessManagementException parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProcessManagementException object =
                new ProcessManagementException();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"processManagementException".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProcessManagementException)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
