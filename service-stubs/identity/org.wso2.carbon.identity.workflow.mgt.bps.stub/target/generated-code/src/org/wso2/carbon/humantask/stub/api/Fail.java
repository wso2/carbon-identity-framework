 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static Fail parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Fail object =
                new Fail();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"fail".equals(type)){
                                ...
                                return (Fail)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
