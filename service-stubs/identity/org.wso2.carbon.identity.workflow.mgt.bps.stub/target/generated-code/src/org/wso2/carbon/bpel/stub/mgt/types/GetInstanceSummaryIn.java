 ...
 */
            ...
            /**
            *  GetInstanceSummaryIn bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetInstanceSummaryIn
    ...
    public static class Factory{
        ...
        */
        public static GetInstanceSummaryIn parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetInstanceSummaryIn object =
                new GetInstanceSummaryIn();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getInstanceSummaryIn".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetInstanceSummaryIn)org.wso2.carbon.bpel.stub.mgt.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
