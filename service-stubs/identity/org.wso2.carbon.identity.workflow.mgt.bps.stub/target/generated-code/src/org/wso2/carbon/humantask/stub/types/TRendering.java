 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected javax.xml.namespace.QName localType ;
    ...
    public static class Factory{
        ...
        */
        public static TRendering parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TRendering object =
                new TRendering();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tRendering".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TRendering)org.wso2.carbon.humantask.stub.api.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribType!=null){
                         java.lang.String content = tempAttribType;
                                ...
                                int index = tempAttribType.indexOf(":");
                                if(index > -1){
                                     prefix = tempAttribType.substring(0,index);
                                } else {
                                ...
                                namespaceuri = reader.getNamespaceURI(prefix);
                                         ...
                                         object.setType(
                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(tempAttribType,namespaceuri));
