...
/**
 * ReadUserFieldsForUserRegistration.java
 *
 ...
 */
            ...
            /**
            *  ReadUserFieldsForUserRegistration bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReadUserFieldsForUserRegistration
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":readUserFieldsForUserRegistration",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "readUserFieldsForUserRegistration",
    ...
    public static class Factory{
        ...
        */
        public static ReadUserFieldsForUserRegistration parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReadUserFieldsForUserRegistration object =
                new ReadUserFieldsForUserRegistration();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"readUserFieldsForUserRegistration".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReadUserFieldsForUserRegistration)org.wso2.carbon.identity.user.registration.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","dialect").equals(reader.getName())){
