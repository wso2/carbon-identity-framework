 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static IsUserExist parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsUserExist object =
                new IsUserExist();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isUserExist".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsUserExist)org.wso2.carbon.identity.user.registration.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
