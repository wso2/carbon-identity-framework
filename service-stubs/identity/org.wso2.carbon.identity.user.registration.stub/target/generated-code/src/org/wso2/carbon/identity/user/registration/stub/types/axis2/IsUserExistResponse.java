 ...
 */
            ...
            /**
            *  IsUserExistResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":isUserExistResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "isUserExistResponse",
    ...
    public static class Factory{
        ...
        */
        public static IsUserExistResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsUserExistResponse object =
                new IsUserExistResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"isUserExistResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsUserExistResponse)org.wso2.carbon.identity.user.registration.stub.dto.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
