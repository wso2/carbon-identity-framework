...
/**
 * ListAllUsersWithPermission.java
 *
 ...
 */
            ...
            /**
            *  ListAllUsersWithPermission bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListAllUsersWithPermission
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listAllUsersWithPermission",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listAllUsersWithPermission",
    ...
    public static class Factory{
        ...
        */
        public static ListAllUsersWithPermission parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListAllUsersWithPermission object =
                new ListAllUsersWithPermission();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listAllUsersWithPermission".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListAllUsersWithPermission)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
