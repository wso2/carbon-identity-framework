 ...
 */
            ...
            /**
            *  GetAllPermittedRoleNames bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllPermittedRoleNames
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllPermittedRoleNames",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllPermittedRoleNames",
    ...
    public static class Factory{
        ...
        */
        public static GetAllPermittedRoleNames parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllPermittedRoleNames object =
                new GetAllPermittedRoleNames();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllPermittedRoleNames".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllPermittedRoleNames)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
