        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns3");
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getPermissions(){
                               ...
                               */
                              protected void validatePermissions(java.lang.String[] param){
                             ...
                             * @param param java.lang.String
                             */
                             public void addPermissions(java.lang.String param){
                                   if (localPermissions == null){
                                   localPermissions = new java.lang.String[]{};
                                   }
                        ...
                        /**
                        * field for IsSharedRole
                        */

                        
                                    protected boolean localIsSharedRole ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localIsSharedRoleTracker = false ;

                           public boolean isIsSharedRoleSpecified(){
                               return localIsSharedRoleTracker;
                           }
                           ...
                           */
                           public  boolean getIsSharedRole(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IsSharedRole
                               */
                               public void setIsSharedRole(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       localIsSharedRoleTracker =
                                       true;
                                   
                                            this.localIsSharedRole=param;
                ...
                if (localRoleNameTracker){
                             ...
                             if (localUserList!=null) {
                                   ...
                                   for (int i = 0;i < localUserList.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://org.apache.axis2/xsd", "userList", xmlWriter);
                             ...
                             if (localPermissions!=null) {
                                   ...
                                   for (int i = 0;i < localPermissions.length;i++){
                                            ...
                                            if (localPermissions[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "permissions", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPermissions[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://org.apache.axis2/xsd", "permissions", xmlWriter);
                        ...
                        } if (localIsSharedRoleTracker){
                                    namespace = "http://org.apache.axis2/xsd";
                                    writeStartElement(null, namespace, "isSharedRole", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("isSharedRole cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsSharedRole));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localRoleNameTracker){
                            ...
                            if (localPermissions!=null){
                                  for (int i = 0;i < localPermissions.length;i++){
                                         ...
                                         if (localPermissions[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://org.apache.axis2/xsd",
                                                                              "permissions"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localPermissions[i]));
                                          } else {
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIsSharedRole));
                            }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addRole".equals(type)){
                                ...
                                return (AddRole)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","userList").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://org.apache.axis2/xsd","userList").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","permissions").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://org.apache.axis2/xsd","permissions").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setPermissions((java.lang.String[])
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","isSharedRole").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"isSharedRole" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setIsSharedRole(
