 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setUserClaimValues",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setUserClaimValues",
    ...
    public static class Factory{
        ...
        */
        public static SetUserClaimValues parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetUserClaimValues object =
                new SetUserClaimValues();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setUserClaimValues".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetUserClaimValues)org.wso2.carbon.user.mgt.multiplecredentials.stub.types.carbon.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(org.wso2.carbon.user.mgt.multiplecredentials.stub.types.carbon.ClaimValue.Factory.parse(reader));
                                                                }
