 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  org.wso2.carbon.user.mgt.multiplecredentials.stub.types.Credential[] getCredential(){
                              ...
                              /**
                               * validate the array for Credential
                               */
                              protected void validateCredential(org.wso2.carbon.user.mgt.multiplecredentials.stub.types.Credential[] param){
                             ...
                             */
                             public void addCredential(org.wso2.carbon.user.mgt.multiplecredentials.stub.types.Credential param){
                                   if (localCredential == null){
                                   localCredential = new org.wso2.carbon.user.mgt.multiplecredentials.stub.types.Credential[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localCredential);
                               list.add(param);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localCredentialTracker){
                                       if (localCredential!=null){
                                            for (int i = 0;i < localCredential.length;i++){
                                                if (localCredential[i] != null){
                                                 localCredential[i].serialize(new javax.xml.namespace.QName("http://multiplecredentials.mgt.user.carbon.wso2.org","credential"),
                                                           xmlWriter);
                                                } else {
                                 ...
                                 for (int i = 0;i < localCredential.length;i++){
                                    ...
                                    if (localCredential[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://multiplecredentials.mgt.user.carbon.wso2.org",
                                                                          "credential"));
                                         elementList.add(localCredential[i]);
                                    } else {
    ...
    public static class Factory{
        ...
        */
        public static AddUsers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddUsers object =
                new AddUsers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addUsers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddUsers)org.wso2.carbon.user.mgt.multiplecredentials.stub.types.carbon.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://multiplecredentials.mgt.user.carbon.wso2.org","credential").equals(reader.getName())){
                                                        ...
                                                        object.setCredential((org.wso2.carbon.user.mgt.multiplecredentials.stub.types.Credential[])
