 ...
 */
            ...
            /**
            *  GetUsersOfRole bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUsersOfRole
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUsersOfRole",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUsersOfRole",
    ...
    public static class Factory{
        ...
        */
        public static GetUsersOfRole parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUsersOfRole object =
                new GetUsersOfRole();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUsersOfRole".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUsersOfRole)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
