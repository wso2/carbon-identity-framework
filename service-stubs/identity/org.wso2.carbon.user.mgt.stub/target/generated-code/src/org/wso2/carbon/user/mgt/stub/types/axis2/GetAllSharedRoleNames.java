 ...
 */
            ...
            /**
            *  GetAllSharedRoleNames bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllSharedRoleNames
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllSharedRoleNames",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllSharedRoleNames",
    ...
    public static class Factory{
        ...
        */
        public static GetAllSharedRoleNames parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllSharedRoleNames object =
                new GetAllSharedRoleNames();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllSharedRoleNames".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllSharedRoleNames)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
