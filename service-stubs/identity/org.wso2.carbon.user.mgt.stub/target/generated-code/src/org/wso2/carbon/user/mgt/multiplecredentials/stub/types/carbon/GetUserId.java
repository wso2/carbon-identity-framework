                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserId".equals(type)){
                                ...
                                return (GetUserId)org.wso2.carbon.user.mgt.multiplecredentials.stub.types.carbon.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
