 ...
 */
            ...
            /**
            *  GetRolesOfUser bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRolesOfUser
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getRolesOfUser",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getRolesOfUser",
    ...
    public static class Factory{
        ...
        */
        public static GetRolesOfUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRolesOfUser object =
                new GetRolesOfUser();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getRolesOfUser".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRolesOfUser)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
