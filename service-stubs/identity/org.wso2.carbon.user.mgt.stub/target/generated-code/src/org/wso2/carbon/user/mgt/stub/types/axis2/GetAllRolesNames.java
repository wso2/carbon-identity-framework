 ...
 */
            ...
            /**
            *  GetAllRolesNames bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllRolesNames
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAllRolesNames",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAllRolesNames",
    ...
    public static class Factory{
        ...
        */
        public static GetAllRolesNames parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllRolesNames object =
                new GetAllRolesNames();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAllRolesNames".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllRolesNames)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
