 ...
 */
            ...
            /**
            *  AddRemoveRolesOfUser bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddRemoveRolesOfUser
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addRemoveRolesOfUser",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addRemoveRolesOfUser",
                ...
                if (localUserNameTracker){
                             ...
                             if (localNewRoles!=null) {
                                   ...
                                   for (int i = 0;i < localNewRoles.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://org.apache.axis2/xsd", "newRoles", xmlWriter);
                             ...
                             if (localDeletedRoles!=null) {
                                   ...
                                   for (int i = 0;i < localDeletedRoles.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "http://org.apache.axis2/xsd", "deletedRoles", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static AddRemoveRolesOfUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddRemoveRolesOfUser object =
                new AddRemoveRolesOfUser();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addRemoveRolesOfUser".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddRemoveRolesOfUser)org.wso2.carbon.user.api.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","newRoles").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://org.apache.axis2/xsd","newRoles").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","deletedRoles").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://org.apache.axis2/xsd","deletedRoles").equals(reader.getName())){
