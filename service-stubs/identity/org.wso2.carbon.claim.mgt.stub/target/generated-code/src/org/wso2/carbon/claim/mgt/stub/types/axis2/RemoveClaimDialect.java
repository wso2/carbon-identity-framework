 ...
 */
            ...
            /**
            *  RemoveClaimDialect bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RemoveClaimDialect
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":removeClaimDialect",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "removeClaimDialect",
    ...
    public static class Factory{
        ...
        */
        public static RemoveClaimDialect parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RemoveClaimDialect object =
                new RemoveClaimDialect();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"removeClaimDialect".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RemoveClaimDialect)org.wso2.carbon.claim.mgt.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
