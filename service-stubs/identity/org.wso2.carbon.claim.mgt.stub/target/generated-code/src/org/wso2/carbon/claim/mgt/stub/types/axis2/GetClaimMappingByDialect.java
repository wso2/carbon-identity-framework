 ...
 */
            ...
            /**
            *  GetClaimMappingByDialect bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetClaimMappingByDialect
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getClaimMappingByDialect",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getClaimMappingByDialect",
    ...
    public static class Factory{
        ...
        */
        public static GetClaimMappingByDialect parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetClaimMappingByDialect object =
                new GetClaimMappingByDialect();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getClaimMappingByDialect".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetClaimMappingByDialect)org.wso2.carbon.claim.mgt.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
