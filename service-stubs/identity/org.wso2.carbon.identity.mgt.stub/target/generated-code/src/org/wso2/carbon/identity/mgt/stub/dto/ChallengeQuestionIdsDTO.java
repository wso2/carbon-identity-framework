 ...
 */
            ...
            /**
            *  ChallengeQuestionIdsDTO bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ChallengeQuestionIdsDTO",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ChallengeQuestionIdsDTO",
                           xmlWriter);
                   }
                ...
                if (localErrorTracker){
                             ...
                             if (localIds!=null) {
                                   ...
                                   for (int i = 0;i < localIds.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://dto.mgt.identity.carbon.wso2.org/xsd", "ids", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static ChallengeQuestionIdsDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ChallengeQuestionIdsDTO object =
                new ChallengeQuestionIdsDTO();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChallengeQuestionIdsDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChallengeQuestionIdsDTO)org.wso2.carbon.captcha.mgt.beans.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd","ids").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://dto.mgt.identity.carbon.wso2.org/xsd","ids").equals(reader.getName())){
