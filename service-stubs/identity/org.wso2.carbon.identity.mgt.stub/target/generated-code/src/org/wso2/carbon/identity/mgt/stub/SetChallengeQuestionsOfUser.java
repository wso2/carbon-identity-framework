...
/**
 * SetChallengeQuestionsOfUser.java
 *
 ...
 */
            ...
            /**
            *  SetChallengeQuestionsOfUser bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SetChallengeQuestionsOfUser
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":setChallengeQuestionsOfUser",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "setChallengeQuestionsOfUser",
                                       ...
                                       if (localChallengesDTOs!=null){
                                            for (int i = 0;i < localChallengesDTOs.length;i++){
                                                if (localChallengesDTOs[i] != null){
                                                 localChallengesDTOs[i].serialize(new javax.xml.namespace.QName("http://services.mgt.identity.carbon.wso2.org","challengesDTOs"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://services.mgt.identity.carbon.wso2.org", "challengesDTOs", xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static SetChallengeQuestionsOfUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SetChallengeQuestionsOfUser object =
                new SetChallengeQuestionsOfUser();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"setChallengeQuestionsOfUser".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SetChallengeQuestionsOfUser)org.wso2.carbon.identity.mgt.stub.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://services.mgt.identity.carbon.wso2.org","challengesDTOs").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list2.add(org.wso2.carbon.identity.mgt.stub.dto.UserChallengesDTO.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone2){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://services.mgt.identity.carbon.wso2.org","challengesDTOs").equals(reader.getName())){
