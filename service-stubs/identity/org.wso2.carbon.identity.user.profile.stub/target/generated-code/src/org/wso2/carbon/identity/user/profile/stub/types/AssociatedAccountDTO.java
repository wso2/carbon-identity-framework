 ...
 */
            ...
            /**
            *  AssociatedAccountDTO bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AssociatedAccountDTO",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AssociatedAccountDTO",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static AssociatedAccountDTO parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AssociatedAccountDTO object =
                new AssociatedAccountDTO();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AssociatedAccountDTO".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AssociatedAccountDTO)org.wso2.carbon.identity.user.profile.stub.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.profile.user.identity.carbon.wso2.org/xsd","identityProviderName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://mgt.profile.user.identity.carbon.wso2.org/xsd","username").equals(reader.getName())){
