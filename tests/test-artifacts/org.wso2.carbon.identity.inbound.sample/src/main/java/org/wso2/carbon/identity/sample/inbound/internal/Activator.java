...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        try {
            bundleContext.registerService(GatewayRequestBuilderFactory.class,
                                          new SampleProtocolIdentityRequestBuilderFactory(), null);
            bundleContext
                    .registerService(GatewayResponseBuilderFactory.class, new SampleProtocolResponseBuilderFactory(),
                                     null);
