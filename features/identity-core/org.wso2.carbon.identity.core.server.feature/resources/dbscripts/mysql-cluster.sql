...
CREATE TABLE IF NOT EXISTS IDN_PD_CLAIM (
    ...
    PRIMARY KEY (ID),
    CONSTRAINT FK_IDN_PD_CLAIM_CREDENTIAL FOREIGN KEY (DEFINITION_ID, CREDENTIAL_ID) REFERENCES IDN_PD_CREDENTIAL(DEFINITION_ID, CREDENTIAL_ID)
)ENGINE NDB;
...
FOR EACH ROW
DELETE FROM IDN_PD_CLAIM WHERE DEFINITION_ID = OLD.DEFINITION_ID AND CREDENTIAL_ID = OLD.CREDENTIAL_ID;
