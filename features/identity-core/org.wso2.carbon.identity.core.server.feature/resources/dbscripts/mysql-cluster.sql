...
CREATE INDEX IDX_IDN_AUTH_SESSION_RECORDS_TIME
  ON IDN_AUTH_SESSION_RECORDS_STORE (TIME_CREATED);

-- IDN_AUTH_TEMP_SESSION_RECORDS_STORE --
CREATE INDEX IDX_IDN_AUTH_TMP_SESSION_RECORDS_TIME
  ON IDN_AUTH_TEMP_SESSION_RECORDS_STORE (TIME_CREATED);
