...
CREATE TABLE IF NOT EXISTS IDN_XACML_STATUS (
    ...
    TIME_INSTANCE VARCHAR(255) NOT NULL,
    MESSAGE VARCHAR(255) NOT NULL,
    POLICY_ID VARCHAR(255),
    POLICY_TENANT_ID INT,
    POLICY_VERSION INT DEFAULT -1,
    SUBSCRIBER_ID VARCHAR(255),
    SUBSCRIBER_TENANT_ID INT,
    PRIMARY KEY (STATUS_ID),
    FOREIGN KEY (SUBSCRIBER_ID, SUBSCRIBER_TENANT_ID) REFERENCES IDN_XACML_SUBSCRIBER (SUBSCRIBER_ID, TENANT_ID) ON DELETE CASCADE
);
...
-- XACML --
CREATE INDEX IDX_POLICY_TENANT_ID ON IDN_XACML_POLICY (POLICY_ID, TENANT_ID);
...
CREATE INDEX IDX_XACML_STATUS ON IDN_XACML_STATUS (SUBSCRIBER_ID, SUBSCRIBER_TENANT_ID);
