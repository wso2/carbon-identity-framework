...
CREATE TABLE IF NOT EXISTS IDN_REMOTE_LOG_PUBLISH_CONFIG (
    UUID CHAR(36) NOT NULL,
...
-- REMOTE LOG PUBLISH CONFIG --
CREATE INDEX IDX_IDN_REMOTE_LOG_PUBLISH_CONFIG_TY_TI ON IDN_REMOTE_LOG_PUBLISH_CONFIG (LOG_TYPE, TENANT_ID);
