...
CREATE TABLE IF NOT EXISTS IDN_SAML2_SERVICE_PROVIDER (
    ID INTEGER NOT NULL AUTO_INCREMENT,
    ISSUER VARCHAR(255),
    DEFAULT_ASSERTION_CONSUMER_URL VARCHAR(2048),
    ...
    ATTR_PROFILE_ENABLED BOOLEAN,
    ATTR_SERVICE_INDEX VARCHAR(255),
    SLO_PROFILE_ENABLED BOOLEAN,
    ...
    QUERY_REQUEST_PROFILE_ENABLED BOOLEAN,
    ECP_ENABLED BOOLEAN,
    ARTIFACT_BINDING_ENABLED BOOLEAN,
