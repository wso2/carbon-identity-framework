...
CREATE TABLE IF NOT EXISTS IDN_SAML2_SSO (
    ID CHAR(36) NOT NULL,
    TENANT_UUID CHAR(36) NOT NULL,
    ISSUER VARCHAR(255) NOT NULL,
    DEFAULT_ASSERTION_CONSUMER_URL VARCHAR(255),
    ISSUER_CERT_ALIAS VARCHAR(255),
    NAME_ID_FORMAT VARCHAR(255),
    SIGNING_ALGORITHM VARCHAR(255),
    DIGEST_ALGORITHM VARCHAR(255),
    ASSERTION_ENCRYPTION_ALGORITHM VARCHAR(255),
    KEY_ENCRYPTION_ALGORITHM VARCHAR(255),
    ENABLE_SINGLE_LOGOUT BOOLEAN,
    ENABLE_SIGN_RESPONSE BOOLEAN,
    ENABLE_ASSERTION_QUERY_REQUEST_PROFILE BOOLEAN,
    ENABLE_SAML2_ARTIFACT_BINDING BOOLEAN,
    ENABLE_SIGN_ASSERTIONS BOOLEAN,
    ENABLE_ECP BOOLEAN,
    ENABLE_ATTRIBUTES_BY_DEFAULT BOOLEAN,
    ENABLE_IDP_INIT_SSO BOOLEAN,
    ENABLE_IDP_INIT_SLO BOOLEAN,
    ENABLE_ENCRYPTED_ASSERTION BOOLEAN,
    VALIDATE_SIGNATURE_IN_REQUESTS BOOLEAN,
    VALIDATE_SIGNATURE_IN_ARTIFACT_RESOLVE BOOLEAN,
    PRIMARY KEY (ID),
    UNIQUE(TENANT_UUID, ISSUER)
);

CREATE TABLE IF NOT EXISTS IDN_SAML2_SSO_ATTRIBUTE (
    ID CHAR(36) NOT NULL,
    SAML2_SSO_ID CHAR(36) NOT NULL,
    ATTR_NAME VARCHAR(255) NOT NULL,
    ATTR_VALUE VARCHAR(255) NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (SAML2_SSO_ID) REFERENCES IDN_SAML2_SSO(ID) ON DELETE CASCADE
);
