...
CREATE TABLE IF NOT EXISTS SP_AUTH_GRAPH (
            ID INTEGER NOT NULL AUTO_INCREMENT,
            TENANT_ID INTEGER NOT NULL,
            APP_ID INTEGER NOT NULL ,
            NAME VARCHAR(255) NOT NULL,
...
ALTER TABLE SP_AUTH_GRAPH ADD CONSTRAINT APPLICATION_ID_CONSTRAINT_GRAPH FOREIGN KEY (APP_ID) REFERENCES SP_APP (ID) ON DELETE CASCADE;
