...
CREATE TABLE IF NOT EXISTS IDN_DIALECT(
  IDN_ID INTEGER NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM(
  ...
  IDN_TENANT_ID INTEGER DEFAULT 0,
  FOREIGN KEY(IDN_DIALECT_ID, IDN_TENANT_ID) REFERENCES IDN_DIALECT(IDN_ID, IDN_TENANT_ID),
  PRIMARY KEY (IDN_ID, IDN_TENANT_ID)
);

CREATE TABLE IDN_CLAIM_META_DATA (
  IDN_ID int(11) NOT NULL AUTO_INCREMENT,
  IDN_CLAIM_ID int(11) NOT NULL,
  IDN_TENANT_ID int(11) DEFAULT 0,
...
CREATE TABLE IDN_CLAIM_MAPPING (
  IDN_ID int(11) NOT NULL AUTO_INCREMENT,
  IDN_LOCAL_CLAIM_ID int(11) NOT NULL,
  IDN_TENANT_ID int(11) DEFAULT 0,
  IDN_ADDITIONAL_CLAIM_ID int(11) NOT NULL,
  PRIMARY KEY (IDN_ID),
