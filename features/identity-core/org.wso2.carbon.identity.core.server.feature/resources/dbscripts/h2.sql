...
CREATE TABLE IF NOT EXISTS IDN_NOTIF_TEMPLATE_TYPE (
    ID CHAR(36) NOT NULL,
    DISPLAY_NAME VARCHAR(255) NOT NULL,
    ...
    PRIMARY KEY (ID),
    UNIQUE (TEMPLATE_TYPE, CHANNEL, TENANT_UUID)
);

CREATE TABLE IF NOT EXISTS IDN_NOTIF_TEMPLATE (
    TEMPLATE_TYPE_ID CHAR(36) NOT NULL,
    LOCALE VARCHAR(255) NOT NULL,
    CONTENT CLOB NOT NULL,
    CONTENT_TYPE VARCHAR(255) NULL,
    PRIMARY KEY (TEMPLATE_TYPE_ID, LOCALE),
