...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_DIALECT (
            ID INTEGER NOT NULL AUTO_INCREMENT,
            DIALECT_URI VARCHAR (45) NOT NULL,
            TENANT_ID INTEGER NOT NULL,
            PRIMARY KEY (ID),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPED_ATTRIBUTE (
            ...
            USER_STORE_DOMAIN_NAME VARCHAR (45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPING (
            ...
            CONSTRAINT LOCAL_TO_EXT_UNIQUE_MAPPING_CONSTRAINT UNIQUE (MAPPED_LOCAL_CLAIM_ID, TENANT_ID)
);