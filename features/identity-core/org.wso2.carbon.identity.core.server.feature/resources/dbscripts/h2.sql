...
CREATE TABLE IF NOT EXISTS IDN_SAML2_SERVICE_PROVIDER (
    ...
    SIGN_RESPONSE VARCHAR(1),
    SIGNING_ALGO VARCHAR(255),
    DIGEST_ALGO VARCHAR(255),
    ENCRYPT_ASSERTION CHAR(1),
    ASSERTION_ENCRYPTION_ALGO VARCHAR(255),
    KEY_ENCRYPTION_ALGO VARCHAR(255),
    ATTR_PROFILE_ENABLED CHAR(1),
    ATTR_SERVICE_INDEX VARCHAR(255),
    SLO_PROFILE_ENABLED CHAR(1),
    ...
    QUERY_REQUEST_PROFILE_ENABLED CHAR(1),
    ECP_ENABLED CHAR(1),
    ARTIFACT_BINDING_ENABLED CHAR(1),
