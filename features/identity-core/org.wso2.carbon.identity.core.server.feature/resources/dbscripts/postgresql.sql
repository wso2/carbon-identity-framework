...
CREATE SEQUENCE IF NOT EXISTS VC_CONFIG_CURSOR_KEY_SEQ;
CREATE TABLE IF NOT EXISTS VC_CONFIG (
    ID CHAR(36) NOT NULL,
    CURSOR_KEY INTEGER DEFAULT NEXTVAL('VC_CONFIG_CURSOR_KEY_SEQ'),
    TENANT_ID INTEGER NOT NULL,
    IDENTIFIER VARCHAR(255) NOT NULL,
    DISPLAY_NAME VARCHAR(255) NOT NULL,
    SCOPE VARCHAR(255) NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS VC_CONFIG_CLAIM_SEQ;
CREATE TABLE IF NOT EXISTS VC_CONFIG_CLAIM (
    ID INTEGER DEFAULT NEXTVAL('VC_CONFIG_CLAIM_SEQ'),
...
CREATE SEQUENCE IF NOT EXISTS VC_OFFER_CURSOR_KEY_SEQ;
CREATE TABLE IF NOT EXISTS VC_OFFER (
    OFFER_ID CHAR(36) NOT NULL,
    CURSOR_KEY INTEGER DEFAULT NEXTVAL('VC_OFFER_CURSOR_KEY_SEQ'),
    TENANT_ID INTEGER NOT NULL,
    DISPLAY_NAME VARCHAR(255) NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS VC_OFFER_CREDENTIAL_CONFIG_SEQ;
CREATE TABLE IF NOT EXISTS VC_OFFER_CREDENTIAL_CONFIG (
    ID INTEGER DEFAULT NEXTVAL('VC_OFFER_CREDENTIAL_CONFIG_SEQ'),
    OFFER_ID CHAR(36) NOT NULL,
    CONFIG_ID CHAR(36) NOT NULL,
    TENANT_ID INTEGER NOT NULL,
    PRIMARY KEY (ID),
