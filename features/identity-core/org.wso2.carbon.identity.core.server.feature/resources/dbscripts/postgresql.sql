...
DROP TABLE IF EXISTS IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT;
DROP SEQUENCE IF EXISTS IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT_SEQ;
CREATE SEQUENCE IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT_SEQ;
CREATE TABLE IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT (
	ID INTEGER NOT NULL DEFAULT NEXTVAL('IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT_SEQ'),
	INVITATION_ID VARCHAR(40) NOT NULL,
...
DROP TABLE IF EXISTS IDN_ORG_USER_ASSOCIATION;
