...
DROP TABLE IF EXISTS IDN_WEBHOOK_EVENTS;
DROP SEQUENCE IF EXISTS IDN_WEBHOOK_EVENTS_SEQ;
CREATE SEQUENCE IDN_WEBHOOK_EVENTS_SEQ;
CREATE TABLE IDN_WEBHOOK_EVENTS (
    ID INTEGER NOT NULL DEFAULT NEXTVAL('IDN_WEBHOOK_EVENTS_SEQ'),
