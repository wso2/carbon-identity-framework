...
CREATE SEQUENCE IF NOT EXISTS IDN_ORG_CONNECTION_ASSOCIATION_PK_SEQ;
CREATE TABLE IF NOT EXISTS IDN_ORG_CONNECTION_ASSOCIATION (
    ID                          INTEGER DEFAULT NEXTVAL('IDN_ORG_CONNECTION_ASSOCIATION_PK_SEQ'),
...
CREATE SEQUENCE IF NOT EXISTS IDN_PD_CURSOR_KEY_SEQ;
CREATE TABLE IF NOT EXISTS IDN_PRESENTATION_DEFINITION (
    ID            CHAR(36)      NOT NULL,
    CURSOR_KEY    INTEGER       DEFAULT NEXTVAL('IDN_PD_CURSOR_KEY_SEQ'),
    IDENTIFIER    VARCHAR(255)  NOT NULL,
    DISPLAY_NAME  VARCHAR(255)  NOT NULL,
    DESCRIPTION   VARCHAR(1024),
    TENANT_ID     INTEGER       NOT NULL,
...
CREATE TABLE IF NOT EXISTS IDN_PD_CREDENTIAL (
    ...
    ENFORCE_TRUSTED_ISSUER  BOOLEAN       DEFAULT FALSE,
    TRUSTED_CAS             TEXT,
