...
DROP TABLE IF EXISTS IDN_OIDC_REQUEST_OBJECT;
DROP SEQUENCE IF EXISTS IDN_OIDC_REQUEST_OBJECT_SEQ;
CREATE SEQUENCE IDN_OIDC_REQUEST_OBJECT_SEQ;
CREATE TABLE IDN_OIDC_REQUEST_OBJECT (
  ID INTEGER DEFAULT NEXTVAL('IDN_OIDC_REQUEST_OBJECT_SEQ'),
  CONSUMER_KEY_ID INTEGER ,
  CODE_ID VARCHAR(255) ,
  TOKEN_ID VARCHAR(255) ,
  JWT BLOB ,
