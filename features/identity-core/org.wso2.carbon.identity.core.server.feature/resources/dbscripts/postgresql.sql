...
DROP TABLE IF EXISTS IDN_DIALECT;
DROP SEQUENCE IF EXISTS IDN_DIALECT_SEQ;
CREATE SEQUENCE IDN_DIALECT_SEQ;
CREATE TABLE IF NOT EXISTS IDN_DIALECT(
  IDN_ID INTEGER DEFAULT NEXTVAL('IDN_DIALECT_SEQ'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM(
  IDN_ID INTEGER DEFAULT NEXTVAL('IDN_CLAIM_SEQ'),
...
DROP TABLE IF EXISTS IDN_CLAIM_META_DATA;
DROP SEQUENCE IF EXISTS IDN_CLAIM_META_DATA_SEQ;
CREATE SEQUENCE IDN_CLAIM_META_DATA_SEQ;
CREATE TABLE IF NOT EXISTS IDN_CLAIM_META_DATA (
  IDN_ID INTEGER DEFAULT NEXTVAL('IDN_CLAIM_META_DATA_SEQ'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPING (
  IDN_ID INTEGER DEFAULT NEXTVAL('IDN_CLAIM_MAPPING_SEQ'),
...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPED_ATTRIBUTE (
  IDN_ID INTEGER DEFAULT NEXTVAL('IDN_CLAIM_MAPPED_ATTRIBUTE_SEQ'),
  IDN_CLAIM_ID INTEGER NOT NULL,
  IDN_TENANT_ID INTEGER DEFAULT 0,
