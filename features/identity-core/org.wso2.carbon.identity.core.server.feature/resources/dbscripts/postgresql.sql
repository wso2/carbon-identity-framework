...
DROP TABLE IF EXISTS IDP_OIDC_PROPERTY;
DROP SEQUENCE IF EXISTS IDP_OIDC_PROPERTY_SEQ;
CREATE SEQUENCE IDP_OIDC_PROPERTY_SEQ;
CREATE TABLE IDP_OIDC_PROPERTY (
  ID INTEGER DEFAULT NEXTVAL('IDP_OIDC_PROPERTY_SEQ'),
  TENANT_ID  INTEGER,
  CONSUMER_KEY  VARCHAR(255) ,
  PROPERTY_KEY  VARCHAR(255) NOT NULL,
  PROPERTY_VALUE  VARCHAR(2047) ,
...
CREATE TABLE IIDN_OIDC_REQ_OBJECT_REFERENCE (
...
DROP TABLE IF EXISTS IDN_OIDC_REQ_OBJECT_CLAIM_VALUES;
