...
DROP TABLE IF EXISTS IDN_XACML_CONFIG;
...
DROP TABLE IF EXISTS IDN_XACML_POLICY;
...
DROP TABLE IF EXISTS IDN_XACML_POLICY_ATTRIBUTE;
DROP SEQUENCE IF EXISTS IDN_XACML_POLICY_ATTRIBUTE_SEQ;
CREATE SEQUENCE IF NOT EXISTS IDN_XACML_POLICY_ATTRIBUTE_SEQ;
CREATE TABLE IF NOT EXISTS IDN_XACML_POLICY_ATTRIBUTE (
    ID INTEGER DEFAULT NEXTVAL('IDN_XACML_POLICY_ATTRIBUTE_SEQ') PRIMARY KEY,
...
DROP TABLE IF EXISTS IDN_XACML_POLICY_EDITOR_DATA;
DROP SEQUENCE IF EXISTS IDN_XACML_POLICY_EDITOR_DATA_SEQ;
CREATE SEQUENCE IF NOT EXISTS IDN_XACML_POLICY_EDITOR_DATA_SEQ;
CREATE TABLE IF NOT EXISTS IDN_XACML_POLICY_EDITOR_DATA (
    ID INTEGER DEFAULT NEXTVAL('IDN_XACML_POLICY_EDITOR_DATA_SEQ') PRIMARY KEY,
    DATA VARCHAR(500),
...
DROP TABLE IF EXISTS IDN_XACML_POLICY_REFERENCE;
...
DROP TABLE IF EXISTS IDN_XACML_POLICY_SET_REFERENCE;
...
DROP TABLE IF EXISTS IDN_XACML_SUBSCRIBER;
...
DROP TABLE IF EXISTS IDN_XACML_SUBSCRIBER_PROPERTY;
...
DROP TABLE IF EXISTS IDN_XACML_SUBSCRIBER_STATUS;
DROP SEQUENCE IF EXISTS IDN_XACML_SUBSCRIBER_STATUS_SEQ;
CREATE SEQUENCE IF NOT EXISTS IDN_XACML_SUBSCRIBER_STATUS_SEQ;
CREATE TABLE IF NOT EXISTS IDN_XACML_SUBSCRIBER_STATUS (
    ID INTEGER DEFAULT NEXTVAL('IDN_XACML_SUBSCRIBER_STATUS_SEQ') PRIMARY KEY,
    TYPE VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS IDN_XACML_POLICY_STATUS;
DROP SEQUENCE IF EXISTS IDN_XACML_POLICY_STATUS_SEQ;
CREATE SEQUENCE IF NOT EXISTS IDN_XACML_POLICY_STATUS_SEQ;
CREATE TABLE IF NOT EXISTS IDN_XACML_POLICY_STATUS (
    ID INTEGER DEFAULT NEXTVAL('IDN_XACML_POLICY_STATUS_SEQ') PRIMARY KEY,
    TYPE VARCHAR(255) NOT NULL,
    IS_SUCCESS BOOLEAN NOT NULL DEFAULT FALSE,
    USERNAME VARCHAR(255) NOT NULL,
    TARGET VARCHAR(255) NOT NULL,
