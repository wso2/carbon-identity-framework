...
DROP TABLE IF EXISTS SP_CONSENT_PURPOSE_ASSOC;
DROP SEQUENCE IF EXISTS SP_CONSENT_PUR_SEQ;
CREATE SEQUENCE SP_CONSENT_PUR_SEQ;
CREATE TABLE SP_CONSENT_PURPOSE_ASSOC (
  ID             INTEGER      NOT NULL DEFAULT NEXTVAL('SP_CONSENT_PUR_SEQ'),
  TENANT_ID      INTEGER      NOT NULL,
  APP_ID         INTEGER      NOT NULL,
