...
DROP TABLE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES_PK_SEQ;
CREATE SEQUENCE IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES_PK_SEQ;
...
DROP TABLE IF EXISTS WF_WORKFLOW_APPROVAL_RELATION;
...
DROP TABLE IF EXISTS WF_WORKFLOW_APPROVAL_STATE;
...
DROP TABLE IF EXISTS IDN_WEBHOOK;
DROP SEQUENCE IF EXISTS IDN_WEBHOOK_SEQ;
CREATE SEQUENCE IDN_WEBHOOK_SEQ;
...
DROP TABLE IF EXISTS IDN_WEBHOOK_CHANNELS;
DROP SEQUENCE IF EXISTS IDN_WEBHOOK_CHANNELS_SEQ;
CREATE SEQUENCE IDN_WEBHOOK_CHANNELS_SEQ;
...
DROP TABLE IF EXISTS IDN_WEBHOOK_TOPIC;
DROP SEQUENCE IF EXISTS IDN_WEBHOOK_TOPIC_SEQ;
CREATE SEQUENCE IDN_WEBHOOK_TOPIC_SEQ;
...
DROP TABLE IF EXISTS IDN_WEBHOOK_METADATA;
DROP SEQUENCE IF EXISTS IDN_WEBHOOK_METADATA_SEQ;
CREATE SEQUENCE IDN_WEBHOOK_METADATA_SEQ;
CREATE TABLE IDN_WEBHOOK_METADATA (
    ID INTEGER NOT NULL DEFAULT NEXTVAL('IDN_WEBHOOK_METADATA_SEQ'),
    PROPERTY_NAME VARCHAR(100) NOT NULL,
    PROPERTY_TYPE VARCHAR(10) NOT NULL,
    PRIMITIVE_VALUE VARCHAR(255),
    OBJECT_VALUE BYTEA,
...
DROP TABLE IF EXISTS APP_GROUP_ASSOCIATION;
DROP SEQUENCE IF EXISTS APP_GROUP_ASSOCIATION_SEQ;
CREATE SEQUENCE APP_GROUP_ASSOCIATION_SEQ;
...
DROP TABLE IF EXISTS IDN_FLOW_NODE;
...
DROP TABLE IF EXISTS IDN_FLOW_NODE_MAPPING;
...
DROP TABLE IF EXISTS IDN_FLOW_PAGE;
...
DROP TABLE IF EXISTS IDN_FLOW_PAGE_META;
...
DROP TABLE IF EXISTS IDN_FLOW_NODE_EXECUTOR;
...
DROP TABLE IF EXISTS IDN_FLOW_NODE_EXECUTOR_META;
...
DROP TABLE IF EXISTS IDN_FLOW_CONTEXT_STORE;
...
DROP TABLE IF EXISTS IDN_ASYNC_OPERATION_STATUS;
DROP SEQUENCE IF EXISTS IDN_ASYNC_OPERATION_STATUS_SEQ;
CREATE SEQUENCE IDN_ASYNC_OPERATION_STATUS_SEQ;
...
DROP TABLE IF EXISTS IDN_ASYNC_OPERATION_STATUS_UNIT;
DROP SEQUENCE IF EXISTS IDN_ASYNC_OPERATION_STATUS_UNIT_SEQ;
CREATE SEQUENCE IDN_ASYNC_OPERATION_STATUS_UNIT_SEQ;
...
DROP TABLE IF EXISTS IDN_OAUTH2_AUTHZ_CODE_ACTOR;
DROP SEQUENCE IF EXISTS IDN_OAUTH2_AUTHZ_CODE_ACTOR_SEQ;
CREATE SEQUENCE IDN_OAUTH2_AUTHZ_CODE_ACTOR_SEQ;
...
DROP TABLE IF EXISTS IDN_CUSTOM_CONTENT_ORG;
DROP SEQUENCE IF EXISTS IDN_CUSTOM_CONTENT_ORG_SEQ;
CREATE SEQUENCE IDN_CUSTOM_CONTENT_ORG_SEQ;
...
DROP TABLE IF EXISTS IDN_CUSTOM_CONTENT_APP;
DROP SEQUENCE IF EXISTS IDN_CUSTOM_CONTENT_APP_SEQ;
CREATE SEQUENCE IDN_CUSTOM_CONTENT_APP_SEQ;
