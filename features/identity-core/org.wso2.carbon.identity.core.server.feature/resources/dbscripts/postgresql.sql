...
DROP TABLE IF EXISTS IDN_ORG_NOTIFICATION_TEMPLATE;
DROP SEQUENCE IF EXISTS IDN_ORG_NOTIFICATION_TEMPLATE_SEQ;
CREATE SEQUENCE IDN_ORG_NOTIFICATION_TEMPLATE_SEQ;
CREATE TABLE IDN_ORG_NOTIFICATION_TEMPLATE (
    ID INTEGER DEFAULT NEXTVAL('IDN_ORG_NOTIFICATION_TEMPLATE_SEQ'),
...
DROP TABLE IF EXISTS IDN_APP_NOTIFICATION_TEMPLATE;
DROP SEQUENCE IF EXISTS IDN_APP_NOTIFICATION_TEMPLATE_SEQ;
CREATE SEQUENCE IDN_APP_NOTIFICATION_TEMPLATE_SEQ;
CREATE TABLE IDN_APP_NOTIFICATION_TEMPLATE (
    ID INTEGER DEFAULT NEXTVAL('IDN_APP_NOTIFICATION_TEMPLATE_SEQ'),
    TEMPLATE_KEY VARCHAR(50) NOT NULL,
    LOCALE VARCHAR(50) NOT NULL,
    SUBJECT VARCHAR(4000),
    BODY TEXT,
