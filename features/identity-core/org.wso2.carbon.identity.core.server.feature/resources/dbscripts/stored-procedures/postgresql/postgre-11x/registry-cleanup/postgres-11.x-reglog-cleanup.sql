CREATE OR REPLACE FUNCTION WSO2_REG_LOG_CLEANUP_11_x(IN operationid int) RETURNS TEXT AS $$
DECLARE
...
RAISE NOTICE 'INFO : WSO2_REG_LOG_CLEANUP_11_x() STARTED .... !';
...
IF (operationid = 4)
    ...
    IF (enableLog)
    THEN
        RAISE NOTICE 'INFO : WSO2_REG_LOG_CLEANUP_11_x TASK COMPLETED .... !';
    END IF;
END IF;
