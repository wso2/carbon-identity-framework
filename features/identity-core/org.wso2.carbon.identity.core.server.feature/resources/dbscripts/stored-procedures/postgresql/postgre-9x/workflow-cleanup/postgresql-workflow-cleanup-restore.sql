CREATE OR REPLACE FUNCTION WSO2_WF_REQUEST_CLEANUP_DATA_RESTORATION_SP() RETURNS void AS $$
...
-- ------------------------------------------
-- UTILITY FUNCTION TO DROP BACKUP TABLES
-- ------------------------------------------
CREATE OR REPLACE FUNCTION WSO2_WF_REQUEST_DROP_BACKUP_TABLES() RETURNS void AS $$
DECLARE
    enableLog boolean;
    tablecount int;
BEGIN
...
-- SELECT WSO2_WF_REQUEST_CLEANUP_DATA_RESTORATION_SP();

-- To drop backup tables after successful restoration:
-- SELECT WSO2_WF_REQUEST_DROP_BACKUP_TABLES();
