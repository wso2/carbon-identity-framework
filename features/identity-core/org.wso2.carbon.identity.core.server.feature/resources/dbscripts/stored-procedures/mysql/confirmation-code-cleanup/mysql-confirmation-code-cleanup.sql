...
BEGIN
    ...
    CONFIRMATION_CHUNK_LOOP : WHILE (chunkCount > 0) DO
        ...
        CREATE TABLE IDN_RECOVERY_FLOW_DATA_CHUNK_TMP AS SELECT RECOVERY_FLOW_ID FROM IDN_RECOVERY_FLOW_DATA WHERE (cleanUpDateTimeLimit > TIME_CREATED) LIMIT chunkSize;
        SELECT row_count() INTO chunkCount;
