...
CREATE TABLE IDN_PRESENTATION_DEFINITION (
    ...
    CONSTRAINT IDN_PD_NAME_TENANT_UNQ UNIQUE (NAME, TENANT_ID)
)
/
...
CREATE TABLE IDN_PD_CREDENTIAL (
    ...
    CREDENTIAL_FORMAT       VARCHAR2(50)   DEFAULT 'dc+sd-jwt' NOT NULL,
    CLAIMS                  CLOB,
    ENFORCE_TRUSTED_ISSUER  CHAR(1)       DEFAULT '0',
    TRUSTED_CAS             CLOB,
    KEY_RESOLUTION_METHOD   VARCHAR2(50)   DEFAULT 'x5c',
    JWKS_URI                VARCHAR2(2048),
    ISSUER_PEM              CLOB,
    CREDENTIAL_ID           VARCHAR2(255)  NOT NULL,
    PRIMARY KEY (DEFINITION_ID, CREDENTIAL_ID),
    FOREIGN KEY (DEFINITION_ID) REFERENCES IDN_PRESENTATION_DEFINITION(DEFINITION_ID) ON DELETE CASCADE
)
/
