...
CREATE TABLE IDN_PD_CREDENTIAL (
    ...
    PURPOSE                 VARCHAR2(1024),
    ISSUER                  VARCHAR2(1024),
    CLAIMS                  CLOB,
    ISSUER_CERT             CLOB,
    TRUSTED_ISSUERS         CLOB,
    ENFORCE_TRUSTED_ISSUERS CHAR(1)        DEFAULT '0',
    JWKS_URI                VARCHAR2(2048),
    CREDENTIAL_QUERY_ID     VARCHAR2(255)  NOT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT IDN_PD_CRED_QID_DEF_UNQ UNIQUE (DEFINITION_ID, CREDENTIAL_QUERY_ID),
