...
CREATE TABLE IDN_PD_CREDENTIAL (
    ...
    ENFORCE_TRUSTED_ISSUER  CHAR(1)       DEFAULT '0',
    TRUSTED_CAS             CLOB,
    KEY_RESOLUTION_METHOD   VARCHAR2(50),
    JWKS_URI                VARCHAR2(2048),
    ISSUER_PEM              CLOB,
    CREDENTIAL_ID           VARCHAR2(255)  NOT NULL,
    PRIMARY KEY (DEFINITION_ID, CREDENTIAL_ID),
...
CREATE TABLE IDN_PD_CLAIM (
    ...
    ALLOWED_VALUES  CLOB,
    PRIMARY KEY (ID),
    FOREIGN KEY (DEFINITION_ID, CREDENTIAL_ID) REFERENCES IDN_PD_CREDENTIAL(DEFINITION_ID, CREDENTIAL_ID) ON DELETE CASCADE
)
/
