...
CREATE TABLE IDN_DEBUG_SESSION (
            DEBUG_ID VARCHAR2(255) NOT NULL,
            STATUS VARCHAR2(100) DEFAULT 'ACTIVE' NOT NULL,
            SESSION_DATA BLOB,
            RESULT_JSON CLOB,
            CREATED_TIME NUMBER(19) NOT NULL,
            EXPIRY_TIME NUMBER(19) NOT NULL,
            TENANT_ID NUMBER(10) DEFAULT -1 NOT NULL,
...
/
-- IDN_DEBUG_SESSION --
CREATE INDEX IDN_DEBUG_SESSION_EXPIRY_IDX ON IDN_DEBUG_SESSION (EXPIRY_TIME)
/
CREATE INDEX IDN_DEBUG_SESSION_TENANT_IDX ON IDN_DEBUG_SESSION (TENANT_ID)
/
