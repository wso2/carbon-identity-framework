...
/
CREATE OR REPLACE TRIGGER IDN_OAUTH2_USER_CONSENT_TRIG
    BEFORE INSERT
        ON IDN_OAUTH2_USER_CONSENT
            REFERENCING NEW AS NEW
            FOR EACH ROW
BEGIN
    SELECT IDN_OAUTH2_USER_CONSENT_PK_SEQ.nextval INTO :NEW.ID FROM dual;
END
/
...
/
CREATE OR REPLACE TRIGGER IDN_OAUTH2_USER_CONSENTED_SCOPES_TRIG
    BEFORE INSERT
        ON IDN_OAUTH2_USER_CONSENTED_SCOPES
            REFERENCING NEW AS NEW
            FOR EACH ROW
BEGIN
    SELECT IDN_OAUTH2_USER_CONSENTED_SCOPES_PK_SEQ.nextval INTO :NEW.ID FROM dual;
END
/
