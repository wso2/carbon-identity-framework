...
CREATE TABLE SP_APP (
            ...
            VERSION VARCHAR (255) DEFAULT 'v1.0.0',
...
CREATE TABLE IDN_XACML_POLICY (
    ...
    IS_IN_PAP CHAR(1) DEFAULT '1' NOT NULL,
    IS_IN_PDP CHAR(1) DEFAULT '0' NOT NULL,
...
/
CREATE SEQUENCE IDN_XACML_POLICY_ATTRIBUTE_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_XACML_POLICY_ATTRIBUTE_TRIG
BEFORE INSERT ON IDN_XACML_POLICY_ATTRIBUTE
REFERENCING NEW AS NEW
FOR EACH ROW
    BEGIN
        SELECT IDN_XACML_POLICY_ATTRIBUTE_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
    END;
/
...
/
CREATE SEQUENCE IDN_XACML_POLICY_EDITOR_DATA_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_XACML_POLICY_EDITOR_DATA_TRIG
BEFORE INSERT ON IDN_XACML_POLICY_EDITOR_DATA
REFERENCING NEW AS NEW
FOR EACH ROW
    BEGIN
        SELECT IDN_XACML_POLICY_EDITOR_DATA_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
    END;
/
...
CREATE TABLE IDN_XACML_SUBSCRIBER_PROPERTY (
    ...
    IS_SECRET CHAR(1) DEFAULT '0' NOT NULL,
...
CREATE TABLE IDN_XACML_SUBSCRIBER_STATUS (
    ID INTEGER NOT NULL,
    TYPE VARCHAR(255) NOT NULL,
    IS_SUCCESS CHAR(1) DEFAULT '0' NOT NULL,
    USERNAME VARCHAR(255) NOT NULL,
...
/
CREATE SEQUENCE IDN_XACML_SUBSCRIBER_STATUS_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_XACML_SUBSCRIBER_STATUS_TRIG
BEFORE INSERT ON IDN_XACML_SUBSCRIBER_STATUS
REFERENCING NEW AS NEW
FOR EACH ROW
    BEGIN
        SELECT IDN_XACML_SUBSCRIBER_STATUS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
    END;
/
...
/
CREATE SEQUENCE IDN_XACML_POLICY_STATUS_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_XACML_POLICY_STATUS_TRIG
BEFORE INSERT ON IDN_XACML_POLICY_STATUS
REFERENCING NEW AS NEW
FOR EACH ROW
    BEGIN
        SELECT IDN_XACML_POLICY_STATUS_SEQ.NEXTVAL INTO :NEW.ID FROM dual;
    END;
/
