...
CREATE TABLE IDN_VC_CLAIMS (
    ...
    CLAIM_URI VARCHAR(255) NOT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT IDN_VC_CLAIMS_UNIQUE_CONSTRAINT UNIQUE (TEMPLATE_ID, CLAIM_URI),
...
CREATE TABLE IDN_VC_NONCE (
    NONCE_ID     INTEGER,
    TENANT_ID    INTEGER       NOT NULL,
    NONCE_VALUE  VARCHAR2(255) NOT NULL,
...
/
CREATE SEQUENCE IDN_VC_NONCE_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_VC_NONCE_TRIG
    BEFORE INSERT
    ON IDN_VC_NONCE
    REFERENCING NEW AS NEW
    FOR EACH ROW
    BEGIN
        SELECT IDN_VC_NONCE_SEQ.nextval INTO :NEW.NONCE_ID FROM dual;
    END;
/
