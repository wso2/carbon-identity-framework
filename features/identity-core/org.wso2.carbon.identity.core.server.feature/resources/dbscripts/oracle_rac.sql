...
CREATE OR REPLACE TRIGGER IDN_WEBHOOK_TOPIC_TRIGGER
    ...
    REFERENCING NEW AS NEW FOR EACH ROW
        ...
        END;
/
CREATE TABLE IDN_WEBHOOK_METADATA (
    ID INTEGER,
    PROPERTY_NAME VARCHAR(100) NOT NULL,
    PROPERTY_TYPE VARCHAR(10) NOT NULL,
    PRIMITIVE_VALUE VARCHAR(255),
...
/
CREATE SEQUENCE IDN_WEBHOOK_METADATA_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_WEBHOOK_METADATA_TRIGGER
    BEFORE INSERT ON IDN_WEBHOOK_METADATA
    REFERENCING NEW AS NEW FOR EACH ROW
        BEGIN
            SELECT IDN_WEBHOOK_METADATA_SEQ.nextval INTO :NEW.ID FROM dual;
        END;
/
