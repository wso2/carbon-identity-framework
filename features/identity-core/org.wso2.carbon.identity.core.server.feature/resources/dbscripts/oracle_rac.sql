...
/
CREATE SEQUENCE IDN_WEBHOOK_EVENTS_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_WEBHOOK_EVENTS_TRIGGER
    BEFORE INSERT ON IDN_WEBHOOK_EVENTS
    REFERENCING NEW AS NEW FOR EACH ROW
        BEGIN
            SELECT IDN_WEBHOOK_EVENTS_SEQ.nextval INTO :NEW.ID FROM dual;
        END;
/
...
/
CREATE INDEX IDX_IDN_WEBHOOK_EVENTS_WID ON IDN_WEBHOOK_EVENTS (WEBHOOK_ID)
/
