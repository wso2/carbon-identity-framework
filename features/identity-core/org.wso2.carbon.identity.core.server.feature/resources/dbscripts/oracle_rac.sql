...
CREATE OR REPLACE TRIGGER SP_SHARED_APP_TRIG
            ...
            FOR EACH ROW
              ...
              END;
/
CREATE TABLE IDN_ORG_CONNECTION_ASSOCIATION (
    ID                          INTEGER NOT NULL,
...
/
CREATE SEQUENCE IDN_ORG_CONNECTION_ASSOCIATION_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_ORG_CONNECTION_ASSOCIATION_TRIG
    BEFORE INSERT
    ON IDN_ORG_CONNECTION_ASSOCIATION
    REFERENCING NEW AS NEW
        FOR EACH ROW
           BEGIN
               SELECT IDN_ORG_CONNECTION_ASSOCIATION_SEQ.nextval INTO :NEW.ID FROM dual;
           END;
/
CREATE TABLE IDVP (
    ID          INTEGER NOT NULL,
...
/
CREATE SEQUENCE IDN_PD_CURSOR_KEY_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_PD_CURSOR_KEY_TRIG
    BEFORE INSERT
    ON IDN_PRESENTATION_DEFINITION
    REFERENCING NEW AS NEW
    FOR EACH ROW
    BEGIN
        SELECT IDN_PD_CURSOR_KEY_SEQ.nextval INTO :NEW.CURSOR_KEY FROM dual;
    END;
/

CREATE TABLE IDN_PD_CREDENTIAL (
    ID                      INTEGER        NOT NULL,
    DEFINITION_ID           CHAR(36)       NOT NULL,
    IDENTIFIER              VARCHAR2(255)  NOT NULL,
    CREDENTIAL_TYPE         VARCHAR2(255)  NOT NULL,
    CREDENTIAL_FORMAT       VARCHAR2(50)   NOT NULL,
    TENANT_ID               INTEGER        NOT NULL,
    PRIMARY KEY (ID),
...
/
CREATE SEQUENCE IDN_PD_CREDENTIAL_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_PD_CREDENTIAL_TRIG
    BEFORE INSERT
    ON IDN_PD_CREDENTIAL
    REFERENCING NEW AS NEW
    FOR EACH ROW
    BEGIN
        SELECT IDN_PD_CREDENTIAL_SEQ.nextval INTO :NEW.ID FROM dual;
    END;
/

CREATE TABLE IDN_PD_CLAIM (
    ID              INTEGER        NOT NULL,
    CREDENTIAL_ID   INTEGER        NOT NULL,
    CLAIM_PATH      VARCHAR2(1024) NOT NULL,
...
/
CREATE SEQUENCE IDN_PD_CLAIM_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_PD_CLAIM_TRIG
    BEFORE INSERT
    ON IDN_PD_CLAIM
    REFERENCING NEW AS NEW
    FOR EACH ROW
    BEGIN
        SELECT IDN_PD_CLAIM_SEQ.nextval INTO :NEW.ID FROM dual;
    END;
/

CREATE TABLE IDN_PD_ISSUER_CONFIG (
    ID                    INTEGER        NOT NULL,
    CREDENTIAL_ID         INTEGER        NOT NULL,
    KEY_SOURCE_TYPE       VARCHAR2(50)   NOT NULL,
    ISSUER_URL            VARCHAR2(2048),
    KEY_SOURCE            CLOB,
    TENANT_ID             INTEGER        NOT NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (CREDENTIAL_ID) REFERENCES IDN_PD_CREDENTIAL(ID) ON DELETE CASCADE
...
/
CREATE SEQUENCE IDN_PD_ISSUER_CONFIG_SEQ START WITH 1 INCREMENT BY 1 NOCACHE
/
CREATE OR REPLACE TRIGGER IDN_PD_ISSUER_CONFIG_TRIG
    BEFORE INSERT ON IDN_PD_ISSUER_CONFIG REFERENCING NEW AS NEW FOR EACH ROW
    BEGIN
        SELECT IDN_PD_ISSUER_CONFIG_SEQ.nextval INTO :NEW.ID FROM dual;
    END;
/
