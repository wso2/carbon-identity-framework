...
CREATE TABLE IDN_OAUTH_CONSUMER_APPS (
            ...
            USER_ACCESS_TOKEN_EXPIRE_TIME LVARCHAR(128) DEFAULT '3600000',
            APPLICATION_ACCESS_TOKEN_EXPIRE_TIME LVARCHAR(128) DEFAULT '3600000',
            REFRESH_TOKEN_EXPIRE_TIME LVARCHAR(128) DEFAULT '84600000',
...
CREATE TABLE IDN_OAUTH2_SCOPE (
            ...
            DESCRIPTION LVARCHAR(512) NOT NULL,
...
CREATE TABLE SP_INBOUND_AUTH (
            ...
            INBOUND_CONFIG_TYPE LVARCHAR (255) NOT NULL,
...
CREATE TABLE SP_CLAIM_MAPPING (
		...
		IS_MANDATORY LVARCHAR(128) DEFAULT '0', 
...
CREATE TABLE IDN_RECOVERY_DATA (
  USER_NAME LVARCHAR(255) NOT NULL,
  USER_DOMAIN LVARCHAR(127) NOT NULL,
  TENANT_ID INTEGER DEFAULT -1,
  CODE LVARCHAR(255) NOT NULL,
  SCENARIO LVARCHAR(255) NOT NULL,
  STEP LVARCHAR(127) NOT NULL,
...
CREATE TABLE IDN_CLAIM_MAPPING (
  ...
  UNIQUE (EXT_CLAIM_ID, TENANT_ID) CONSTRAINT EXT_TO_LOC_MAPPING_CONSTRN
);

CREATE TABLE IDN_SAML2_ASSERTION_STORE (
  ID SERIAL,
  SAML2_ID  LVARCHAR(255) ,
  SAML2_ISSUER  LVARCHAR(255) ,
  SAML2_SUBJECT  LVARCHAR(255) ,
  SAML2_SESSION_INDEX LVARCHAR (255) ,
  SAML2_AUTHN_CONTEXT_CLASS_REF LVARCHAR (255) ,
  SAML2_ASSERTION LVARCHAR (4096) ,
  PRIMARY KEY (ID)
);
