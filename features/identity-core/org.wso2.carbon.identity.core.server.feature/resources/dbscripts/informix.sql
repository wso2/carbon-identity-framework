...
CREATE TABLE IDN_DIALECT(
  IDN_ID SERIAL,
  IDN_DIALECT_URI LVARCHAR(255) NOT NULL,
...
CREATE TABLE IDN_CLAIM(
  ...
  IDN_CLAIM_URI LVARCHAR(255) NOT NULL,
  IDN_TENANT_ID INTEGER DEFAULT 0,
...
CREATE TABLE IDN_CLAIM_META_DATA (
  ...
  IDN_TENANT_ID INTEGER DEFAULT 0,
  IDN_KEY LVARCHAR(255) DEFAULT NULL,
  IDN_VALUE LVARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (IDN_ID),
...
CREATE TABLE IDN_CLAIM_MAPPED_ATTRIBUTE (
  ...
  IDN_CLAIM_ID INTEGER NOT NULL,
  IDN_TENANT_ID INTEGER DEFAULT 0,
  IDN_MAPPED_ATTRIBUTE_DOMAIN LVARCHAR(255) DEFAULT NULL,
  IDN_MAPPED_ATTRIBUTE LVARCHAR(255) DEFAULT NULL,
  PRIMARY KEY (IDN_ID),
  FOREIGN KEY (IDN_CLAIM_ID) REFERENCES IDN_CLAIM (IDN_ID) ON DELETE CASCADE
);
