...
CREATE TABLE IF NOT EXISTS IDN_ASYNC_OPERATION_STATUS (
	...
	OPERATION_TYPE VARCHAR VARYING(63) NOT NULL,
	SUBJECT_TYPE VARCHAR VARYING(63) NOT NULL,
	SUBJECT_ID VARCHAR VARYING(255) NOT NULL,
	INITIATED_ORG_ID VARCHAR VARYING(255) NOT NULL,
	INITIATED_USER_ID VARCHAR VARYING(255) NOT NULL,
	STATUS VARCHAR VARYING(127) NOT NULL,
	CREATED_AT TIMESTAMP NOT NULL,
	LAST_MODIFIED TIMESTAMP NOT NULL,
	POLICY VARCHAR VARYING(127),
...
CREATE TABLE IF NOT EXISTS IDN_ASYNC_OPERATION_STATUS_UNIT (
	...
	CURSOR_KEY INTEGER NOT NULL,
	OPERATION_ID VARCHAR(36) NOT NULL,
	RESIDENT_RESOURCE_ID VARCHAR VARYING(255) NOT NULL,
	TARGET_ORG_ID VARCHAR VARYING(255) NOT NULL,
	STATUS VARCHAR VARYING(63) NOT NULL,
	STATUS_MESSAGE VARCHAR VARYING(127),
	CREATED_AT TIMESTAMP NOT NULL,
