...
/
CREATE TRIGGER IDN_ORG_CONNECTION_ASSOC_TRIG NO CASCADE
    BEFORE INSERT
    ON IDN_ORG_CONNECTION_ASSOCIATION
    REFERENCING NEW AS NEW
    FOR EACH ROW MODE DB2SQL
        BEGIN ATOMIC
            SET (NEW.ID) = (NEXTVAL FOR IDN_ORG_CONNECTION_ASSOCIATION_SEQ);
        END
/
CREATE TABLE IDVP (
    ID          INTEGER NOT NULL,
...
CREATE TABLE IDN_PRESENTATION_DEFINITION (
    ID            CHAR(36)      NOT NULL,
    CURSOR_KEY    INTEGER       NOT NULL GENERATED ALWAYS AS IDENTITY,
    IDENTIFIER    VARCHAR(255)  NOT NULL,
    DISPLAY_NAME  VARCHAR(255)  NOT NULL,
    DESCRIPTION   VARCHAR(1024),
    TENANT_ID     INTEGER       NOT NULL,
...
CREATE TABLE IDN_PD_CREDENTIAL (
    ...
    ENFORCE_TRUSTED_ISSUER  BOOLEAN       WITH DEFAULT FALSE,
    TRUSTED_CAS             CLOB,
...
CREATE TABLE IDN_PD_CLAIM (
    ...
    MANDATORY       SMALLINT      NOT NULL WITH DEFAULT 1,
    ALLOWED_VALUES  CLOB,
    PRIMARY KEY (ID),
