...
CREATE TABLE IF NOT EXISTS IDN_FLOW (
    ...
    CONSTRAINT UQ_IDN_FLOW_TENANT_TYPE_NAME UNIQUE (TENANT_ID, TYPE, FLOW_NAME)
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_NODE (
    ...
    IS_FIRST_NODE SMALLINT DEFAULT 0 NOT NULL,
    CONSTRAINT PK_IDN_FLOW_NODE PRIMARY KEY (ID),
    CONSTRAINT UQ_IDN_FLOW_NODE UNIQUE (NODE_ID, FLOW_ID),
    CONSTRAINT FK_FLOW_NODE_FLOW FOREIGN KEY (FLOW_ID) REFERENCES IDN_FLOW(ID) ON DELETE CASCADE
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_NODE_MAPPING (
    ...
    CONSTRAINT FK_FLOW_NODE_MAP_FLOWNODE FOREIGN KEY (FLOW_NODE_ID) REFERENCES IDN_FLOW_NODE(ID) ON DELETE CASCADE,
    CONSTRAINT FK_FLOW_NODE_MAP_NEXTNODE FOREIGN KEY (NEXT_NODE_ID) REFERENCES IDN_FLOW_NODE(ID) ON DELETE CASCADE
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_PAGE (
    ...
    CONSTRAINT FK_FLOW_PAGE_FLOW FOREIGN KEY (FLOW_ID) REFERENCES IDN_FLOW(ID) ON DELETE CASCADE,
    CONSTRAINT FK_FLOW_PAGE_FLOWNODE FOREIGN KEY (FLOW_NODE_ID) REFERENCES IDN_FLOW_NODE(ID) ON DELETE CASCADE
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_PAGE_META (
    ...
    CONSTRAINT FK_PAGE_META_PAGE FOREIGN KEY (PAGE_ID) REFERENCES IDN_FLOW_PAGE(ID) ON DELETE CASCADE
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_NODE_EXECUTOR (
    ...
    CONSTRAINT FK_NODE_EXECUTOR_NODE FOREIGN KEY (FLOW_NODE_ID) REFERENCES IDN_FLOW_NODE(ID) ON DELETE CASCADE
);
/
...
CREATE TABLE IF NOT EXISTS IDN_FLOW_NODE_EXECUTOR_META (
    ...
    CONSTRAINT FK_NODE_EXECUTOR_META_EXECUTOR FOREIGN KEY (EXECUTOR_ID) REFERENCES IDN_FLOW_NODE_EXECUTOR(ID) ON DELETE CASCADE
);
/
