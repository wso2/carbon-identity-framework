...
/
CREATE TRIGGER VC_CONFIG_CURSOR_KEY_TRIG NO CASCADE
    BEFORE INSERT
    ON VC_CONFIG
    REFERENCING NEW AS NEW
    FOR EACH ROW MODE DB2SQL
        BEGIN ATOMIC
            SET (NEW.CURSOR_KEY) = (NEXTVAL FOR VC_CONFIG_CURSOR_KEY_SEQ);
        END
/
...
/
CREATE TRIGGER VC_CONFIG_CLAIM_TRIG NO CASCADE
    BEFORE INSERT
    ON VC_CONFIG_CLAIM
    REFERENCING NEW AS NEW
    FOR EACH ROW MODE DB2SQL
        BEGIN ATOMIC
            SET (NEW.ID) = (NEXTVAL FOR VC_CONFIG_CLAIM_SEQ);
        END
/
...
/
CREATE TRIGGER VC_OFFER_CURSOR_KEY_TRIG NO CASCADE
    BEFORE INSERT
    ON VC_OFFER
    REFERENCING NEW AS NEW
    FOR EACH ROW MODE DB2SQL
        BEGIN ATOMIC
            SET (NEW.CURSOR_KEY) = (NEXTVAL FOR VC_OFFER_CURSOR_KEY_SEQ);
        END
/
...
/
CREATE TRIGGER VC_OFFER_CREDENTIAL_CONFIG_TRIG NO CASCADE
    BEFORE INSERT
    ON VC_OFFER_CREDENTIAL_CONFIG
    REFERENCING NEW AS NEW
    FOR EACH ROW MODE DB2SQL
        BEGIN ATOMIC
            SET (NEW.ID) = (NEXTVAL FOR VC_OFFER_CREDENTIAL_CONFIG_SEQ);
        END
/
