...
/
CREATE UNIQUE INDEX IDN_PASSWORD_HISTORY_DATALOWER_USER_NAME_USER_DOMAIN_TENANT_ID_SALT_VALUE_HASH ON IDN_PASSWORD_HISTORY_DATA(LOWER(USER_NAME), USER_DOMAIN, TENANT_ID, SALT_VALUE, HASH)
/
