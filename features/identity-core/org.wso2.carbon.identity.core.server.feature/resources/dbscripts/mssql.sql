...
IF NOT EXISTS (SELECT * FROM SYS.INDEXES WHERE NAME = 'IDX_IDN_OAUTH_CONSUMER_SECRETS_CK' AND OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH_CONSUMER_SECRETS]'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_PRESENTATION_DEFINITION]') AND TYPE IN (N'U'))
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_PD_CREDENTIAL]') AND TYPE IN (N'U'))
CREATE TABLE IDN_PD_CREDENTIAL (
    DEFINITION_ID           CHAR(36)      NOT NULL,
    CREDENTIAL_TYPE         VARCHAR(255)  NOT NULL,
    CREDENTIAL_FORMAT       VARCHAR(50)   NOT NULL,
    ENFORCE_TRUSTED_ISSUER  BIT           DEFAULT 0,
    TRUSTED_CAS             NVARCHAR(MAX),
    KEY_RESOLUTION_METHOD   VARCHAR(50),
    JWKS_URI                VARCHAR(2048),
    ISSUER_PEM              NVARCHAR(MAX),
...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_PD_CLAIM]') AND TYPE IN (N'U'))
