...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_APP_CALLBACK_URLS]') AND TYPE IN (N'U'))
CREATE TABLE IDN_OAUTH2_APP_CALLBACK_URLS (
   APP_ID INTEGER NOT NULL,
   APP_URL_ID INTEGER NOT NULL,
   CALLBACK_URL VARCHAR (2048),
   TENANT_ID INTEGER DEFAULT -1,
   PRIMARY KEY (APP_ID, APP_URL_ID),
