...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_AUTH_APP_SESSION_STORE]') AND TYPE IN (N'U'))
CREATE TABLE IDN_AUTH_APP_SESSION_STORE (
  SESSION_ID VARCHAR (100) NOT NULL,
  SUBJECT VARCHAR (100) NOT NULL,
  APP_ID VARCHAR (10) NOT NULL,
  APP_TENANT_ID (10) NOT NULL,
...
IF NOT EXISTS(SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[SP_DEFAULT_AUTH_SEQ]') AND TYPE IN (N'U'))
CREATE TABLE SP_DEFAULT_AUTH_SEQ (
  ID INTEGER NOT NULL IDENTITY,
  NAME VARCHAR(255) NOT NULL,
  DESCRIPTION VARCHAR(1024),
  SEQ_CONTENT VARBINARY(MAX) DEFAULT NULL,
  TENANT_ID INTEGER NOT NULL,
  PRIMARY KEY (ID),
