...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_OAUTH2_ACCESS_TOKEN_BINDING]') AND TYPE IN (N'U'))
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN_BINDING (
            TOKEN_ID VARCHAR (255),
...
CREATE INDEX IDX_IDN_AUTH_BIND ON IDN_OAUTH2_ACCESS_TOKEN_BINDING (TOKEN_BINDING_REF);
