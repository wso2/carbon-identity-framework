...
IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT]') AND TYPE IN (N'U'))
CREATE TABLE IDN_ORG_USER_INVITE_ROLE_ASSIGNMENT (
	ID INTEGER IDENTITY(1,1) NOT NULL,
	INVITATION_ID VARCHAR(40) NOT NULL,
	APPLICATION_ID CHAR(36) NOT NULL,
	ROLE_ID VARCHAR(255) NOT NULL,
	CONSTRAINT PK_ORG_USER_ROLE_ASSIGNMENT PRIMARY KEY(INVITATION_ID, APPLICATION_ID, ROLE_ID),
	...
	CONSTRAINT FK_ORG_USER_ROLE_SP_APP FOREIGN KEY(APPLICATION_ID) REFERENCES SP_APP(UUID) ON DELETE CASCADE
);

IF NOT  EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_ORG_USER_ASSOCIATION]') AND TYPE IN (N'U'))
