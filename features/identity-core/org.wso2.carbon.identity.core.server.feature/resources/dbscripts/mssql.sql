...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_DIALECT]') AND TYPE IN (N'U'))
CREATE TABLE IDN_DIALECT(
  IDN_ID INTEGER NOT NULL IDENTITY,
...
IF NOT EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[DBO].[IDN_CLAIM_META_DATA]') AND TYPE IN (N'U'))
