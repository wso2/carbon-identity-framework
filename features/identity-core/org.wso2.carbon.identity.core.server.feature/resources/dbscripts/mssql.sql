...
CREATE TABLE IDN_VC_CLAIMS (
    ...
    CLAIM_URI VARCHAR(255) NOT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT IDN_VC_CLAIMS_UNQ UNIQUE (CONFIG_ID, CLAIM_URI),
    CONSTRAINT FK_IDN_VC_TEMPLATE_CLAIM_CONFIG FOREIGN KEY (CONFIG_ID) REFERENCES IDN_VC_TEMPLATE (ID) ON DELETE CASCADE
);
