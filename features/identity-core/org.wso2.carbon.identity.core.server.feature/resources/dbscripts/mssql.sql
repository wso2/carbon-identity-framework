...
CREATE TRIGGER IDN_CLAIM_DIALECT_DELETE_TRIGGER
ON IDN_CLAIM_DIALECT
INSTEAD OF DELETE
AS BEGIN
	DELETE FROM IDN_CLAIM WHERE DIALECT_ID IN (SELECT ID FROM deleted)
...
CREATE TRIGGER IDN_CLAIM_MAPPING_DELETE_TRIGGER
ON IDN_CLAIM
INSTEAD OF DELETE
AS BEGIN
	DELETE FROM IDN_CLAIM_MAPPING WHERE EXT_CLAIM_ID IN (SELECT ID FROM deleted) OR MAPPED_LOCAL_CLAIM_ID IN (SELECT ID FROM deleted)
