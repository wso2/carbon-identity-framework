...
/**
 * Exception thrown when creating test.
 */
public class TestCreationException extends RuntimeException {
    ...
    public TestCreationException(String message, Throwable cause) {
    ...
    public TestCreationException(String message, Throwable cause, boolean enableSuppression,
