...
public interface DebugResourceHandler {
     ...
     * 1. Loading the resource configuration from the database
     * 2. Detecting the protocol used by the resource
     * 3. Getting the appropriate protocol provider
     * 4. Executing the debug flow
     *
