 ...
 * Represents internal processing errors (5xx HTTP status codes) such as:
 * - Reflection API errors (method invocation failures)
 * - Configuration/dependency issues
 * - Resource provider/executor not found
 * - Context resolution or execution failures
 */
