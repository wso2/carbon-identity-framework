...
import org.wso2.carbon.identity.debug.framework.core.handler.DebugResourceHandler;
 ...
 * Defines the different types of resources that can be debugged (IdP, Application, Connector, etc.).
 */
public enum DebugResourceType {
     ...
     * Uses switch case for built-in types and registry for custom types.
     *
