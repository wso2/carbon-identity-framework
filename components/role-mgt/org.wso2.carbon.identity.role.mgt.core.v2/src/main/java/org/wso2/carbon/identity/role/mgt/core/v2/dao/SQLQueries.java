...
public class SQLQueries {
    ...
    public static final String ADD_ROLE_WITH_AUDIENCE_SQL = "INSERT INTO UM_HYBRID_ROLE (UM_ROLE_NAME, AUDIENCE_ID, " +
    ...
    public static final String GET_ROLE_AUDIENCE_BY_ROLE_NAME_SQL = "SELECT AUDIENCE, " +
            ...
            "UM_HYBRID_ROLE.AUDIENCE_ID = UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_ROLE_NAME =:ROLE_NAME; AND " +
    ...
    public static final String GET_ROLES_BY_TENANT_MYSQL = "SELECT UM_ROLE_NAME, AUDIENCE, " +
            "UM_HYBRID_ROLE_AUDIENCE.AUDIENCE_ID FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON " +
            "UM_HYBRID_ROLE.AUDIENCE_ID = UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_TENANT_ID=:UM_TENANT_ID; ORDER BY " +
    ...
    public static final String GET_ROLES_BY_TENANT_DB2 = "SELECT UM_ROLE_NAME, AUDIENCE, " +
            ...
            "UM_HYBRID_ROLE.* FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE.AUDIENCE_ID = " +
    ...
    public static final String GET_ROLES_BY_TENANT_INFORMIX = "SELECT SKIP :OFFSET; FIRST :LIMIT; UM_ROLE_NAME, " +
            ...
            "UM_HYBRID_ROLE.AUDIENCE_ID = UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_TENANT_ID=:UM_TENANT_ID; " +
            "ORDER BY UM_ID DESC";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_MYSQL = "SELECT UM_ROLE_NAME, AUDIENCE, " +
            "UM_HYBRID_ROLE_AUDIENCE.AUDIENCE_ID FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON " +
            "UM_HYBRID_ROLE.AUDIENCE_ID = UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_TENANT_ID=:UM_TENANT_ID; AND " +
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_INFORMIX = "SELECT SKIP :OFFSET; FIRST :LIMIT; " +
            ...
            "UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE.AUDIENCE_ID = UM_HYBRID_ROLE_AUDIENCE.ID WHERE " +
