...
public class RoleManagementServiceImplTest extends IdentityBaseTest {
    ...
    public void testAddRoleWithSystemPrefix(boolean allowSystemPrefix, String roleName, boolean errorScenario)
        ...
        try (MockedStatic<IdentityUtil> identityUtil = mockStatic(IdentityUtil.class)) {
            ...
            when(roleDAO.addRole(anyString(), anyList(), anyString(), anyString(), anyString()))
            ...
            RoleBasicInfo addedRole = roleManagementService.addRole(roleName, new ArrayList<>(), APPLICATION,
                    audienceId, SUPER_TENANT_DOMAIN_NAME);
            if (errorScenario) {
    ...
    public void testAddRoleInvalidRoleName(String roleName, String expectedMessage) throws Exception {
        ...
        try {
            roleManagementService.addRole(roleName, new ArrayList<>(), audience, audienceId, tenantDomain);
        } catch (IdentityRoleManagementClientException e) {
    ...
    public void testAddRoleWithIsFragmentAppProperty() throws Exception {
        ...
        RoleBasicInfo result = roleManagementService.addRole(roleName, new ArrayList<>(), audience,
