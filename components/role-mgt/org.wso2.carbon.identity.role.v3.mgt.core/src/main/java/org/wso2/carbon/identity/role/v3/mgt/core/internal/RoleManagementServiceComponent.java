...
package org.wso2.carbon.identity.role.v3.mgt.core.internal;
...
import org.wso2.carbon.identity.role.v3.mgt.core.RoleManagementServiceImpl;
import org.wso2.carbon.identity.role.v3.mgt.core.listener.RoleManagementListener;
import org.wso2.carbon.identity.role.v3.mgt.core.listener.RoleManagementV3AuditLogger;
import org.wso2.carbon.idp.mgt.IdpManager;
import org.wso2.carbon.user.core.service.RealmService;

/**
 * Role management V3 service component.
 */
@Component(name = "org.wso2.carbon.identity.role.v3.mgt.core.internal.RoleManagementServiceComponent",
           immediate = true)
public class RoleManagementServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            bundleContext.registerService(RoleManagementListener.class, new RoleManagementV3AuditLogger(), null);

            log.debug("Role V3 management service is activated.");
        } catch (Throwable e) {
            log.error("Error while activating Role V3 management service.", e);
        }
    }
    ...
    protected void deactivate(ComponentContext context) {
        ...
        log.debug("Role V3 management service is deactivated.");
    }
    ...
    @Reference(
            name = "role.management.audit.v3.logger",
            service = RoleManagementV3AuditLogger.class,
            cardinality = ReferenceCardinality.MULTIPLE,
            policy = ReferencePolicy.DYNAMIC,
            unbind = "unsetRoleManagementAuditV3Logger"
    )
    protected void setRoleManagementAuditV3Logger(RoleManagementV3AuditLogger roleManagementAuditV3Logger) {

        RoleManagementServiceComponentHolder.getInstance().addRoleManagementListener(roleManagementAuditV3Logger);
    }

    protected void unsetRoleManagementAuditV3Logger(RoleManagementV3AuditLogger roleManagementListener) {
