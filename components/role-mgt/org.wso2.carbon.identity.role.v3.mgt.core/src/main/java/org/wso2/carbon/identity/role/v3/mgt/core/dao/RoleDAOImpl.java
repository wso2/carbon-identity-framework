...
package org.wso2.carbon.identity.role.v3.mgt.core.dao;
...
import org.wso2.carbon.identity.role.v3.mgt.core.FilterQueryBuilder;
import org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants;
import org.wso2.carbon.identity.role.v3.mgt.core.exception.IdentityRoleManagementClientException;
import org.wso2.carbon.identity.role.v3.mgt.core.exception.IdentityRoleManagementException;
import org.wso2.carbon.identity.role.v3.mgt.core.exception.IdentityRoleManagementServerException;
import org.wso2.carbon.identity.role.v3.mgt.core.internal.RoleManagementServiceComponentHolder;
import org.wso2.carbon.identity.role.v3.mgt.core.model.AssociatedApplication;
import org.wso2.carbon.identity.role.v3.mgt.core.model.GroupBasicInfo;
import org.wso2.carbon.identity.role.v3.mgt.core.model.IdpGroup;
...
import org.wso2.carbon.identity.role.v3.mgt.core.model.RoleAudience;
import org.wso2.carbon.identity.role.v3.mgt.core.model.RoleBasicInfo;
import org.wso2.carbon.identity.role.v3.mgt.core.model.RoleDTO;
import org.wso2.carbon.identity.role.v3.mgt.core.model.RoleProperty;
import org.wso2.carbon.identity.role.v3.mgt.core.model.UserBasicInfo;
import org.wso2.carbon.identity.role.v3.mgt.core.util.GroupIDResolver;
...
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.Error.INVALID_LIMIT;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.Error.INVALID_OFFSET;
...
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.Error.PERMISSION_ALREADY_ADDED;
...
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.Error.SORTING_NOT_IMPLEMENTED;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.Error.UNEXPECTED_SERVER_ERROR;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.H2;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.INFORMIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.INTERNAL_DOMAIN;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.INTERNAL_ORG_SCOPE_PREFIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.INTERNAL_SCOPE_PREFIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.MARIADB;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.MICROSOFT;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.MY_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.ORGANIZATION;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.POSTGRE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.RoleTableColumns.ROLE_NAME;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.RoleTableColumns.USER_NOT_FOUND_ERROR_MESSAGE;
import static org.wso2.carbon.identity.role.v3.mgt.core.RoleConstants.SYSTEM;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_APP_ROLE_ASSOCIATION_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_GROUP_TO_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_IDP_GROUPS_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_ROLE_AUDIENCE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_ROLE_SCOPE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.ADD_SCIM_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_INFORMIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_MSSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_MYSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.COUNT_ROLES_BY_TENANT_POSTGRESQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_APP_ROLE_ASSOCIATION_BY_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_IDP_GROUPS_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_ROLES_BY_APP_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_ROLE_SCOPE_BY_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_ROLE_SCOPE_BY_SCOPE_NAME_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_SCIM_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_SHARED_ROLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.DELETE_SHARED_SCIM_ROLES_WITH_MAIN_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ASSOCIATED_APPS_BY_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ASSOCIATED_APP_IDS_BY_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_AUDIENCE_BY_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_AUDIENCE_REF_BY_ID_FROM_UM_HYBRID_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_GROUP_LIST_OF_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_IDP_GROUPS_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_LIMITED_USER_LIST_OF_ROLE_DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_LIMITED_USER_LIST_OF_ROLE_MSSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_LIMITED_USER_LIST_OF_ROLE_ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_LIMITED_USER_LIST_OF_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_MAIN_ROLE_TO_SHARED_ROLE_MAPPINGS_BY_SUBORG_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_APP_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_INFORMIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_MSSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_MYSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_POSTGRESQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_INFORMIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MSSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MYSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_POSTGRESQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_DB2;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_INFORMIX;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_MSSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_MYSQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_ORACLE;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLES_BY_TENANT_POSTGRESQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_AUDIENCE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_ID_BY_NAME_AND_AUDIENCE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_ID_LIST_OF_GROUP_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_ID_LIST_OF_IDP_GROUPS_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_ID_LIST_OF_USER_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_LIST_OF_GROUP_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_LIST_OF_IDP_GROUPS_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_LIST_OF_USER_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_NAME_BY_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_SCOPE_NAMES_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_SCOPE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_TENANT_DOMAIN_BY_ID;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_ROLE_UM_ID_BY_UUID;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_SHARED_HYBRID_ROLE_WITH_MAIN_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_SHARED_ROLES_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_SHARED_ROLE_MAIN_ROLE_ID_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.GET_SHARED_ROLE_TO_MAIN_ROLE_MAPPINGS_BY_SUBORG_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.INSERT_MAIN_TO_SHARED_ROLE_RELATIONSHIP;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.IS_ROLE_EXIST_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.IS_ROLE_ID_EXIST_FROM_UM_HYBRID_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.IS_SHARED_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.REMOVE_GROUP_FROM_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.REMOVE_USER_FROM_ROLE_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.UPDATE_ROLE_NAME_SQL;
import static org.wso2.carbon.identity.role.v3.mgt.core.dao.SQLQueries.UPDATE_SCIM_ROLE_NAME_SQL;
...
public class RoleDAOImpl implements RoleDAO {
    ...
    @Override
    public RoleBasicInfo addRole(String roleName, List<Permission> permissions, String audience, String audienceId,
                                 String tenantDomain)
