...
package org.wso2.carbon.identity.role.v3.mgt.core;
...
public class RoleManagementEventPublisherProxy {
     ...
     */
    public void publishPreAddRoleWithException(String roleName, List<Permission> permissions, String audience,
        ...
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_ADD_ROLE_V3_EVENT);
     ...
     * @param tenantDomain The domain in which the operation is being performed.
     */
    public void publishPostAddRole(String roleId, String roleName, List<Permission> permissions, String audience,
                                   String audienceId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.AUDIENCE_ID, audienceId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_ADD_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
    ...
    public void publishPreGetRolesWithException(Integer limit, Integer offset, String sortBy, String sortOrder,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_ROLES_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetRoles(Integer limit, Integer offset, String sortBy, String sortOrder,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.SORT_ORDER, sortOrder);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_ROLES_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreGetRoleWithException(String roleId, String tenantDomain)
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetRole(String roleId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreGetPermissionListOfRoleWithException(String roleId, String tenantDomain)
        ...
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.PRE_GET_PERMISSION_LIST_OF_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetPermissionListOfRole(String roleId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.POST_GET_PERMISSION_LIST_OF_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreUpdatePermissionsForRoleWithException(String roleId, List<Permission> addedPermissions,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.PRE_UPDATE_PERMISSIONS_FOR_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostUpdatePermissionsForRole(String roleId, List<Permission> addedPermissions,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.POST_UPDATE_PERMISSIONS_FOR_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreDeleteRoleWithException(String roleId, String tenantDomain)
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_DELETE_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostDeleteRole(String roleId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_DELETE_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreUpdateRoleNameWithException(String roleId, String newRoleName, String tenantDomain)
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_UPDATE_ROLE_V3_NAME_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostUpdateRoleName(String roleId, String newRoleName, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.NEW_ROLE_NAME, newRoleName);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_UPDATE_ROLE_V3_NAME_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreGetGroupListOfRoleWithException(String roleId, String tenantDomain)
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_GROUP_LIST_OF_ROLES_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetGroupListOfRole(String roleId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_GROUP_LIST_OF_ROLES_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreUpdateUserListOfRoleWithException(String roleId, List<String> newUserIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_UPDATE_USER_LIST_OF_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostUpdateUserListOfRole(String roleId, List<String> newUserIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.DELETE_USER_ID_LIST, deletedUserIDList);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_UPDATE_USER_LIST_OF_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreGetUserListOfRoleWithException(String roleId, String tenantDomain)
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_USER_LIST_OF_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetUserListOfRole(String roleId, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.ROLE_ID, roleId);
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_USER_LIST_OF_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreUpdateGroupListOfRoleWithException(String roleId, List<String> newGroupIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_UPDATE_GROUP_LIST_OF_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostUpdateGroupListOfRole(String roleId, List<String> newGroupIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.POST_UPDATE_GROUP_LIST_OF_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreUpdateIdpGroupListOfRoleWithException(String roleId, List<IdpGroup> newGroupIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.PRE_UPDATE_IDP_GROUP_LIST_OF_ROLE_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostUpdateIdpGroupListOfRole(String roleId, List<IdpGroup> newGroupIDList,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.POST_UPDATE_IDP_GROUP_LIST_OF_ROLE_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreGetRolesCountWithException(String tenantDomain) throws IdentityRoleManagementException {
        ...
        Map<String, Object> eventProperties = new HashMap<>();
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_ROLES_V3_COUNT_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPreGetRolesCountWithException(String searchFilter, String tenantDomain)
        ...
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.PRE_GET_ROLES_V3_FILTERED_COUNT_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostGetRolesCount(String tenantDomain) {
        ...
        Map<String, Object> eventProperties = new HashMap<>();
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_ROLES_V3_COUNT_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPreAddMainRoleToSharedRoleRelationshipWithException(String mainRoleUUID, String sharedRoleUUID,
        ...
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.PRE_ADD_MAIN_ROLE_TO_SHARED_ROLE_RELATIONSHIP_V3_EVENT);
        doPublishEvent(event);
    }
    ...
    public void publishPostAddMainRoleToSharedRoleRelationship(String mainRoleUUID, String sharedRoleUUID,
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.SHARED_ROLE_TENANT_DOMAIN, sharedRoleTenantDomain);
        Event event = createEvent(eventProperties,
                IdentityEventConstants.Event.POST_ADD_MAIN_ROLE_TO_SHARED_ROLE_RELATIONSHIP_V3_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
    ...
    public void publishPostGetRolesCount(String searchFilter, String tenantDomain) {
        ...
        eventProperties.put(IdentityEventConstants.EventProperty.TENANT_DOMAIN, tenantDomain);
        eventProperties.put(IdentityEventConstants.EventProperty.SEARCH_FILTER, searchFilter);
        Event event = createEvent(eventProperties, IdentityEventConstants.Event.POST_GET_ROLES_V3_FILTERED_COUNT_EVENT);
        try {
            doPublishEvent(event);
        } catch (IdentityRoleManagementException e) {
            log.error(e.getMessage(), e);
