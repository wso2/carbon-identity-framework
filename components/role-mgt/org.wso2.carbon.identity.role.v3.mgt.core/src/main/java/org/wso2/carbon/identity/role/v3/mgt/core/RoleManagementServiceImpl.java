...
import org.wso2.carbon.identity.role.v3.mgt.core.listener.RoleManagementListener;
...
public class RoleManagementServiceImpl implements RoleManagementService {
    ...
    @Override
    public RoleBasicInfo addRole(String roleName, List<Permission> permissions, String audience,
        ...
        try {
            ...
            for (RoleManagementListener roleManagementListener : roleManagementListenerList) {
                if (roleManagementListener.isEnable()) {
                    roleManagementListener.preAddRole(roleName, permissions, audience, audienceId, tenantDomain);
                }
            }

            RoleManagementEventPublisherProxy roleManagementEventPublisherProxy = RoleManagementEventPublisherProxy
                    .getInstance();
            roleManagementEventPublisherProxy.publishPreAddRoleWithException(roleName, permissions, audience,
            ...
            RoleBasicInfo roleBasicInfo = roleDAO.addRole(roleName, permissions, audience,
                    audienceId, tenantDomain);
            roleManagementEventPublisherProxy.publishPostAddRole(roleBasicInfo.getId(), roleName, permissions,
            ...
            for (RoleManagementListener roleManagementListener : roleManagementListenerList) {
                if (roleManagementListener.isEnable()) {
                    roleManagementListener.postAddRole(role, roleName, permissions, audience, audienceId, tenantDomain);
                }
            }
            return role;
        } finally {
