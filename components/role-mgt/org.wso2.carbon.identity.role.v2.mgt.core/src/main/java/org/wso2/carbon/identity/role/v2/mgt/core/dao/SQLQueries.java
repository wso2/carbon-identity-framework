...
public class SQLQueries {
    ...
    public static final String GET_ROLE_ID_LIST_OF_SHARED_USER_SQL = "SELECT r.UM_UUID FROM UM_HYBRID_ROLE r INNER " +
            "JOIN UM_HYBRID_USER_ROLE ur ON r.UM_ID = ur.UM_ROLE_ID INNER JOIN UM_DOMAIN d ON " +
            "ur.UM_DOMAIN_ID = d.UM_DOMAIN_ID WHERE ur.UM_USER_NAME =:UM_USER_NAME; AND " +
            "ur.UM_TENANT_ID =:UM_TENANT_ID; ur.UM_EDIT_RESTRICTION = `RESTRICTED`; AND " +
            "d.UM_TENANT_ID =:UM_TENANT_ID; AND d.UM_DOMAIN_NAME =:UM_DOMAIN_NAME;";
