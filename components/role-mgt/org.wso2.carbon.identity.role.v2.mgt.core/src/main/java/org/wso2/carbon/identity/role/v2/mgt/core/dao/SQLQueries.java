...
public class SQLQueries {
    ...
    public static final String GET_ROLES_USERS_BY_TENANT_AND_ROLE_ORACLE =
            "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT UM_USER_NAME, UM_DOMAIN_NAME, rownum AS rnum FROM (" +
            "SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME " +
            "FROM UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE " +
            "ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID " +
            "INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID " +
            "INNER JOIN UM_DOMAIN ON UM_DOMAIN.UM_DOMAIN_ID = UM_HYBRID_USER_ROLE.UM_DOMAIN_ID WHERE ";

    public static final String GET_ROLES_USERS_BY_TENANT_USER_STORE_AND_ROLE_ORACLE =
            "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT UM_USER_NAME, UM_DOMAIN_NAME, rownum AS rnum FROM (" +
            "SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID " +
            "INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID " +
