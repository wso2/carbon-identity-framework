...
public class SQLQueries {
    ...
    public static final String GET_SHARED_HYBRID_ROLE_WITH_MAIN_ROLE_SQL = "SELECT UM_SHARED_ROLE_ID, " +
            ...
            "SELECT UM_ID, UM_TENANT_ID FROM UM_HYBRID_ROLE WHERE UM_UUID =:UM_UUID; AND UM_TENANT_ID =:UM_TENANT_ID;)";

    public static final String GET_SHARED_HYBRID_ROLE_WITH_MAIN_ROLE_MSSQL = "SELECT s.UM_SHARED_ROLE_ID, " +
