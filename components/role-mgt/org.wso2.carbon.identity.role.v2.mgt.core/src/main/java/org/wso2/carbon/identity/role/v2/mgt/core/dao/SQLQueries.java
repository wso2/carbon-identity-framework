...
public class SQLQueries {
    ...
    public static final String DELETE_ROLE_SCOPE_BY_SCOPE_NAME_SQL = "DELETE FROM ROLE_SCOPE LEFT JOIN SCOPE ON " +
            "ROLE_SCOPE.SCOPE_ID = SCOPE.ID WHERE ROLE_ID =:ROLE_ID; AND SCOPE.NAME = :SCOPE_NAME;";
    ...
    public static final String GET_SCOPE_BY_ROLES_SQL = "SELECT NAME FROM ROLE_SCOPE INNER JOIN SCOPE ON " +
            "ROLE_SCOPE.SCOPE_ID = SCOPE.ID WHERE AND ROLE_ID IN (";
