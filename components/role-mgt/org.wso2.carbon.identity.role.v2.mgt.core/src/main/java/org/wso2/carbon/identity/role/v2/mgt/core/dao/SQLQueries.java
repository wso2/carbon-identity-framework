...
public class SQLQueries {
    ...
    public static final String DELETE_SHARED_HYBRID_ROLES_WITH_MAIN_ROLE_MYSQL =
            "DELETE uhr FROM UM_HYBRID_ROLE uhr JOIN (SELECT UM_SHARED_ROLE_ID, UM_SHARED_ROLE_TENANT_ID FROM " +
            "UM_SHARED_ROLE usr WHERE (usr.UM_MAIN_ROLE_ID, usr.UM_MAIN_ROLE_TENANT_ID) IN (SELECT UM_ID, " +
            "UM_TENANT_ID FROM UM_HYBRID_ROLE WHERE UM_UUID =:UM_UUID; AND UM_TENANT_ID =:UM_TENANT_ID;)) AS temp " +
            "ON uhr.UM_ID = temp.UM_SHARED_ROLE_ID AND uhr.UM_TENANT_ID = temp.UM_SHARED_ROLE_TENANT_ID";
