...
public class SQLQueries {
    ...
    public static final String GET_ROLES_USERS_BY_TENANT_AND_ROLE_DB2 =
            "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT ROW_NUMBER() OVER (ORDER BY UM_USER_NAME DESC) AS RN, " +
    ...
    public static final String GET_USER_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MYSQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME DESC LIMIT :OFFSET;, :LIMIT;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_ORACLE =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME DESC) WHERE rownum <= " +
            ":END_INDEX;) WHERE rnum > :ZERO_BASED_START_INDEX;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MSSQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME DESC OFFSET :OFFSET; " +
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_POSTGRESQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME DESC LIMIT :LIMIT; OFFSET :OFFSET;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_INFORMIX =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME DESC";
