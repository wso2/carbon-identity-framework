...
public class SQLQueries {
    ...
    public static final String GET_ROLE_AUDIENCE_BY_REF_ID_SQL = "SELECT AUDIENCE, AUDIENCE_ID FROM " +
            "UM_HYBRID_ROLE_AUDIENCE ON WHERE ID =:AUDIENCE_REF_ID;";
    ...
    public static final String GET_AUDIENCE_BY_ID_SQL = "SELECT AUDIENCE, AUDIENCE_ID FROM UM_HYBRID_ROLE_AUDIENCE " +
            "WHERE ID IN (SELECT AUDIENCE_REF_ID FROM IDN_SCIM_GROUP WHERE TENANT_ID=:TENANT_ID; AND " +
            "ATTR_NAME=:ATTR_NAME; AND ATTR_VALUE=:ATTR_VALUE;)";
    ...
    public static final String GET_IDP_GROUPS_INFO_SQL = "SELECT GROUP_NAME, IDP_ID, NAME FROM IDP_GROUP INNER " +
            "JOIN IDP ON IDP_GROUP.IDP_ID = IDP.ID WHERE IDP_GROUP.UUID=:GROUP_ID; AND IDP_GROUP.TENANT_ID=:TENANT_ID;";
