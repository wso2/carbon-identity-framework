...
public class SQLQueries {
    ...
    public static final String DELETE_ROLE_SCOPE_BY_SCOPE_NAME_SQL = "DELETE FROM ROLE_SCOPE WHERE " +
            "ROLE_ID =:ROLE_ID; AND SCOPE_NAME=:SCOPE_NAME;";
    ...
    public static final String GET_ROLE_SCOPE_SQL = "SELECT NAME, DISPLAY_NAME, API_ID FROM ROLE_SCOPE INNER JOIN " +
            ...
            "ROLE_ID =:ROLE_ID; AND (ROLE_SCOPE.TENANT_ID =:TENANT_ID; OR ROLE_SCOPE.TENANT_ID = 0)";
    ...
    public static final String GET_SCOPE_BY_ROLES_SQL = "SELECT NAME FROM ROLE_SCOPE INNER JOIN SCOPE ON " +
            ...
            "(ROLE_SCOPE.TENANT_ID =:TENANT_ID; OR ROLE_SCOPE.TENANT_ID = 0) AND ROLE_ID IN (";
