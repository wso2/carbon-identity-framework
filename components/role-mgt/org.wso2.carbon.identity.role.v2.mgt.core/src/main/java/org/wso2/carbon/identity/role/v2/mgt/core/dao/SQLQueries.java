...
public class SQLQueries {
    ...
    public static final String GET_LIMITED_USER_LIST_OF_ROLE_SQL = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            ...
            "AND UM_AUDIENCE_REF_ID=:UM_AUDIENCE_REF_ID;) AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; " +
    ...
    public static final String GET_LIMITED_USER_LIST_OF_ROLE_ORACLE = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            ...
            "(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_ROLE_NAME=:UM_ROLE_NAME; AND UM_TENANT_ID=:UM_TENANT_ID; AND " +
            "UM_AUDIENCE_REF_ID=:UM_AUDIENCE_REF_ID;) AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; AND " +
    ...
    public static final String GET_NOT_RESTRICTED_USERNAMES_BY_ROLE_HEAD =
            "SELECT UM_USER_NAME FROM UM_HYBRID_USER_ROLE WHERE UM_ROLE_ID = :" + UM_USER_NAME + "; AND " +
                    "UM_USER_NAME IN (";

    public static final String GET_NOT_RESTRICTED_USERNAMES_BY_ROLE_TAIL =
            "); AND UM_TENANT_ID = :" + UM_TENANT_ID + "; AND UM_EDIT_RESTRICTION = 'NOT_RESTRICTED';";
    ...
    public static final String GET_RESTRICTED_USERNAMES_BY_ROLE_AND_ORG_HEAD =
            "SELECT r.UM_USER_NAME FROM UM_HYBRID_USER_ROLE r "
                    ...
                    + "WHERE r.UM_ROLE_ID = :" + UM_ROLE_ID + "; AND r.UM_USER_NAME IN (";

    public static final String GET_RESTRICTED_USERNAMES_BY_ROLE_AND_ORG_TAIL =
            "); AND r.UM_TENANT_ID = :" + UM_TENANT_ID + "; AND p.UM_PERMITTED_ORG_ID = :" + UM_PERMITTED_ORG_ID +
