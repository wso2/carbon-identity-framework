...
public class SQLQueries {
    ...
    public static final String ADD_ROLE_SQL_OPTIMIZED = "INSERT INTO UM_HYBRID_ROLE (UM_ROLE_NAME, " +
            "UM_AUDIENCE_REF_ID, UM_UUID, UM_TENANT_ID) SELECT :UM_ROLE_NAME;, UM_HYBRID_ROLE_AUDIENCE.UM_ID, " +
            ":UM_UUID;, :UM_TENANT_ID; FROM UM_HYBRID_ROLE_AUDIENCE WHERE UM_AUDIENCE = :UM_AUDIENCE; " +
            "AND UM_AUDIENCE_ID = :UM_AUDIENCE_ID;";
    ...
    public static final String IS_ROLE_EXIST_SQL_OPTIMIZED = "SELECT COUNT(UM_HYBRID_ROLE.UM_ID) " +
            "FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE " +
            "ON UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID = UM_HYBRID_ROLE_AUDIENCE.UM_ID " +
            "WHERE UM_ROLE_NAME=:UM_ROLE_NAME; AND UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE=:UM_AUDIENCE; AND " +
    ...
    public static final String ADD_USER_TO_ROLE_SQL_OPTIMIZED = "INSERT INTO UM_HYBRID_USER_ROLE " +
            "(UM_USER_NAME, UM_ROLE_ID, UM_TENANT_ID, UM_DOMAIN_ID) VALUES (:UM_USER_NAME;,(SELECT UM_ID FROM " +
            "UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;), :UM_TENANT_ID;, " +
            "(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;))";
    ...
    public static final String ADD_USER_TO_ROLE_SQL_MSSQL_OPTIMIZED = "INSERT INTO UM_HYBRID_USER_ROLE " +
            "(UM_USER_NAME, UM_ROLE_ID, UM_TENANT_ID,  UM_DOMAIN_ID) SELECT (:UM_USER_NAME;),(SELECT UM_ID FROM " +
            "UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;), (:UM_TENANT_ID;), " +
            "(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;)";
    ...
    public static final String REMOVE_USER_FROM_ROLE_SQL_OPTIMIZED =
            "DELETE FROM UM_HYBRID_USER_ROLE WHERE UM_USER_NAME=:UM_USER_NAME; AND "
                    + "UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND "
                    + "UM_TENANT_ID=:UM_TENANT_ID;) AND " +
                    "UM_TENANT_ID=:UM_TENANT_ID; AND UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE " +
                    "UM_TENANT_ID=:UM_TENANT_ID; AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;)";
    ...
    public static final String GET_ROLE_ID_LIST_OF_USER_SQL_CASE_INSENSITIVE =
            "SELECT r.UM_UUID FROM UM_HYBRID_ROLE r INNER " +
            "JOIN UM_HYBRID_USER_ROLE ur ON r.UM_ID = ur.UM_ROLE_ID INNER JOIN UM_DOMAIN d ON " +
    ...
    public static final String ADD_GROUP_TO_ROLE_SQL_OPTIMIZED = "INSERT INTO UM_HYBRID_GROUP_ROLE (UM_GROUP_NAME, " +
            "UM_ROLE_ID, UM_TENANT_ID, UM_DOMAIN_ID) VALUES (:UM_GROUP_NAME;,(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE "
            + "UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;), :UM_TENANT_ID;, (SELECT UM_DOMAIN_ID FROM "
            + "UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;))";
    ...
    public static final String ADD_GROUP_TO_ROLE_SQL_MSSQL_OPTIMIZED = "INSERT INTO UM_HYBRID_GROUP_ROLE " +
            "(UM_GROUP_NAME, UM_ROLE_ID, UM_TENANT_ID,  UM_DOMAIN_ID) SELECT (:UM_GROUP_NAME;),(SELECT UM_ID " +
            "FROM UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;), (:UM_TENANT_ID;), " +
            "(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_DOMAIN_NAME=:UM_DOMAIN_NAME;)";
    ...
    public static final String GET_LIMITED_USER_LIST_OF_ROLE_SQL = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_DOMAIN WHERE UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE " +
            "UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;) " +
            "AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; " +
            "AND UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=UM_DOMAIN.UM_DOMAIN_ID " +
            "ORDER BY UM_HYBRID_USER_ROLE.UM_ROLE_ID DESC LIMIT :LIMIT; OFFSET :OFFSET;";

    public static final String GET_LIMITED_USER_LIST_OF_ROLE_MSSQL = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "UM_HYBRID_USER_ROLE, UM_DOMAIN WHERE UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE " +
            "UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;) " +
            "AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=UM_DOMAIN.UM_DOMAIN_ID ORDER BY UM_HYBRID_USER_ROLE.UM_ROLE_ID " +
            "DESC OFFSET :OFFSET; ROWS FETCH NEXT :LIMIT; ROWS ONLY";

    public static final String GET_LIMITED_USER_LIST_OF_ROLE_ORACLE = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "(SELECT UM_USER_NAME, UM_DOMAIN_NAME, rownum AS rnum FROM " +
            "(SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM UM_HYBRID_USER_ROLE, UM_DOMAIN WHERE UM_ROLE_ID=" +
            "(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;) " +
            "AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=UM_DOMAIN.UM_DOMAIN_ID ORDER BY UM_HYBRID_USER_ROLE.UM_ROLE_ID DESC) " +
            "WHERE rownum <= :END_INDEX;) WHERE rnum > :ZERO_BASED_START_INDEX;";

    public static final String GET_LIMITED_USER_LIST_OF_ROLE_DB2 = "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "(SELECT UM_USER_NAME, UM_DOMAIN_NAME, ROW_NUMBER() OVER (ORDER BY UM_HYBRID_USER_ROLE.UM_ROLE_ID DESC) " +
            "AS rn FROM UM_HYBRID_USER_ROLE, UM_DOMAIN WHERE UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE " +
            "UM_UUID=:UM_UUID; AND UM_TENANT_ID=:UM_TENANT_ID;) " +
            "AND UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; AND " +
            "UM_HYBRID_USER_ROLE.UM_DOMAIN_ID=UM_DOMAIN.UM_DOMAIN_ID) AS USERS " +
    ...
    public static final String GET_ROLE_BASIC_INFO_BY_ROLE_UUID_SQL = "SELECT UM_HYBRID_ROLE.UM_ID, UM_ROLE_NAME, " +
            "UM_AUDIENCE_ID, UM_AUDIENCE FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON " +
            "UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID = UM_HYBRID_ROLE_AUDIENCE.UM_ID WHERE UM_TENANT_ID=:UM_TENANT_ID; AND " +
            "UM_UUID=:UM_UUID;";
    ...
    public static final String REMOVE_GROUP_FROM_ROLE_SQL_OPTIMIZED =
            "DELETE FROM UM_HYBRID_GROUP_ROLE WHERE " + "UM_GROUP_NAME=:UM_GROUP_NAME; AND "
                    + "UM_ROLE_ID=(SELECT UM_ID FROM UM_HYBRID_ROLE WHERE UM_UUID=:UM_UUID; AND "
                    + "UM_TENANT_ID=:UM_TENANT_ID;) AND " +
                    "UM_TENANT_ID=:UM_TENANT_ID; AND UM_DOMAIN_ID=(SELECT UM_DOMAIN_ID FROM UM_DOMAIN WHERE "
    ...
    public static final String GET_ROLES_USERS_BY_TENANT_AND_ROLE = "SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME " +
            "FROM UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE " +
            "ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID " +
            "INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID " +
            "INNER JOIN UM_DOMAIN ON UM_DOMAIN.UM_DOMAIN_ID = UM_HYBRID_USER_ROLE.UM_DOMAIN_ID WHERE ";

    public static final String GET_ROLES_USERS_BY_TENANT_AND_ROLE_DB2 =
            "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT ROW_NUMBER() OVER (ORDER BY UM_USER_NAME) AS RN, " +
            "UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME " +
            "FROM UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE " +
            "ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID INNER JOIN UM_HYBRID_ROLE_AUDIENCE " +
            "ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID INNER JOIN UM_DOMAIN " +
            "ON UM_DOMAIN.UM_DOMAIN_ID = UM_HYBRID_USER_ROLE.UM_DOMAIN_ID WHERE ";

    public static final String GET_ROLES_USERS_BY_TENANT_USER_STORE_AND_ROLE =
            "SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME FROM " +
            "UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID " +
            "INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID " +
            "INNER JOIN UM_DOMAIN ON UM_DOMAIN.UM_DOMAIN_ID = UM_HYBRID_USER_ROLE.UM_DOMAIN_ID " +
            "WHERE UM_DOMAIN.UM_DOMAIN_NAME =:UM_DOMAIN_NAME; AND ";

    public static final String GET_ROLES_USERS_BY_TENANT_USER_STORE_AND_ROLE_DB2 =
            "SELECT UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT ROW_NUMBER() OVER (ORDER BY UM_USER_NAME) AS RN, " +
            "UM_USER_NAME, UM_DOMAIN_NAME FROM (SELECT DISTINCT UM_USER_NAME, UM_DOMAIN_NAME " +
            "FROM UM_HYBRID_USER_ROLE INNER JOIN UM_HYBRID_ROLE " +
            "ON UM_HYBRID_USER_ROLE.UM_ROLE_ID = UM_HYBRID_ROLE.UM_ID INNER JOIN UM_HYBRID_ROLE_AUDIENCE " +
            "ON UM_HYBRID_ROLE_AUDIENCE.UM_ID = UM_HYBRID_ROLE.UM_AUDIENCE_REF_ID INNER JOIN UM_DOMAIN " +
            "ON UM_DOMAIN.UM_DOMAIN_ID = UM_HYBRID_USER_ROLE.UM_DOMAIN_ID " +
            "WHERE UM_DOMAIN.UM_DOMAIN_NAME =:UM_DOMAIN_NAME; AND ";
    ...
    public static final String GET_USER_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MYSQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME LIMIT :OFFSET;, :LIMIT;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_ORACLE =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME) WHERE rownum <= :END_INDEX;) " +
            "WHERE rnum > :ZERO_BASED_START_INDEX;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_MSSQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME OFFSET :OFFSET; " +
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_POSTGRESQL =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME LIMIT :LIMIT; OFFSET :OFFSET;";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_DB2 =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ) AS DISTINCT_USERS ) AS USERS " +
            "WHERE RN BETWEEN :ONE_BASED_START_INDEX; AND :END_INDEX; ORDER BY RN";
    ...
    public static final String GET_USERS_ROLES_BY_TENANT_AND_ROLE_NAME_TAIL_INFORMIX =
            "UM_HYBRID_USER_ROLE.UM_TENANT_ID=:UM_TENANT_ID; ORDER BY UM_USER_NAME";
