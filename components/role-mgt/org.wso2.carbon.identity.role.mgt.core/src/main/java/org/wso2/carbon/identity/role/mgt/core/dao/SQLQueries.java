...
public class SQLQueries {
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_MYSQL = "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE " +
            "WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 ORDER BY UM_ID DESC LIMIT :OFFSET;, :LIMIT;";
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_ORACLE = "SELECT UM_ROLE_NAME FROM (SELECT " +
            "UM_ROLE_NAME, rownum AS rnum FROM (SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE " +
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_MSSQL = "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE " +
            "WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 ORDER BY UM_ID DESC OFFSET :OFFSET; ROWS " +
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_POSTGRESQL = "SELECT UM_ROLE_NAME FROM " +
    ...
    public static final String GET_ROLES_BY_TENANT_WITH_AUDIENCE_INFORMIX = "SELECT SKIP :OFFSET; FIRST "
            + ":LIMIT; UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 " +
            "ORDER BY UM_ID DESC";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_MYSQL = "SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE "
            ...
            + ":OFFSET;, :LIMIT;";
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_MYSQL = "SELECT UM_ROLE_NAME FROM " +
            "UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 AND UM_ROLE_NAME " +
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_ORACLE =
            "SELECT UM_ROLE_NAME FROM (SELECT UM_ROLE_NAME, rownum AS "
                    + "rnum FROM (SELECT UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND " +
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_POSTGRESQL = "SELECT UM_ROLE_NAME " +
            "FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 AND UM_ROLE_NAME LIKE " +
            ":UM_ROLE_NAME; ORDER BY UM_ID DESC LIMIT :LIMIT; OFFSET :OFFSET;";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_WITH_AUDIENCE_INFORMIX = "SELECT SKIP :OFFSET; FIRST "
            + ":LIMIT; UM_ROLE_NAME FROM UM_HYBRID_ROLE WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_AUDIENCE_REF_ID=-1 " +
            "AND UM_ROLE_NAME LIKE :UM_ROLE_NAME; ORDER BY UM_ID DESC";
