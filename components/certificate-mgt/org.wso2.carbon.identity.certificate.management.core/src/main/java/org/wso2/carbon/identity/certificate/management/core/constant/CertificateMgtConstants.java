...
package org.wso2.carbon.identity.certificate.management.core.constant;

/**
 * Constants for Certificate Management.
 */
public class CertificateMgtConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_EMPTY_FIELD("60002", "Invalid request.",
                "%s cannot be empty."),
        ERROR_INVALID_FIELD("60003", "Invalid request.",
                "%s is invalid."),
