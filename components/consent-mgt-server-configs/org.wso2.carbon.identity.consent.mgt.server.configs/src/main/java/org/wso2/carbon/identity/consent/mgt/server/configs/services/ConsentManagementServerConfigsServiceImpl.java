...
import org.wso2.carbon.identity.consent.mgt.server.configs.exceptions.ConsentMgtServerConfigsClientException;
...
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.EXTERNAL_CONSENT_PAGE;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.EXTERNAL_CONSENT_PAGE_CONFIGURATIONS;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.EXTERNAL_CONSENT_PAGE_URL;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.ErrorMessages.ERROR_GETTING_EXISTING_CONFIGURATIONS;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.ErrorMessages.ERROR_NO_EXTERNAL_CONSENT_PAGE_CONFIGURATIONS_FOUND;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.ErrorMessages.ERROR_NO_EXTERNAL_CONSENT_PAGE_URL_FOUND;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.RESOURCE_NAME;
import static org.wso2.carbon.identity.consent.mgt.server.configs.utils.Constants.RESOURCE_TYPE_NAME;

/**
 * Class for Consent Management Server Configs Service Implementation.
 */
public class ConsentManagementServerConfigsServiceImpl implements ConsentManagementServerConfigsService {

    private static final Log LOG = LogFactory.getLog(ConsentManagementServerConfigsServiceImpl.class);
     ...
     */
    public String getExternalConsentPageUrl(String tenantDomain) throws ConsentMgtServerConfigsException {
        ...
        if (externalConsentPageUrl.isEmpty()) {
            throw new ConsentMgtServerConfigsClientException(
    ...
    private List<Attribute> getResourceAttributesByTenant(String tenantDomain, Condition condition)
            throws ConsentMgtServerConfigsException {
        ...
        try {
           ...
           return resourceAttributes;
            ...
            throw new ConsentMgtServerConfigsServerException(ERROR_GETTING_EXISTING_CONFIGURATIONS.getCode(),
    ...
    private ConfigurationManager getConfigurationManager() {
        ...
        return ConsentManagementServerConfigsDataHolder.getConfigurationManager();
    }
}
