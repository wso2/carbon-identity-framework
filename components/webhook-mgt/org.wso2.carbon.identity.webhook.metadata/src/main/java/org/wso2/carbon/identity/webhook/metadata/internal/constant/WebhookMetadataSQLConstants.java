...
public final class WebhookMetadataSQLConstants {
    ...
    public static final class Query {
        ...
        public static final String CHECK_PROPERTY_EXISTS =
                "SELECT 1 FROM IDN_WEBHOOK_METADATA WHERE PROPERTY_NAME = :PROPERTY_NAME AND TENANT_ID = :TENANT_ID";

        public static final String INSERT_WEBHOOK_METADATA_PROPERTY =
                "INSERT INTO IDN_WEBHOOK_METADATA (PROPERTY_NAME, PROPERTY_TYPE, PRIMITIVE_VALUE, OBJECT_VALUE, TENANT_ID) " +
        ...
        public static final String UPDATE_WEBHOOK_METADATA_PROPERTY =
                "UPDATE IDN_WEBHOOK_METADATA SET PROPERTY_TYPE = :PROPERTY_TYPE, PRIMITIVE_VALUE = :PRIMITIVE_VALUE, " +
                        "OBJECT_VALUE = :OBJECT_VALUE WHERE PROPERTY_NAME = :PROPERTY_NAME AND TENANT_ID = :TENANT_ID";
