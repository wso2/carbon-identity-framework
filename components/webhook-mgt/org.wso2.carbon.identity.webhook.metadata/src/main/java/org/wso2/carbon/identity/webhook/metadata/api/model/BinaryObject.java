...
import org.wso2.carbon.identity.webhook.metadata.api.exception.WebhookMetadataRuntimeException;
...
/**
 * This class models the object typed webhook metadata property values.
 * It can be used to represent binary data as a string.
 */
public class BinaryObject {
    ...
    public static BinaryObject fromInputStream(InputStream inputStream) {
        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8))) {
            ...
            throw new WebhookMetadataRuntimeException("Error occurred while reading the input stream", e);
        }
    }
