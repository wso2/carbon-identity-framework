 ...
 */
public class WebhookManagementFacade implements WebhookManagementDAO {

    private static final Log LOG = LogFactory.getLog(WebhookManagementFacade.class);
     ...
     */
    public WebhookManagementFacade(WebhookManagementDAO webhookManagementDAO) {
    ...
    public void createWebhook(Webhook webhook, int tenantId) throws WebhookMgtException {
        ...
        WebhookSubscriberService subscriberService =
                WebhookManagementComponentServiceHolder.getInstance().getWebhookSubscriberService();

        try {
            jdbcTemplate.withTransaction(template -> {
                if (webhook.getStatus() == null || webhook.getStatus().equals("ACTIVE")) {
    ...
    public WebhookSearchResult listWebhooks(String status, int limit, int offset, int tenantId)
        ...
        return webhookManagementDAO.listWebhooks(status, limit, offset, tenantId);
    }
    ...
    /**
     * List webhook endpoints from the database.
     *
     * @param tenantId Tenant ID.
    ...
    public List<String> listWebhookEndpoints(int tenantId) throws WebhookMgtException {
        ...
        return webhookManagementDAO.listWebhookEndpoints(tenantId);
    }
