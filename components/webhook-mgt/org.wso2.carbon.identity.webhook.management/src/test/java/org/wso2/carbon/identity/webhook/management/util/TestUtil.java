...
public class TestUtil {
     ...
     * @param eventSchemaVersion Event schema version.
    ...
    public static Webhook buildMockWebhook(String id, String endpoint, String description, String secret,
                                           String version, String eventSchemaName, String eventSchemaUri,
                                           String eventSchemaVersion, String status, List<String> eventsSubscribed) {
        ...
        webhook.setEventSchemaVersion(eventSchemaVersion);
