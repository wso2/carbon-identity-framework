...
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.ATTRIBUTE_ID;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.ATTRIBUTE_VALUE;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.CATEGORY;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.DATA_TYPE;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.EDITOR_DATA;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.EDITOR_DATA_NAME;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.IS_ACTIVE;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.IS_IN_PAP;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.IS_IN_PDP;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.LAST_MODIFIED_TIME;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.LAST_MODIFIED_USER;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.POLICY;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.POLICY_EDITOR;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.POLICY_ID;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.POLICY_ORDER;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.POLICY_TYPE;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.REFERENCE;
import static org.wso2.carbon.identity.entitlement.PDPConstants.EntitlementTableColumns.SET_REFERENCE;
            ...
            try (ResultSet editorMetadata = getPolicyEditorDataPrepStmt.executeQuery()) {
                ...
                if (editorMetadata != null) {
                    while (editorMetadata.next()) {
                        String dataName =
                                editorMetadata.getString(EDITOR_DATA_NAME);
                        if (dataName.startsWith(PDPConstants.BASIC_POLICY_EDITOR_META_DATA)) {
                            int index = Integer.parseInt(
                                    dataName.substring(PDPConstants.BASIC_POLICY_EDITOR_META_DATA.length() + 1));
                            while (basicPolicyEditorMetaDataList.size() <= index) {
                                basicPolicyEditorMetaDataList.add(null);
                            }
                            basicPolicyEditorMetaDataList.set(index,
                                    editorMetadata.getString(PDPConstants.EntitlementTableColumns.EDITOR_DATA));
                        }
                    }
                }
        ...
        if (policyMetaData != null && policyMetaData.length > 0) {
            ...
            try (NamedPreparedStatement createPolicyEditorDataPrepStmt = new NamedPreparedStatement(connection,
                ...
                for (String policyData : policyMetaData) {
                    createPolicyEditorDataPrepStmt.setString(EDITOR_DATA_NAME,
                            (PDPConstants.BASIC_POLICY_EDITOR_META_DATA + "_" + index));
