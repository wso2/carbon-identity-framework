...
public class DAOConstants {
    ...
    public static class SQLQueries {
        ...
        public static final String CREATE_PAP_POLICY_SQL = "INSERT INTO IDN_XACML_POLICY (POLICY_ID, VERSION, " +
                ...
                "LAST_MODIFIED_TIME, LAST_MODIFIED_USER) VALUES (:POLICY_ID;, :VERSION;, :TENANT_ID;, :IS_IN_PDP;, " +
        ...
        public static final String GET_ALL_PAP_POLICIES_SQL = "SELECT t1.POLICY_ID, t1.VERSION, t1" +
                ...
                "AND t1.TENANT_ID = :TENANT_ID; AND t1.VERSION =(SELECT MAX(VERSION) FROM IDN_XACML_POLICY t2 WHERE " +
                "t2.POLICY_ID = t1.POLICY_ID AND t2.TENANT_ID=:TENANT_ID_1;)";
        public static final String DELETE_PAP_POLICY_SQL = "UPDATE IDN_XACML_POLICY SET IS_IN_PAP=:IS_IN_PAP; " +
                "WHERE POLICY_ID=:POLICY_ID; AND IS_IN_PDP=:IS_IN_PDP; AND TENANT_ID=:TENANT_ID;";
        ...
        public static final String GET_POLICY_PAP_PRESENCE_SQL = "SELECT POLICY_ID FROM IDN_XACML_POLICY WHERE " +
                "POLICY_ID=:POLICY_ID; AND IS_IN_PAP=:IS_IN_PAP; AND TENANT_ID=:TENANT_ID;";
        public static final String GET_PDP_POLICY_SQL =
                "SELECT POLICY, POLICY_ORDER, IS_ACTIVE, POLICY_TYPE, VERSION FROM IDN_XACML_POLICY WHERE " +
                        "POLICY_ID=:POLICY_ID; AND IS_IN_PDP=:IS_IN_PDP; AND TENANT_ID=:TENANT_ID;";
        ...
        public static final String DELETE_PUBLISHED_VERSIONS_SQL =
                "UPDATE IDN_XACML_POLICY SET IS_IN_PDP=:IS_IN_PDP;, IS_ACTIVE=:IS_ACTIVE;, POLICY_ORDER=:POLICY_ORDER;" +
                        " WHERE POLICY_ID=:POLICY_ID; AND TENANT_ID=:TENANT_ID; AND IS_IN_PDP=:IS_IN_PDP_1;";
        public static final String PUBLISH_POLICY_VERSION_SQL =
                "UPDATE IDN_XACML_POLICY SET IS_IN_PDP=:IS_IN_PDP; WHERE POLICY_ID=:POLICY_ID; AND " +
