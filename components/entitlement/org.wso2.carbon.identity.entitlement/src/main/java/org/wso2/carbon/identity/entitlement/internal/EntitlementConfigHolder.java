...
public class EntitlementConfigHolder {
     ...
     */
    private Map<PAPStatusDataHandlerModule, Properties> papStatusDataHandlers =
            new HashMap<PAPStatusDataHandlerModule, Properties>();

    /**
     * This holds all the policy storing logic of entitlement engine
     */
    private Map<PDPPolicyStoreModule, Properties> policyStore =
            new HashMap<PDPPolicyStoreModule, Properties>();

    /**
     * This holds all the policy versioning of PAP
     */
    private Map<PolicyDataStoreModule, Properties> policyDataStore =
            new HashMap<PolicyDataStoreModule, Properties>();


    /**
     * This holds all the policy storing logic of entitlement engine
     */
    private Map<PolicyVersionManagerModule, Properties> policyVersionModule =
            new HashMap<PolicyVersionManagerModule, Properties>();
    ...
    public Map<PDPPolicyStoreModule, Properties> getPolicyStore() {
        return policyStore;
    }

    public void addPolicyStore(PDPPolicyStoreModule policyStoreStore, Properties properties) {
    ...
    public Map<PAPStatusDataHandlerModule, Properties> getPapStatusDataHandlers() {
        return papStatusDataHandlers;
    }

    public void addNotificationHandler(PAPStatusDataHandlerModule notificationHandler,
                                       Properties properties) {
        this.papStatusDataHandlers.put(notificationHandler, properties);
    }

    public Map<PolicyVersionManagerModule, Properties> getPolicyVersionModule() {
        return policyVersionModule;
    }

    public void addPolicyVersionModule(PolicyVersionManagerModule policyVersionModule, Properties properties) {
        this.policyVersionModule.put(policyVersionModule, properties);
    }

    public Map<PolicyDataStoreModule, Properties> getPolicyDataStore() {
        return policyDataStore;
    }

    public void addPolicyDataStore(PolicyDataStoreModule policyDataStore, Properties properties) {
