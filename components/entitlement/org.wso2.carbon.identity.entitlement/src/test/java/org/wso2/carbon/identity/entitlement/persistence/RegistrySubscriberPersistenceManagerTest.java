...
/**
 * This class tests the behavior of the Registry Subscriber Persistence Manager class.
 */
@WithCarbonHome
...
public class RegistrySubscriberPersistenceManagerTest extends SubscriberPersistenceManagerTest {
    ...
    @Test(priority = 5)
    public void testIsSubscriberExists() throws EntitlementException {

        assertFalse(((RegistrySubscriberPersistenceManager) subscriberPersistenceManager).
                isSubscriberExists(SAMPLE_SUBSCRIBER_ID_1));
