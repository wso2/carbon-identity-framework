...
/**
 * This class tests the behavior of the JDBC Subscriber Persistence Manager class.
 */
@WithCarbonHome
...
public class JDBCSubscriberPersistenceManagerTest extends SubscriberPersistenceManagerTest {
    ...
    public void testIsSubscriberExists() throws EntitlementException {
        ...
        assertFalse(((JDBCSubscriberPersistenceManager) subscriberPersistenceManager).
