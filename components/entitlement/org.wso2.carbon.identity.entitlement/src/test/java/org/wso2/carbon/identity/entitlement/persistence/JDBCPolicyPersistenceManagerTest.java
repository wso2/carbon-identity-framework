...
public class JDBCPolicyPersistenceManagerTest extends PolicyPersistenceManagerTest {
    ...
    public void testGetPolicyIdentifiers() throws Exception {
        ...
        String[] policyIdentifiersBeforePublishing = ((JDBCPolicyPersistenceManager) policyPersistenceManager)
        ...
        String[] policyIdentifiersAfterPublishing = ((JDBCPolicyPersistenceManager) policyPersistenceManager).
                getPolicyIdentifiers();
