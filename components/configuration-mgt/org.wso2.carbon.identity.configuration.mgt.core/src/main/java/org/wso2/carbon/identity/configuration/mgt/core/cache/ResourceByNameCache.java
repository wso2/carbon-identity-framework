...
/**
 * Cache for {@link org.wso2.carbon.identity.configuration.mgt.core.model.Resource} from it's name.
 */
public class ResourceByNameCache extends BaseCache<ResourceByNameCacheKey, ResourceCacheEntry> {
    ...
    public ResourceByNameCache(String cacheName) {

        super(cacheName);
    }

    public ResourceByNameCache(String cacheName, boolean isTemp) {
