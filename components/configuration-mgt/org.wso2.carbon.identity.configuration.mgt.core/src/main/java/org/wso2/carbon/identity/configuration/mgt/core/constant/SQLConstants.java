...
public class SQLConstants {
    ...
    public static final String GET_FILES_BY_RESOURCE_TYPE_AND_TENANT_ID_SQL = "SELECT IDN_CONFIG_FILE.ID, "
            + "IDN_CONFIG_FILE.NAME FILE_NAME, IDN_CONFIG_RESOURCE.NAME RESOURCE_NAME, IDN_CONFIG_TYPE.NAME TYPE_NAME "
            + "FROM IDN_CONFIG_FILE INNER JOIN IDN_CONFIG_RESOURCE  ON IDN_CONFIG_FILE.RESOURCE_ID = "
            + "IDN_CONFIG_RESOURCE.ID INNER JOIN IDN_CONFIG_TYPE ON IDN_CONFIG_RESOURCE.TYPE_ID = "
            + "IDN_CONFIG_TYPE.ID WHERE IDN_CONFIG_TYPE.NAME = ? AND IDN_CONFIG_RESOURCE.TENANT_ID = ?";
}
