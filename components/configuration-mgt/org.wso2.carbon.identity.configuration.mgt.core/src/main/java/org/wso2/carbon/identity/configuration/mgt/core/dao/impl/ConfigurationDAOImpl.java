...
public class ConfigurationDAOImpl implements ConfigurationDAO {
    ...
    @Override
    public List<ResourceFile> getFilesByResourceType(String resourceType) throws ConfigurationManagementException {
        ...
        try {
            ...
            throw handleServerException(ERROR_CODE_GET_FILES_BY_TYPE, resourceType, e);
        }
    }
