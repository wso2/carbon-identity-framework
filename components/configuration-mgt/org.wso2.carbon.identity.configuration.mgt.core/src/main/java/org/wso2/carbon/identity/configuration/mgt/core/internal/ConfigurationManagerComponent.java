...
public class ConfigurationManagerComponent {
    ...
    private boolean isConfigurationManagementEnabled() {
        ...
        return IdentityDatabaseUtil.isTableExists("IDN_CONFIG_TYPE") && IdentityDatabaseUtil.isTableExists(
                "IDN_CONFIG_RESOURCE") && IdentityDatabaseUtil.isTableExists("IDN_CONFIG_ATTRIBUTE")
