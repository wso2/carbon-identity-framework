...
public class InputValidationMgtServerException extends InputValidationMgtException {
     ...
     */
    public InputValidationMgtServerException(String errorCode, String message) {
     ...
     */
    public InputValidationMgtServerException(String errorCode, String message, Throwable cause) {
     ...
     * @param cause If any error occurred when accessing the tenant.
     */
    public InputValidationMgtServerException(Throwable cause) {
