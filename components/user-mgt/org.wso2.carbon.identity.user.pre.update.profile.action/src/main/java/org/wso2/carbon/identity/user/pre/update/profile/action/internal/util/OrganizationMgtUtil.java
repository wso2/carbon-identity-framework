...
package org.wso2.carbon.identity.user.pre.update.profile.action.internal.util;
...
public class OrganizationMgtUtil {
    ...
    private static OrganizationManager getOrganizationManager() {
        ...
        return PreUpdateProfileActionServiceComponentHolder.getInstance().getOrganizationManager();
    }
}
