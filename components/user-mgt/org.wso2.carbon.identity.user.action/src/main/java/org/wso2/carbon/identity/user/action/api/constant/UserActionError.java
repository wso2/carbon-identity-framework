...
public class UserActionError {
    ...
    public static final String PRE_UPDATE_PROFILE_ACTION_EXECUTION_FAILED = "USER-ACTION-PRE-UPDATE-PROFILE-60002";
    public static final String PRE_UPDATE_PASSWORD_ACTION_EXECUTION_ERROR = "USER-ACTION-PRE-UPDATE-PASSWORD-65001";
    public static final String PRE_UPDATE_PROFILE_ACTION_EXECUTION_ERROR = "USER-ACTION-PRE-UPDATE-PROFILE-65004";
    ...
    public static final String PRE_UPDATE_PROFILE_ACTION_SERVER_ERROR = "USER-ACTION-PRE-UPDATE-PROFILE-65005";
