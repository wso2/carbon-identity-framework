...
public class Constants {
    ...
    public static class SQLQueries {
        ...
        public static final String RETRIEVE_ASSOCIATIONS_FOR_USER_BY_USERNAME = "SELECT IDP_USER_ID, IDP_ID, " +
                "ASSOCIATION_ID FROM IDN_ASSOCIATED_ID WHERE TENANT_ID = ? AND USER_NAME = ?";
    }
}
