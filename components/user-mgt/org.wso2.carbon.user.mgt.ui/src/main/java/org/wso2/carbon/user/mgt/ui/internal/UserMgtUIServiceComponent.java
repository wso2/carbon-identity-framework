...
package org.wso2.carbon.user.mgt.ui.internal;
...
public class UserMgtUIServiceComponent {

    private static final Log log = LogFactory.getLog(UserMgtUIServiceComponent.class);
