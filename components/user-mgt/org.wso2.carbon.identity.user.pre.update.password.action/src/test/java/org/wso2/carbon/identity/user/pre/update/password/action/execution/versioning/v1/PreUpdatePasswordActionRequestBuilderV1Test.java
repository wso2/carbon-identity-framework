...
package org.wso2.carbon.identity.user.pre.update.password.action.execution.versioning.v1;
...
/**
 * Unit tests for PreUpdatePasswordActionRequestBuilderV1, verifying request building and related logic.
 */
@WithCarbonHome
@WithRealmService(injectToSingletons = {PreUpdatePasswordActionServiceComponentHolder.class},
        initUserStoreManager = true)
public class PreUpdatePasswordActionRequestBuilderV1Test {
    ...
    private PreUpdatePasswordRequestBuilderV1 preUpdatePasswordActionRequestBuilderV1;
    ...
    public void setUp() throws Exception {
        ...
        preUpdatePasswordActionRequestBuilderV1 = new PreUpdatePasswordRequestBuilderV1();
    ...
    public void getSupportedActionType() {
        ...
        assertEquals(preUpdatePasswordActionRequestBuilderV1.getSupportedActionType(), ActionType.PRE_UPDATE_PASSWORD);
    }
    ...
    public void testRequestBuilder(boolean isOrganizationFlow, Flow mockedFlow,
        ...
        ActionExecutionRequest actionExecutionRequest =
                preUpdatePasswordActionRequestBuilderV1.buildActionExecutionRequest(
    ...
    public void testRequestBuilderWithErrorFromClaimMetaDataService() throws Exception {
        ...
        preUpdatePasswordActionRequestBuilderV1.buildActionExecutionRequest(flowContext,
