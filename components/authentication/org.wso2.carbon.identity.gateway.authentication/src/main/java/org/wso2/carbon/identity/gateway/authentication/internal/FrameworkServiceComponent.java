...
package org.wso2.carbon.identity.gateway.authentication.internal;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.osgi.framework.BundleContext;
import org.osgi.service.component.ComponentContext;
import org.wso2.carbon.identity.gateway.authentication.demo.DemoSequenceBuildFactory;
import org.wso2.carbon.identity.gateway.authentication.processor.AuthenticationProcessor;
import org.wso2.carbon.identity.gateway.authentication.processor.authenticator.ApplicationAuthenticator;
...
import org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.AuthenticationHandler;
...
import org.wso2.carbon.identity.gateway.authentication.processor.handler.authorization.AbstractAuthorizationHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.claim.ClaimHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.extension.AbstractPostHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.extension.AbstractPreHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.extension.ExtensionHandlerPoints;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.jit.JITHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.response.AbstractResponseHandler;
import org.wso2.carbon.identity.gateway.authentication.processor.request.FrameworkLoginRequestFactory;
import org.wso2.carbon.identity.gateway.framework.IdentityProcessor;
import org.wso2.carbon.identity.gateway.authentication.processor.handler.request.AbstractRequestHandler;
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.authenticator.ApplicationAuthenticator"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.request.AbstractRequestHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.AuthenticationHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authorization.AbstractAuthorizationHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.jit.JITHandler"
 * cardinality="0..n" policy="dynamic" bind="addJITHandler"
 * unbind="unSetJITHandler"
 * @scr.reference name="identity.handlers.claim"
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.claim.ClaimHandler"
 * cardinality="0..n" policy="dynamic" bind="addClaimHandler"
 * unbind="unSetClaimHandler"
 * @scr.reference name="identity.handlers.response"
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.response.AbstractResponseHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.extension.AbstractPreHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.extension.AbstractPostHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.impl.AbstractSequenceBuildFactory"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.impl.SequenceManager"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.impl.RequestPathHandler"
 ...
 * interface="org.wso2.carbon.identity.gateway.authentication.processor.handler.authentication.impl.StepHandler"
