...
public class ConsentServerConfigsMgtClientException extends ConsentServerConfigsMgtException {
     ...
     */
    public ConsentServerConfigsMgtClientException(String errorCode, String message) {
     ...
     */
    public ConsentServerConfigsMgtClientException(String errorCode, String message, String description) {
     ...
     */
    public ConsentServerConfigsMgtClientException(String errorCode, String message, Throwable cause) {
     ...
     * @param cause If any error occurred when accessing the tenant.
     */
    public ConsentServerConfigsMgtClientException(Throwable cause) {
