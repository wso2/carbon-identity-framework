...
public class AuthMethodsTest {
    ...
    public void testBearerAuth() {
        ...
        AuthProperty accessTokenProperty = new AuthProperty.AuthPropertyBuilder()
                .name(AuthType.AUTH_PROPERTY_ACCESS_TOKEN)
                .isConfidential(true)
                .value("testToken")
                .build();
        ...
        assertEquals(AuthType.AuthenticationType.BEARER.getType(), bearerAuth.getAuthType());
    ...
    public void testBasicAuth() {
        ...
        AuthProperty usernameProperty = new AuthProperty.AuthPropertyBuilder()
                .name(AuthType.AUTH_PROPERTY_USERNAME)
                .isConfidential(true)
                .value("testUser")
                .build();
        AuthProperty passwordProperty = new AuthProperty.AuthPropertyBuilder()
                .name(AuthType.AUTH_PROPERTY_PASSWORD)
                .isConfidential(true)
                .value("testPass")
                .build();
        ...
        assertEquals(AuthType.AuthenticationType.BASIC.getType(), basicAuth.getAuthType());
    ...
    public void testAPIKeyAuth() {
        ...
        AuthProperty headerProperty = new AuthProperty.AuthPropertyBuilder()
                .name(AuthType.AUTH_PROPERTY_HEADER)
                .isConfidential(false)
                .value("x-api-key")
                .build();
        AuthProperty valueProperty = new AuthProperty.AuthPropertyBuilder()
                .name(AuthType.AUTH_PROPERTY_VALUE)
                .isConfidential(true)
                .value("testApiKey")
                .build();
        ...
        assertEquals(AuthType.AuthenticationType.API_KEY.getType(), apiKeyAuth.getAuthType());
