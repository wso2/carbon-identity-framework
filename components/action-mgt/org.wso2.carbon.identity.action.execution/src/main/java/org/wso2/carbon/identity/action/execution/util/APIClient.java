...
public class APIClient {
    ...
    private ActionInvocationSuccessResponse handleSuccessResponse(HttpEntity responseEntity) throws ActionInvocationException {
    ...
    private ActionInvocationErrorResponse handleErrorResponse(HttpEntity responseEntity) throws ActionInvocationException {
