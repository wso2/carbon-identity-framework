...
public class ActionExecutorServiceImpl implements ActionExecutorService {
    ...
    public void execute(ActionType actionType, Map<String, Object> eventContext, String tenantDomain)
            throws ActionExecutionException {

        ActionExecutionRequest actionRequest =
                ActionExecutionRequestBuilderFactory.buildActionExecutionRequest(actionType, eventContext);
        ...
        try {
            ...
            log.warn("Skip executing actions for action type: " + actionType.name() +
                    ". Error occurred while retrieving actions.");
        ...
        for (Action action : actions) {
            executeAction(action, actionRequest, actionType, eventContext, actionExecutionResponseProcessor);
        }
    }

    private void executeAction(Action action, ActionExecutionRequest actionRequest, ActionType actionType,
        ...
        AuthMethods.AuthMethod authenticationMethod = null;
        ...
        try {
            ...
            processActionResponse(actionInvocationResponse, actionType, eventContext, actionRequest, action.getId(),
                    apiEndpoint, authenticationMethod, actionExecutionResponseProcessor
                                 );

        } catch (ActionMgtException | JsonProcessingException e) {
            //todo: Add to diagnostics
            log.warn("Skip executing action: " + action.getId() + " for action type: " + actionType +
    ...
    private void processActionResponse(ActionInvocationResponse actionInvocationResponse, ActionType actionType,
                                       Map<String, Object> eventContext, ActionExecutionRequest actionRequest,
        ...
        if (actionInvocationResponse.isSuccess()) {
            processSuccessResponse((ActionInvocationSuccessResponse) actionInvocationResponse.getResponse(), actionType,
            ...
            processErrorResponse((ActionInvocationErrorResponse) actionInvocationResponse.getResponse(), actionType,
                    eventContext, actionRequest, actionId, apiEndpoint, authenticationMethod,
                    actionExecutionResponseProcessor);
        } else {
    ...
    private void processSuccessResponse(ActionInvocationSuccessResponse successResponse, ActionType actionType,
                                        Map<String, Object> eventContext, ActionExecutionRequest actionRequest,
                                        String actionId, String apiEndpoint,
                                        AuthMethods.AuthMethod authenticationMethod,
                                        ActionExecutionResponseProcessor actionExecutionResponseProcessor)
        ...
        actionExecutionResponseProcessor.processSuccessResponse(actionType, eventContext, actionRequest.getEvent(),
                successResponseBuilder.build());
    }

    private void processErrorResponse(ActionInvocationErrorResponse errorResponse, ActionType actionType,
                                      Map<String, Object> eventContext, ActionExecutionRequest actionRequest,
                                      String actionId, String apiEndpoint,
                                      AuthMethods.AuthMethod authenticationMethod,
                                      ActionExecutionResponseProcessor actionExecutionResponseProcessor)
        ...
        actionExecutionResponseProcessor.processErrorResponse(actionType, eventContext, actionRequest.getEvent(),
                errorResponse);
    }
