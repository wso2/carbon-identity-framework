 ...
 * Operation is defined by the operation type and the paths that the operation is performed on.
 * Operations follow JSON Patch format (RFC 6902) semantics to define the operations that are performed.
 */
