...
public class ActionMgtSQLConstants {
    ...
    public static class Query {
        ...
        public static final String ADD_ACTION_TO_ACTION_TYPE = "INSERT INTO IDN_ACTION (UUID, TYPE, NAME, " +
                "DESCRIPTION, STATUS, TENANT_ID, VERSION, CREATED_AT, UPDATED_AT) VALUES (:UUID;, :TYPE;, :NAME;, " +
                ":DESCRIPTION;, :STATUS;, :TENANT_ID;, :VERSION;, :CREATED_AT;, :UPDATED_AT;)";
        ...
        public static final String GET_ACTION_BASIC_INFO_BY_ID = "SELECT TYPE, NAME, DESCRIPTION, STATUS, CREATED_AT," +
                " UPDATED_AT FROM IDN_ACTION WHERE TYPE = :TYPE; AND UUID = :UUID; AND TENANT_ID = :TENANT_ID;";
        ...
        public static final String GET_ACTIONS_BASIC_INFO_BY_ACTION_TYPE = "SELECT UUID, TYPE, NAME, DESCRIPTION," +
                " STATUS, CREATED_AT, UPDATED_AT FROM IDN_ACTION WHERE TYPE = :TYPE; AND TENANT_ID = :TENANT_ID;";
        public static final String UPDATE_ACTION_BASIC_INFO = "UPDATE IDN_ACTION SET NAME = :NAME;, DESCRIPTION = " +
                ":DESCRIPTION;, UPDATED_AT = :UPDATED_AT; WHERE UUID = :UUID; AND TYPE = :TYPE; AND " +
                "TENANT_ID = :TENANT_ID;";
