...
public class ActionMgtSQLConstants {
    ...
    public static class Query {
        ...
        public static final String ADD_ACTION_PROPERTIES = "INSERT INTO IDN_ACTION_PROPERTIES (ACTION_UUID, " +
                "PROPERTY_NAME, PROPERTY_TYPE, PRIMITIVE_VALUE, OBJECT_VALUE, TENANT_ID) VALUES (:ACTION_UUID;, " +
                ":PROPERTY_NAME;, :PROPERTY_TYPE;, :PRIMITIVE_VALUE;, :OBJECT_VALUE;, :TENANT_ID;)";
        ...
        public static final String GET_ACTION_PROPERTIES_INFO_BY_ID = "SELECT PROPERTY_NAME, PROPERTY_TYPE, " +
                "PRIMITIVE_VALUE, OBJECT_VALUE FROM IDN_ACTION_PROPERTIES WHERE ACTION_UUID = :ACTION_UUID; AND " +
                "TENANT_ID = :TENANT_ID;";
        ...
        public static final String UPDATE_ACTION_PROPERTY = "UPDATE IDN_ACTION_PROPERTIES SET " +
                "PRIMITIVE_VALUE = :PRIMITIVE_VALUE;, OBJECT_VALUE = :OBJECT_VALUE; WHERE ACTION_UUID = " +
