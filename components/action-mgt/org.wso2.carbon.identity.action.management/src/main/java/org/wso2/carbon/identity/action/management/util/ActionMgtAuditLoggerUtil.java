...
/**
 * Action management V2 audit logger util class.
 */
public class ActionMgtAuditLoggerUtil {
     ...
     */
    public void printActionAuditLog(Operation operation, Action action) {
     ...
     * @param action    Action object to be logged.
     */
    public void printActionAuditLog(Operation operation, String actionId, Action action) {
     ...
     * @param actionId   ID of the action to be logged.
     */
    public void printActionAuditLog(Operation operation, String actionType, String actionId) {
    ...
    private JSONObject getAllEndpointData(EndpointConfig endpointConfig) {
        ...
        endpointData.put(LogConstants.ENDPOINT_AUTHENTICATION_SCHEME_FIELD, authentication.getType().getName());
    ...
    private JSONObject getEndpointData(EndpointConfig endpointConfig) {
        ...
        if (endpointConfig.getAuthentication() != null) {
            Authentication authentication = endpointConfig.getAuthentication();
            endpointData.put(LogConstants.ENDPOINT_AUTHENTICATION_SCHEME_FIELD, authentication.getType());
            switch (authentication.getType()) {
                case BASIC:
