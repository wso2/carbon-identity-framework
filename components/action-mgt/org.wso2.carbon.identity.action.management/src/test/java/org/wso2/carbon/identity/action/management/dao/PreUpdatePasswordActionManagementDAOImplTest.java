...
@WithCarbonHome
public class PreUpdatePasswordActionManagementDAOImplTest {
    ...
    public void testAddPreUpdatePasswordAction() throws ActionMgtException, CertificateMgtException {
        ...
        preUpdatePasswordAction = (PreUpdatePasswordAction) daoImpl.addAction(PRE_UPDATE_PASSWORD_TYPE,
                PRE_UPDATE_PASSWORD_ACTION_ID, actionModel, TENANT_ID);

        Assert.assertEquals(PRE_UPDATE_PASSWORD_ACTION_ID, preUpdatePasswordAction.getId());
    ...
    public void testGetPreUpdatePasswordActionsByActionType() throws ActionMgtException, CertificateMgtException {
        ...
        doReturn(certificate).when(certificateManagementService).getCertificate(anyString(), anyString());
        List<Action> preUpdatePasswordActionList = daoImpl.getActionsByActionType(PRE_UPDATE_PASSWORD_TYPE, TENANT_ID);
    ...
    public void testGetPreUpdatePasswordActionByActionId() throws ActionMgtException, CertificateMgtException {
        ...
        doReturn(certificate).when(certificateManagementService).getCertificate(anyString(), anyString());
        PreUpdatePasswordAction fetchedAction = (PreUpdatePasswordAction)
                daoImpl.getActionByActionId(PRE_UPDATE_PASSWORD_TYPE, PRE_UPDATE_PASSWORD_ACTION_ID, TENANT_ID);
    ...
    public void testUpdatePreUpdatePasswordAction() throws ActionMgtException, CertificateMgtException {
        ...
        PreUpdatePasswordAction updatedAction = (PreUpdatePasswordAction) daoImpl.updateAction(
                PRE_UPDATE_PASSWORD_TYPE, PRE_UPDATE_PASSWORD_ACTION_ID, updateActionModel,
                preUpdatePasswordAction, TENANT_ID);
    ...
    public void testUpdatePreUpdatePasswordActionWithServerErrorFromCertificate() throws CertificateMgtException {
        ...
        try {
            daoImpl.updateAction(PRE_UPDATE_PASSWORD_TYPE, PRE_UPDATE_PASSWORD_ACTION_ID, updateActionModel,
                    preUpdatePasswordAction, TENANT_ID);
    ...
    @Test(priority = 10, dependsOnMethods = "testUpdatePreUpdatePasswordAction")
    ...
    public void testDeletePreUpdatePasswordAction() throws ActionMgtException, CertificateMgtException {
        ...
        Assert.assertNull(daoImpl.getActionByActionId(PRE_UPDATE_PASSWORD_TYPE, PRE_UPDATE_PASSWORD_ACTION_ID,
                TENANT_ID));
    }

    @Test(priority = 12, dependsOnMethods = "testAddPreUpdatePasswordAction")
    public void testAddPreUpdatePasswordActionWithServerErrorFromCertificate() throws CertificateMgtException {
        ...
        try {
            daoImpl.addAction(PRE_UPDATE_PASSWORD_TYPE, PRE_UPDATE_PASSWORD_ACTION_ID, actionModel, TENANT_ID);
    ...
    @Test(priority = 13, dependsOnMethods = "testAddPreUpdatePasswordAction")
