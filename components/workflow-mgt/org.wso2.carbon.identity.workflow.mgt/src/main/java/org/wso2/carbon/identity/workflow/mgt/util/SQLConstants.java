...
public class SQLConstants {
    ...
    public static final String OPERATION_FILTER = "operation";
    ...
    public static final String GET_ASSOCIATIONS_BY_TENANT_AND_ASSOC_NAME_MYSQL = "SELECT WF_WORKFLOW.WF_NAME, " +
            ...
            "WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW_ASSOCIATION.EVENT_ID LIKE ? ORDER BY ID ASC LIMIT ?, ? ";

    public static final String GET_ASSOCIATIONS_BY_TENANT_AND_ASSOC_NAME_ORACLE = "SELECT WF_WORKFLOW.WF_NAME, " +
            "WF_WORKFLOW_ASSOCIATION.ID, WF_WORKFLOW_ASSOCIATION.ASSOC_NAME, WF_WORKFLOW_ASSOCIATION.EVENT_ID, " +
            "WF_WORKFLOW_ASSOCIATION.ASSOC_CONDITION, WF_WORKFLOW_ASSOCIATION.IS_ENABLED FROM " +
            "WF_WORKFLOW,WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID AND " +
            "WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW_ASSOCIATION.EVENT_ID LIKE ? ORDER BY ID ASC OFFSET ? ROWS " +
    ...
    public static final String GET_ASSOCIATIONS_BY_TENANT_AND_ASSOC_NAME_POSTGRESQL = "SELECT WF_WORKFLOW.WF_NAME, " +
            ...
            "WF_WORKFLOW_ASSOCIATION.ASSOC_CONDITION, WF_WORKFLOW_ASSOCIATION.IS_ENABLED FROM " +
            "WF_WORKFLOW,WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID AND " +
            "WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW_ASSOCIATION.EVENT_ID LIKE ? ORDER BY ID ASC LIMIT ? OFFSET ? ";
    ...
    public static final String GET_ASSOCIATIONS_COUNT_QUERY_BY_OPERATION = "SELECT COUNT(WORKFLOW_ID) " +
            "FROM WF_WORKFLOW, WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID " +
            "AND WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW_ASSOCIATION.EVENT_ID LIKE ?";

    public static final String GET_ASSOCIATIONS_COUNT_QUERY_BY_WORKFLOW_ID = "SELECT COUNT(WORKFLOW_ID) " +
            "FROM WF_WORKFLOW, WF_WORKFLOW_ASSOCIATION WHERE WF_WORKFLOW.ID = WF_WORKFLOW_ASSOCIATION.WORKFLOW_ID " +
            "AND WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW.ID = ?";
    ...
    public static final String GET_WORKFLOW_BY_ID = "SELECT WF_WORKFLOW.WF_NAME, WF_WORKFLOW.DESCRIPTION, WF_WORKFLOW" +
            ".TEMPLATE_ID, WF_WORKFLOW.IMPL_ID, WF_WORKFLOW.TENANT_ID FROM WF_WORKFLOW WHERE TENANT_ID = ? AND " +
            "WF_WORKFLOW.ID = ?";

    public static final String GET_WORKFLOW_BY_NAME = "SELECT WF_WORKFLOW.ID, WF_WORKFLOW.DESCRIPTION, WF_WORKFLOW" +
            ".TEMPLATE_ID, WF_WORKFLOW.IMPL_ID, WF_WORKFLOW.TENANT_ID FROM WF_WORKFLOW WHERE " +
            "WF_WORKFLOW.TENANT_ID = ? AND WF_WORKFLOW.WF_NAME = ?";
    ...
    public static final String DELETE_ENTITY_RELATIONS_BY_WORKFLOW_ID_QUERY =
            "DELETE FROM WF_REQUEST_ENTITY_RELATIONSHIP WHERE REQUEST_ID IN " +
            "(SELECT REQUEST_ID FROM WF_WORKFLOW_REQUEST_RELATION WHERE WORKFLOW_ID = ?)";
