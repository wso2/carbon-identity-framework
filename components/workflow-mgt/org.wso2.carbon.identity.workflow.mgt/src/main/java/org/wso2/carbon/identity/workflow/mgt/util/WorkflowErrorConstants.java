...
public class WorkflowErrorConstants {
    ...
    public enum ErrorMessages {
        ...
        ERROR_CODE_USER_WF_ROLE_PENDING_APPROVAL("WFM-10007",
                "There is the pending deletion/update workflow for the role: %s"),
        ...
        ERROR_CODE_ROLE_WF_ROLE_NOT_FOUND("WFM-10010",
                "The role is not found in the system."),
        ERROR_CODE_ROLE_WF_USER_NOT_FOUND("WFM-10011",
                "The user %s is not found in the system for assign the role."),
        ERROR_CODE_ROLE_WF_USER_PENDING_APPROVAL("WFM-10012",
