 ...
 */
public class ProvisioningRoleMgtV3Listener extends AbstractRoleManagementListener {

    private static final Log LOG = LogFactory.getLog(ProvisioningRoleMgtV3Listener.class);
    ...
    public void postUpdateUserListOfRole(String roleId, List<String> newUserIDList, List<String> deletedUserIDList,
        ...
        try {
            ...
            RoleBasicInfo roleBasicInfo = ProvisioningServiceDataHolder.getInstance().getRoleManagementServiceV3()
