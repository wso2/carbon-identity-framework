...
public class ProvisioningRoleMgtV3ListenerTest {
    ...
    ProvisioningRoleMgtV3Listener ProvisioningRoleMgtV3Listener = new ProvisioningRoleMgtV3Listener();
    ...
    public void setup() {
        ...
        ProvisioningServiceDataHolder.getInstance().setRoleManagementServiceV3(roleManagementService);
    ...
    public void testUserStoreException()
        ...
        try (MockedStatic<IdentityTenantUtil> identityTenantUtil = Mockito.mockStatic(IdentityTenantUtil.class)) {
            ...
            ProvisioningRoleMgtV3Listener.postUpdateUserListOfRole("roleId", new ArrayList<>(), new ArrayList<>(),
                    "carbon.super");
        }
    }
    ...
    public void testUpdateRoleWithoutUserAddOrDeletion()
        ...
        try (MockedStatic<IdentityTenantUtil> identityTenantUtil = Mockito.mockStatic(IdentityTenantUtil.class)) {
            ...
            identityTenantUtil.when(()-> IdentityTenantUtil.getTenantId(MultitenantConstants.SUPER_TENANT_DOMAIN_NAME))
                    .thenReturn(MultitenantConstants.SUPER_TENANT_ID);
            ProvisioningRoleMgtV3Listener.postUpdateUserListOfRole("roleId", new ArrayList<>(), new ArrayList<>(), "carbon.super");
    ...
    public void testUpdateApplicationAudienceRole()
        ...
        try (MockedStatic<IdentityTenantUtil> identityTenantUtil = Mockito.mockStatic(IdentityTenantUtil.class)) {
            ...
            ProvisioningRoleMgtV3Listener.postUpdateUserListOfRole("roleId", Collections.singletonList("JOHN"),
    ...
    public void testListenerEnabled() {
        ...
        try (MockedStatic<IdentityUtil> identityUtil = Mockito.mockStatic(IdentityUtil.class)) {
            ...
            assert ProvisioningRoleMgtV3Listener.isEnable();
        }
    }
    ...
    public void testListenerDefaultOrder() {
        ...
        try (MockedStatic<IdentityUtil> identityUtil = Mockito.mockStatic(IdentityUtil.class)) {
            ...
            assert ProvisioningRoleMgtV3Listener.getDefaultOrderId() == 100;
        }
    }
}
