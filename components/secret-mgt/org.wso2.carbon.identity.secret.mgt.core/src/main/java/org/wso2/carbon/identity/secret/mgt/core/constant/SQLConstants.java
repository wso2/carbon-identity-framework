...
public class SQLConstants {
    ...
    public static final String INSERT_SECRET_ORACLE = "INSERT INTO IDN_SECRET( ID, TENANT_ID, SECRET_NAME, SECRET_VALUE_CLOB, CREATED_TIME, " +
            "LAST_MODIFIED, TYPE_ID, DESCRIPTION ) VALUES(:ID; ,:TENANT_ID; ,:SECRET_NAME; , :SECRET_VALUE_CLOB; , :CREATED_TIME; , :LAST_MODIFIED; , :TYPE; , :DESCRIPTION;)";
    ...
    public static final String UPDATE_SECRET_ORACLE = "UPDATE IDN_SECRET SET SECRET_NAME = :SECRET_NAME; ,SECRET_VALUE = :SECRET_VALUE; , SECRET_VALUE_CLOB = :SECRET_VALUE_CLOB; , LAST_MODIFIED " +
            "= :LAST_MODIFIED; , TYPE_ID = :TYPE; , DESCRIPTION = :DESCRIPTION; WHERE ID = :ID;";
    ...
    public static final String GET_SECRET_BY_NAME_ORACLE = "SELECT ID,TENANT_ID,SECRET_NAME,SECRET_VALUE,SECRET_VALUE_CLOB,CREATED_TIME,LAST_MODIFIED,TYPE_ID,DESCRIPTION FROM " +
            "IDN_SECRET WHERE SECRET_NAME = :SECRET_NAME; AND TYPE_ID = :TYPE; AND TENANT_ID = :TENANT_ID;";
    ...
    public static final String GET_SECRET_BY_ID_ORACLE = "SELECT IDN_SECRET.ID,IDN_SECRET.TENANT_ID,IDN_SECRET.SECRET_NAME,IDN_SECRET.SECRET_VALUE,SECRET_VALUE_CLOB,CREATED_TIME, LAST_MODIFIED, IDN_SECRET_TYPE.NAME, " +
            "IDN_SECRET.DESCRIPTION FROM IDN_SECRET INNER JOIN IDN_SECRET_TYPE ON IDN_SECRET.TYPE_ID = IDN_SECRET_TYPE.ID WHERE IDN_SECRET.ID = :ID; AND TENANT_ID = :TENANT_ID;";
    ...
    public static final String UPDATE_SECRET_VALUE_ORACLE = "UPDATE IDN_SECRET SET SECRET_VALUE = :SECRET_VALUE; , SECRET_VALUE_CLOB = :SECRET_VALUE_CLOB; , " +
