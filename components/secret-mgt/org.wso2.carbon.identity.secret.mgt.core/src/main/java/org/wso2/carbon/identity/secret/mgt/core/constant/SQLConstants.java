...
public class SQLConstants {
    ...
    public static final String DELETE_SECRET = "DELETE FROM IDN_SECRET WHERE SECRET_NAME = :SECRET_NAME; " +
            "AND TYPE_ID = :TYPE_ID; AND TENANT_ID = :TENANT_ID;";
    ...
    public static final String UPDATE_SECRET_DESCRIPTION = "UPDATE IDN_SECRET SET DESCRIPTION = :DESCRIPTION; , " +
            "LAST_MODIFIED = :LAST_MODIFIED; WHERE ID = :ID;";
}
