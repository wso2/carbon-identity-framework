...
public class SQLConstants {
    ...
    public static final String INSERT_SECRET = "INSERT INTO IDN_SECRET( ID, TENANT_ID, SECRET_NAME, SECRET_VALUE, CREATED_TIME, " +
            "LAST_MODIFIED, TYPE_ID, DESCRIPTION ) VALUES(:ID; ,:TENANT_ID; ,:SECRET_NAME; , :SECRET_VALUE; , :CREATED_TIME; , :LAST_MODIFIED; , :TYPE_ID; , :DESCRIPTION;)";
    ...
    public static final String GET_SECRET_BY_NAME = "SELECT ID,TENANT_ID,SECRET_NAME,SECRET_VALUE,CREATED_TIME,LAST_MODIFIED,TYPE_ID,DESCRIPTION FROM " +
            "IDN_SECRET WHERE SECRET_NAME = :SECRET_NAME; AND TYPE_ID = :TYPE_ID; AND TENANT_ID = :TENANT_ID;";

    public static final String GET_SECRET_NAME_BY_ID = "SELECT SECRET_NAME FROM IDN_SECRET WHERE ID = :ID; AND TENANT_ID =" +
            " :TENANT_ID;";

    public static final String GET_SECRET_BY_ID = "SELECT ID,TENANT_ID,SECRET_NAME,SECRET_VALUE,CREATED_TIME,LAST_MODIFIED,TYPE_ID,DESCRIPTION FROM" +
    ...
    public static final String DELETE_SECRET = "DELETE FROM IDN_SECRET WHERE SECRET_NAME = :SECRET_NAME; AND TYPE_ID = :TYPE_ID; AND TENANT_ID = :TENANT_ID;";
    ...
    public static final String GET_SECRETS =
            "SELECT ID, TENANT_ID, SECRET_NAME, LAST_MODIFIED, CREATED_TIME, DESCRIPTION FROM IDN_SECRET WHERE TYPE_ID = :TYPE_ID; AND TENANT_ID = :TENANT_ID;";
