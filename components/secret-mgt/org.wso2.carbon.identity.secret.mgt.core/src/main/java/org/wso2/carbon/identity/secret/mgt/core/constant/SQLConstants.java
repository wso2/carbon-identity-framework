...
public class SQLConstants {
    ...
    public static final String UPDATE_SECRET = "UPDATE IDN_SECRET SET NAME = ?,VALUE = ?, LAST_MODIFIED = ?" +
            " WHERE ID = ?";

    public static final String GET_SECRET_BY_NAME = "SELECT ID,TENANT_ID,NAME,CREATED_TIME, LAST_MODIFIED FROM " +
            "IDN_SECRET WHERE NAME = ? AND TENANT_ID = ? ";

    public static final String GET_SECRET_WITH_VALUE_BY_NAME = "SELECT ID,TENANT_ID,NAME,VALUE, CREATED_TIME, LAST_MODIFIED FROM " +
            "IDN_SECRET WHERE NAME = ? AND TENANT_ID = ? ";

    public static final String GET_SECRET_NAME_BY_ID = "SELECT NAME FROM IDN_SECRET WHERE ID = ? AND TENANT_ID = ?";
    ...
    public static final String DELETE_SECRET_BY_ID = "DELETE FROM IDN_SECRET WHERE ID = ? AND TENANT_ID = ?";
