...
public class SQLConstants {
    ...
    public static final String ADD_AUTHORIZATION_DETAILS_TYPE_H2 = "INSERT INTO AUTHORIZATION_DETAILS_TYPES " +
            "(ID, TYPE, API_ID, NAME, DESCRIPTION, JSON_SCHEMA, TENANT_ID) VALUES (?, ?, ?, ?, ?, ? FORMAT JSON, ?)";
    ...
    public static final String GET_AUTHORIZATION_DETAILS_TYPE_BY_TENANT_ID_PREFIX = "SELECT " +
            "ID, TYPE, API_ID, NAME, DESCRIPTION, JSON_SCHEMA, TENANT_ID FROM AUTHORIZATION_DETAILS_TYPES WHERE ";
    ...
    public static final String DELETE_AUTHORIZATION_DETAILS_TYPE_BY_API_ID_AND_TYPE_ID = "DELETE FROM " +
            "AUTHORIZATION_DETAILS_TYPES WHERE API_ID = ? AND ID = ? AND ( TENANT_ID = ? OR TENANT_ID IS NULL)";
    public static final String DELETE_AUTHORIZATION_DETAILS_TYPE_BY_API_ID_AND_TYPE = "DELETE FROM " +
            "AUTHORIZATION_DETAILS_TYPES WHERE API_ID = ? AND TYPE = ? AND ( TENANT_ID = ? OR TENANT_ID IS NULL)";
    public static final String UPDATE_AUTHORIZATION_DETAILS_TYPES = "UPDATE AUTHORIZATION_DETAILS_TYPES SET " +
            "NAME = ?, TYPE = ?, DESCRIPTION = ?, JSON_SCHEMA = ? WHERE API_ID = ? AND ID = ? AND TENANT_ID = ?";
    public static final String UPDATE_AUTHORIZATION_DETAILS_TYPES_H2 = "UPDATE AUTHORIZATION_DETAILS_TYPES SET " +
            "NAME=?, TYPE=?, DESCRIPTION=?, JSON_SCHEMA=? FORMAT JSON WHERE API_ID=? AND ID=? AND TENANT_ID=?";
}
