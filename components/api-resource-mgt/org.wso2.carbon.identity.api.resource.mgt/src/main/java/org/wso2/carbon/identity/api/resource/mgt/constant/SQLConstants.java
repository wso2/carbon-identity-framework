...
public class SQLConstants {
    ...
    public static final String GET_SYSTEM_API_RESOURCES_WITH_SCOPES = "SELECT IDENTIFIER, SCOPE.NAME FROM " +
            "API_RESOURCE INNER JOIN SCOPE ON API_RESOURCE.ID = SCOPE.API_ID WHERE API_RESOURCE.TYPE != 'BUSINESS'";
}
