...
public class SQLConstants {
    ...
    public static final String GET_AUTHORIZATION_DETAILS_TYPES =
            "SELECT ID, TYPE, API_ID, NAME, DESCRIPTION, JSON_SCHEMA, TENANT_ID "
                    + "FROM AUTHORIZATION_DETAILS_TYPES WHERE TENANT_ID = ?";
    ...
    public static final String UPDATE_AUTHORIZATION_DETAILS_TYPES = "UPDATE AUTHORIZATION_DETAILS_TYPES SET " +
            "NAME = ?, DESCRIPTION = ?, JSON_SCHEMA = ? WHERE API_ID = ? AND TYPE = ? AND TENANT_ID = ?";
}
