...
<fmt:bundle
        basename="org.wso2.carbon.identity.functions.library.mgt.ui.i18n.Resources">
    ...
    %>
    <script>
        location.href = 'functions-library-mgt-edit.jsp?functionLibraryName=<%=Encode.forUriComponent(functionLibraryName)%>';
    </script>
</fmt:bundle>