...
public class UserSessionManagementServiceImpl implements UserSessionManagementService {
    ...
    @Override
    public void terminateSessionsOfUser(String userName)
        ...
        String userStoreDomain = User.getUserFromUserName(userName).getUserStoreDomain();
        String tenantDomain = MultitenantUtils.getTenantDomain(userName);
        try {
            userId = UserSessionStore.getInstance().getUserId(userName, IdentityTenantUtil.getTenantId(tenantDomain),
                    userStoreDomain);
