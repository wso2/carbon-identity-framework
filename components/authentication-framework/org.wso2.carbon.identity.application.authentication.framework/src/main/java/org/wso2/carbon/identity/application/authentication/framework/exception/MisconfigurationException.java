...
/**
 * Exception if there is any misconfiguration in the authentication flow by identity admin.
 */
public class MisconfigurationException extends FrameworkException {
    ...
    public MisconfigurationException(String errorCode, String message) {
    ...
    public MisconfigurationException(String errorCode, String message, Throwable cause) {
