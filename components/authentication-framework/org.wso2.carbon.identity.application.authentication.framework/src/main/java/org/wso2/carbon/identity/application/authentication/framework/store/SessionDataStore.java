 ...
 * <p>
 * Implementations are pluggable and selected by the {@code SessionStorage.Type} configuration, which
 * defaults to the relational {@link JDBCSessionDataStore}. An alternative implementation extends this
 * class and registers itself as an OSGi {@code SessionDataStore} service, reading its own settings from
 * the properties of the same configuration.
 */
