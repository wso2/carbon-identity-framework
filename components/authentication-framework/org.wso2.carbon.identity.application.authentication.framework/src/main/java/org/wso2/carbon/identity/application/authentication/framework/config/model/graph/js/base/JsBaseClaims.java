 ...
 */
public abstract class JsBaseClaims extends AbstractJSContextMemberObject {

    protected static final Log LOG = LogFactory.getLog(JsBaseClaims.class);
    private String idp;
     ...
     */
    public JsBaseClaims(AuthenticationContext context, int step, String idp, boolean isRemoteClaimRequest) {

        this(step, idp, isRemoteClaimRequest);
        initializeContext(context);
    }

    public JsBaseClaims(int step, String idp, boolean isRemoteClaimRequest) {
     ...
     * @param isRemoteClaimRequest Whether the request is for remote claim (false for local claim request)
     */
    public JsBaseClaims(AuthenticatedUser authenticatedUser, boolean isRemoteClaimRequest) {

        this.isRemoteClaimRequest = isRemoteClaimRequest;
        this.authenticatedUser = authenticatedUser;
    }

    public JsBaseClaims(AuthenticationContext context, AuthenticatedUser authenticatedUser,
