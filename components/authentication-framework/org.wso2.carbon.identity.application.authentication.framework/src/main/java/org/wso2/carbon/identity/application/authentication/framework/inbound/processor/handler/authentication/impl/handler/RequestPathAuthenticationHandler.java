...
public class RequestPathAuthenticationHandler extends FrameworkHandler {
    @Override
    public String getName() {
        return null;
    }

    public AuthenticationResponse handleAuthentication(IdentityMessageContext identityMessageContext){
        return null ;
    }
