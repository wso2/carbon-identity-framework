...
public class ApplicationConfig implements Serializable, Cloneable {
     ...
     */
    @Deprecated
    public ApplicationConfig(ServiceProvider application) throws FrameworkException {
    ...
    private ServiceProvider reconstructServiceProvider() throws FrameworkException {
        ...
        if (serviceProvider == null) {
            throw new FrameworkException(String.format("Cannot find the application with ID: %s in tenant domain: %s",
                    this.serviceProviderResourceId, this.tenantDomain));
        }
