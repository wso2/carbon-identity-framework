...
public class SQLQueries {
    ...
    public static final String SQL_SELECT_ACTIVE_SESSION_IDS_OF_USER_ID_LIMIT_LIMITED =
            SQL_SELECT_ACTIVE_SESSION_IDS_OF_USER_ID + " LIMIT %d";

    public static final String SQL_SELECT_ACTIVE_SESSION_IDS_OF_USER_ID_FETCH_FIRST_LIMITED =
            SQL_SELECT_ACTIVE_SESSION_IDS_OF_USER_ID + " FETCH FIRST %d ROWS ONLY";
    ...
    public static final String SQL_GET_SESSION_OPERATIONS_WITHIN_IDLE_SESSION_TIMEOUT_BY_TENANT =
            "SELECT TENANT_SESSIONS.SESSION_ID, IDN_AUTH_SESSION_STORE.OPERATION " +
                    "FROM (SELECT DISTINCT SESSION_ID FROM IDN_AUTH_SESSION_STORE WHERE TENANT_ID = ?) " +
                        "TENANT_SESSIONS " +
                    "INNER JOIN IDN_AUTH_SESSION_META_DATA ON " +
                        "TENANT_SESSIONS.SESSION_ID = IDN_AUTH_SESSION_META_DATA.SESSION_ID " +
                    "INNER JOIN IDN_AUTH_USER_SESSION_MAPPING " +
                        "ON TENANT_SESSIONS.SESSION_ID = IDN_AUTH_USER_SESSION_MAPPING.SESSION_ID " +
                    "INNER JOIN IDN_AUTH_SESSION_STORE " +
                        "ON TENANT_SESSIONS.SESSION_ID = IDN_AUTH_SESSION_STORE.SESSION_ID " +
                    "WHERE IDN_AUTH_SESSION_META_DATA.PROPERTY_TYPE = ? " +
                        "AND IDN_AUTH_SESSION_META_DATA.VALUE BETWEEN ? AND ?";

    public static final String SQL_GET_SESSION_OPERATIONS_WITHIN_IDLE_SESSION_TIMEOUT_BY_TENANT_H2 =
            "SELECT TENANT_SESSIONS.SESSION_ID, IDN_AUTH_SESSION_STORE.OPERATION " +
                    "FROM (SELECT DISTINCT SESSION_ID FROM IDN_AUTH_SESSION_STORE WHERE TENANT_ID = ?) " +
                        "AS TENANT_SESSIONS " +
                    "INNER JOIN IDN_AUTH_SESSION_META_DATA ON " +
    ...
    public static final String SQL_GET_SESSION_OPS_BY_TENANT_WITH_IDLE_AND_MAX_TIMEOUT =
            "SELECT TENANT_SESSIONS.SESSION_ID, IDN_AUTH_SESSION_STORE.OPERATION " +
                    "FROM (SELECT DISTINCT SESSION_ID FROM IDN_AUTH_SESSION_STORE WHERE TENANT_ID = ?) " +
                    "AS TENANT_SESSIONS " +
                    "INNER JOIN IDN_AUTH_SESSION_META_DATA AS IDN_AUTH_SESSION_META_DATA_PROP_1 ON " +
                    "TENANT_SESSIONS.SESSION_ID = IDN_AUTH_SESSION_META_DATA_PROP_1.SESSION_ID " +
                    "INNER JOIN IDN_AUTH_SESSION_META_DATA AS IDN_AUTH_SESSION_META_DATA_PROP_2 ON " +
                    "TENANT_SESSIONS.SESSION_ID = IDN_AUTH_SESSION_META_DATA_PROP_2.SESSION_ID " +
                    "INNER JOIN IDN_AUTH_USER_SESSION_MAPPING " +
                    "ON TENANT_SESSIONS.SESSION_ID = IDN_AUTH_USER_SESSION_MAPPING.SESSION_ID " +
                    "INNER JOIN IDN_AUTH_SESSION_STORE " +
                    "ON TENANT_SESSIONS.SESSION_ID = IDN_AUTH_SESSION_STORE.SESSION_ID " +
                    "WHERE (IDN_AUTH_SESSION_META_DATA_PROP_1.PROPERTY_TYPE = ? " +
                    "AND IDN_AUTH_SESSION_META_DATA_PROP_1.VALUE BETWEEN ? AND ?) AND (" +
                    "IDN_AUTH_SESSION_META_DATA_PROP_2.PROPERTY_TYPE = ? AND " +
                    "IDN_AUTH_SESSION_META_DATA_PROP_2.VALUE BETWEEN ? AND ?)";

    public static final String SQL_GET_SESSION_OPS_BY_TENANT_WITH_IDLE_AND_MAX_TIMEOUT_H2 =
            "SELECT TENANT_SESSIONS.SESSION_ID, IDN_AUTH_SESSION_STORE.OPERATION " +
                    "FROM (SELECT DISTINCT SESSION_ID FROM IDN_AUTH_SESSION_STORE WHERE TENANT_ID = ?) " +
                    "AS TENANT_SESSIONS " +
                    "INNER JOIN IDN_AUTH_SESSION_META_DATA AS IDN_AUTH_SESSION_META_DATA_PROP_1 ON " +
