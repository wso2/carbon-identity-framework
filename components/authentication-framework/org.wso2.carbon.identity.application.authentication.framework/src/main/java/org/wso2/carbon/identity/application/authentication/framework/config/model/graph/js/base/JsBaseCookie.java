 ...
 */
public abstract class JsBaseCookie extends AbstractJSObjectWrapper<Cookie> implements JsCookie {

    protected static final Log LOG = LogFactory.getLog(JsBaseCookie.class);

    public JsBaseCookie(Cookie cookie) {
        super(cookie);
    }
