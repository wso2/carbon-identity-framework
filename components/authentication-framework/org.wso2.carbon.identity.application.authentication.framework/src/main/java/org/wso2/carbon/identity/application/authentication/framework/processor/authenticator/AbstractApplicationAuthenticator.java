...
public abstract class AbstractApplicationAuthenticator implements ApplicationAuthenticator{
    ...
    public AuthenticationResponse process(AuthenticationContext authenticationContext)
        ...
        AuthenticationResponse authenticationResponse = AuthenticationResponse.FAILED;
    ...
    protected abstract AuthenticationResponse processRequest(AuthenticationContext context) throws AuthenticationHandlerException;
    protected abstract AuthenticationResponse processResponse(AuthenticationContext context) throws AuthenticationHandlerException;
