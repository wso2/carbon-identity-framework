...
public class FrameworkUtilsTest extends PowerMockIdentityBaseTest {
    ...
    @DataProvider(name = "provideAuthenticators")
    public Object[][] provideAuthenticators() {

        authenticators = new ArrayList<>();
        ApplicationAuthenticator authenticator1 = initAuthenticators("Authenticator1");
        ApplicationAuthenticator authenticator2 = initAuthenticators("Authenticator2");
        authenticators.add(authenticator1);
        authenticators.add(authenticator2);
