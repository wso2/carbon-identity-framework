...
<%
    ...
    String templateAPIURL = IdentityUtil.getServerURL("/t/" + tenantDomain +
                            "/api/identity/template/mgt/v1.0.0/templates/", true, true);
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <script id="template-handlebars" type="text/x-handlebars-template">
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-4 col-centered
                wr-content wr-login col-centered">
            ...
            <script type="text/javascript">
                ...
                document.getElementById("template-form").method = "POST";
            </script>
            ...
            <div class="container col-xs-7 col-sm-5 col-md-4 col-lg-3 col-centered wr-content wr-login col-centered">
                <div>
                    <h2 class="wr-title uppercase blue-bg padding-double white
                    boarder-bottom-blue margin-none"><%=Encode.forHtmlContent("Incorrect Request")%>
                    </h2>
                </div>
