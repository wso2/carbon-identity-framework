...
<html>
    <head>
        <title><%=AuthenticationEndpointUtil.i18n(resourceBundle, "add.challenge.answers")%></title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            <h1><%=AuthenticationEndpointUtil.i18n(resourceBundle, "answer.following.questions")%></h1>
            <%
            ...
            <form action="../commonauth" method="post" id="profile" name="">
                ...
                <dev class="form-horizontal">
                    ...
                    <div class="form-group">
                            <label class="control-label col-sm-4"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "select.challenge.question")%></label>
                            <div class="col-sm-8">
                                <select class="form-control"  id="qchallengeQuestion1" name=<%="Q-" + Encode.forHtmlAttribute(list1)%>>
                                    <%
                                    ...
                                    <option name="q" selected="selected" value="<%=Encode.forHtmlAttribute(q1.getQuestion())%>">
                                    	<%=Encode.forHtmlContent(q1.getQuestion())%></option>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4"><%=AuthenticationEndpointUtil.i18n(resourceBundle, "answers.security.question")%></label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="answer_to_questions" 
                                placeholder= "<%=AuthenticationEndpointUtil.i18n(resourceBundle, "type.your.security.answer")%>" name=<%="A-" + Encode.forHtmlAttribute(list1)%>>
                            </div> 
                    </div>    
                </dev>
                ...
                <div class="col-sm-8">
                    <input type="button" class="btn btn-primary" value="<%=AuthenticationEndpointUtil.i18n(resourceBundle, "update")%>" onclick="javascript: validate(); return false;">
                </div>
