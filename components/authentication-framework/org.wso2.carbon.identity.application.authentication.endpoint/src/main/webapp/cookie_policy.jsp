        ...
        <div class="container col-xs-12 col-sm-12 col-md-12 col-lg-12 col-centered wr-content wr-login col-centered padding-bottom-100">
            ...
            <div class="boarder-all ">
                ...
                <div id="cookiePolicy" class="padding-double">
                    ...
                    <p>WSO2 IS 5.5.0 uses cookies so that it can provide the best user experience for you and identify you for security purposes. If you disable cookies, some of the services will (most probably) be inaccessible to you. </p>
                    <div class="margin-bottom-double"></div>
                    ...
                    <p>WSO2 IS 5.5.0 uses cookies for the following purposes listed below.</p>
                    <h3>Preferences</h3>
                    <p>WSO2 IS 5.5.0 uses these cookies to remember your settings and preferences, and to auto-fill the form fields to make your interactions with the site easier. </p>
                    <p>These cookies can not be used to personally identify you.</p>
                    <h3>Security</h3>
              <ul>
                    <li>WSO2 IS 5.5.0 uses selected cookies to identify and prevent security risks.
                     For example, WSO2 IS 5.5.0 may use these cookies to store your session information in order to prevent others from changing your password without your username and password.</li>
                </br><li>WSO2 IS 5.5.0 uses session cookies to maintain your active session.</li>
                  </br>   <li>WSO2 IS 5.5.0 may use temporary cookies when performing multi-factor authentication and federated authentication.</li>
              </br>   <li>WSO2 IS 5.5.0 may use permanent cookies to detect that you have previously used the same device to log in. This is to to calculate the &ldquo;risk level&rdquo; associated with your current login attempt. This is primarily to protect you and your account from possible attack.</li>
              </ul>   
                    <h3>Performance</h3>
                    <p>WSO2 IS 5.5.0 may use cookies to allow &ldquo;Remember Me&rdquo; functionalities.</p>
                    <div class="margin-bottom"></div>
                    <h3 id="analytics">Analytics</h3>
                    <p>WSO2 IS 5.5.0 as a product does not use cookies for analytical purposes.</p>
                    <div class="margin-bottom"></div>
                    <h3 id="third-party-cookies">Third party cookies</h3>
                    <p>Using WSO2 IS 5.5.0 may cause some third-party cookies to be set in your browser. WSO2 IS 5.5.0 has no control over how any of them operate. The third-party cookies that may be set include:</p>
                    <ul>
                        <ul>
                            <li>Any social login sites. For example, third-party cookies may be set when WSO2 IS 5.5.0 is configured to use &ldquo;social&rdquo; or &ldquo;federated&rdquo; login, and you opt to login with your &ldquo;Social Account&rdquo;.</li>
