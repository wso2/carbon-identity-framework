...
public class AuthenticationEndpointUtil {
    ...
    public static String getErrorCodeToi18nMapping(String errorCode, String subErrorCode) {
        ...
        switch (errorKey) {
            ...
            case Constants.ErrorToi18nMappingConstants.CLIENT_NOT_AUTHORIZED_FOR_REQUESTED_GRANT_TYPE:
                return Constants.ErrorToi18nMappingConstants.CLIENT_NOT_AUTHORIZED_FOR_REQUESTED_GRANT_TYPE_I18N_KEY;
            default:
