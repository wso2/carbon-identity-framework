...
public class AuthenticationEndpointUtil {
     ...
     * and invalid states:
     *
     * Ensures the URL is not the string "null" (case-insensitive). Ensures the URL is not null, empty, or consists only
     * of whitespace. Prevents common trickery by disallowing URLs starting with "javascript:", "file:", "ftp:", or
     * "data:"
     *
    ...
    public static boolean isSchemeSafeURL(String url) {
        ...
        return !StringUtils.equalsIgnoreCase(url, "null") && !StringUtils.isBlank(url) &&
                !url.toLowerCase()
