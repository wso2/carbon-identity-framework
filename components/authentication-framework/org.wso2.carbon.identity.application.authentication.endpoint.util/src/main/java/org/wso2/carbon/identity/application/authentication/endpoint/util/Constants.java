...
public class Constants {
    ...
    public static class ErrorToi18nMappingConstants {
        ...
        public static final String CLIENT_NOT_AUTHORIZED_FOR_REQUESTED_GRANT_TYPE = "unauthorized_client_not.authorized.to.use.requested.grant.type";
        public static final String CLIENT_NOT_AUTHORIZED_FOR_REQUESTED_GRANT_TYPE_I18N_KEY = "not.authorized.to.use.requested.grant.type";
