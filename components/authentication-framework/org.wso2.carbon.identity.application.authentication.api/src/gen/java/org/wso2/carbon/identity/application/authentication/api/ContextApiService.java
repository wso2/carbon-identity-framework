...
import org.wso2.carbon.identity.application.authentication.api.*;
...
public abstract class ContextApiService {
    public abstract Response getContextParameters(String sessionKey,String parameters);
}
