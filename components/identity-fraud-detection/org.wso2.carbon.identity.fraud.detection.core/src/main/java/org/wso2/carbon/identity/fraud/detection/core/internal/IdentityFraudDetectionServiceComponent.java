...
/**
 * OSGi service component for Identity Fraud Detection.
 */
@Component(
        name = "org.wso2.carbon.identity.fraud.detection",
        immediate = true
)
public class IdentityFraudDetectionServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            LOG.debug("Identity Fraud Detection Service Component bundle activated successfully.");
        } catch (Throwable e) {
    ...
    protected void deactivate(ComponentContext context) {
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Identity Fraud Detection Service Component bundle is deactivated.");
        }
    }
