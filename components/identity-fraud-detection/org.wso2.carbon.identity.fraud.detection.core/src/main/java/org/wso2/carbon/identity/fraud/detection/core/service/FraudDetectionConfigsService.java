...
import static org.wso2.carbon.identity.fraud.detection.core.constant.FraudDetectionConstants.ErrorMessages.ERROR_CODE_ADDING_FRAUD_DETECTION_CONFIG;
import static org.wso2.carbon.identity.fraud.detection.core.constant.FraudDetectionConstants.ErrorMessages.ERROR_CODE_GETTING_FRAUD_DETECTION_CONFIG;
import static org.wso2.carbon.identity.fraud.detection.core.constant.FraudDetectionConstants.ErrorMessages.ERROR_CODE_UPDATING_FRAUD_DETECTION_CONFIG;
...
public class FraudDetectionConfigsService {
    ...
    private Resource getResource(String tenantDomain) throws FraudDetectionConfigServerException {
        ...
        try {
            ...
            if (!ERROR_CODE_RESOURCE_TYPE_DOES_NOT_EXISTS.getCode().equals(e.getErrorCode()) &&
                ...
                throw handleServerException(ERROR_CODE_GETTING_FRAUD_DETECTION_CONFIG, e, tenantDomain);
            }
    ...
    private Resource addResource(Resource resource, String tenantDomain)
        ...
        try {
            ...
            throw handleServerException(ERROR_CODE_ADDING_FRAUD_DETECTION_CONFIG, e, tenantDomain);
        }
    }
    ...
    private Resource updateResource(Resource resource, String tenantDomain)
        ...
        try {
            ...
            throw handleServerException(ERROR_CODE_UPDATING_FRAUD_DETECTION_CONFIG, e, tenantDomain);
        }
    }
