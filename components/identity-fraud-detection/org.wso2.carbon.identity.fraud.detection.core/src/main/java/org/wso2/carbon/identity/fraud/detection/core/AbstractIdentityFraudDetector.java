...
public abstract class AbstractIdentityFraudDetector implements IdentityFraudDetector {
    ...
    /**
     * Handles the IdentityFraudDetectionException and constructs a FraudDetectorResponseDTO.
     *
     * @param e     The IdentityFraudDetectionException thrown during request publishing.
