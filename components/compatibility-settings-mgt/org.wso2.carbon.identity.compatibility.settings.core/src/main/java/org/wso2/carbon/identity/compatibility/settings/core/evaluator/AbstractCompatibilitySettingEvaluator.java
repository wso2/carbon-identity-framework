...
/**
 * Abstract class for compatibility setting evaluators.
 */
public abstract class AbstractCompatibilitySettingEvaluator implements CompatibilitySettingsEvaluator {

    private final int defaultExecutionOrderId = 99;

    @Override
    public int getExecutionOrderId() {

        return defaultExecutionOrderId;
    }
