...
public class APIAuthPropertyTest {
    ...
    public void testGetterMethods() throws APIClientRequestException {
        ...
        APIAuthProperty authProperty = new APIAuthProperty.Builder(expectedName, expectedValue).build();

        assertEquals(authProperty.getName(), expectedName);
        assertEquals(authProperty.getValue(), expectedValue);
    }
     ...
     */
    @Test
    public void testBuilderPattern() throws APIClientRequestException {

        APIAuthProperty.Builder builder = new APIAuthProperty.Builder(PROPERTY_NAME, PROPERTY_VALUE);
        APIAuthProperty authProperty = builder.build();
