...
public class APIAuthenticationTest {
    ...
    /**
     * Test AuthType enum values and getName method.
     */
    @Test
    public void testAuthTypeEnum() {

        assertEquals(APIAuthentication.AuthType.NONE.getName(), "NONE");
        assertEquals(APIAuthentication.AuthType.BEARER.getName(), "BEARER");
        assertEquals(APIAuthentication.AuthType.BASIC.getName(), "BASIC");
        assertEquals(APIAuthentication.AuthType.API_KEY.getName(), "API_KEY");
    }

    /**
     * Test Property enum values and getName method.
     */
    @Test
    public void testPropertyEnum() {

        assertEquals(APIAuthentication.Property.USERNAME.getName(), "username");
        assertEquals(APIAuthentication.Property.PASSWORD.getName(), "password");
        assertEquals(APIAuthentication.Property.HEADER.getName(), "header");
        assertEquals(APIAuthentication.Property.VALUE.getName(), "value");
        assertEquals(APIAuthentication.Property.ACCESS_TOKEN.getName(), "accessToken");
    }

    /**
     * Test builder with null properties map.
     */
    @Test
