...
public class ErrorMessageConstant {
    ...
    public enum ErrorMessage {
        ...
        ERROR_CODE_MISSING_REQUEST_FIELD("TOKENMGT-65005", "Missing token request field.",
                "The field %s must be included as n the token request context."),
        ...
        ERROR_CODE_UNACCEPTABLE_STATUS_CODE("TOKENMGT-65012", "Unacceptable response status code.",
                "The token endpoint returns a 201 status code, whereas the expected code is 200."),
        ...
        ERROR_CODE_NULL_TOKEN_RESPONSE("TOKENMGT-65014", "Null token response.",
                "The Token response body is null. The token %s will not be set."),
        ERROR_CODE_INVALID_TOKEN_RESPONSE("TOKENMGT-65015", "Invalid token response.",
                "Failed to parse response body as JSON. The token %s will not be set."),
        ERROR_CODE_INVALID_JSON_OBJECT("TOKENMGT-65016", "Invalid JSON response body.",
                "Response body contains invalid JSON object. The token %s will not be set."),
