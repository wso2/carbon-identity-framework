    ...
    var claimURIDropdownPopulator = function () {
        ...
        jQuery('#claimAddTable .claimrow').each(function () {
            ...
            if (val.trim() != "") {
                ...
                if (val == unescape('<%=Encode.forJavaScriptBlock(googleFamilyNameClaim)%>')) {
                ...
                if (val == unescape('<%=Encode.forJavaScriptBlock(googleGivenNameClaim)%>')) {
        ...
        if (selectedVal == "choose_dialet_type1") {
            ...
            google_prov_email_option += '<option  selected="selected" value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <% 	 } else {  %>
            google_prov_email_option += '<option value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <%	 }
            }%>
            ...
            google_prov_family_email_option += '<option  selected="selected" value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <% 	 } else {  %>
            google_prov_family_email_option += '<option value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <%	 }
            }%>
            ...
            google_prov_givenname_option += '<option  selected="selected" value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <% 	 } else {  %>
            google_prov_givenname_option += '<option value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
            <%	 }
            }%>


            <% for(int i =0 ; i< claimUris.length ; i++){%>
            option += '<option value="' + "<%=Encode.forHtmlAttribute(claimUris[i])%>" + '">' + "<%=Encode.forHtmlContent(claimUris[i])%>" + '</option>';
