        ...
        <div id="workArea">
          ...
          <form name="filterForm" method="post" action="idp-mgt-list.jsp">
                ...
                <table class="styledLeft" width="100%" id="IDProviders">
                    ...
                    <tr>
                        <td class="leftCol-big" style="padding-right: 0 !important;"><fmt:message key="idp.search.pattern"/></td>
                        <td>
                            <input type="text" name="<%=IdPManagementUIUtil.FILTER_STRING%>" value="<%=StringUtils.isBlank(filter) ? StringUtils.EMPTY :  Encode.forHtmlAttribute(filter)%>"
