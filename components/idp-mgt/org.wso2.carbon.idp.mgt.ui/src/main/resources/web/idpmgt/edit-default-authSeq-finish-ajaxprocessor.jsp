...
<%
    ...
    String seqDesc = request.getParameter("sequence-desc") != null ? request.getParameter("sequence-desc").trim() : "";
...
<%
    ...
    if (e.getFaultMessage() != null && e.getFaultMessage().getDefaultAuthSeqMgtClientException() != null &&
        ...
        session.setAttribute("updateError", e.getFaultMessage().getDefaultAuthSeqMgtClientException().getMessages());
%>
<script>
