...
<fmt:bundle
    ...
    <%
        ...
        try {
            ...
            seqName = sequence.getName() != null ? sequence.getName().trim() : "";
            seqContent = sequence.getContentXml() != null ? sequence.getContentXml().trim() : "";
        } catch (Exception e) {
            String message = resourceBundle.getString("alert.error.load.default.seq");
        ...
        <form id="update-default-authSeq-form" name="update-default-authSeq-form" method="post"
            ...
            <table class="carbonFormTable">
                <tr>
                    ...
                    <td>
                        <textarea style="width:50%" name="sequence-name" id="sequence-name" class="text-box-big"><%=seqName != null ? Encode.forHtmlContent(seqName) : ""%></textarea>
                        <div class="sectionHelp"><fmt:message key='help.default.seq.name'/></div>
                    </td>
                </tr>
            </table>
