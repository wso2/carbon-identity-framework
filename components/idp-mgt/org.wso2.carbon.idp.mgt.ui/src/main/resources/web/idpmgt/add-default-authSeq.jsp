            ...
            <form id="add-default-auth-seq-form" name="add-default-auth-seq-form" method="post"
                ...
                <table class="carbonFormTable">
                    ...
                    <tr>
                        ...
                        <td>
                        <textarea style="width:50%; margin-bottom:3px" type="text" name="sequence-description" id="sequence-description"
                        ...
                        <td>
                            <div style="position: relative;">
                                    <div class="sectionSub step_contents" id="codeMirror">
                                        <textarea id="seqContent" name="seqContent" readonly="false" style="height: 500px; width: 100%; display: none; margin-left: 10%"></textarea>
                                    </div>
                                </div>
                        </td>
                    </tr>
