...
public class IdPManagementConstants {
    ...
    public static final String IS_JWT_ISSUER = "isJWTIssuer";
    ...
    public static class SQLQueries {
        ...
        public static final String FROM_JWT_ISSUER_WHERE =
                "FROM IDP JOIN IDP_PROPERTY ON IDP.ID=IDP_METADATA.IDP_ID WHERE IDP_METADATA.NAME='isJWTIssuer' AND ";
        ...
        public static final String GET_JWT_ISSUER_TENANT_MSSQL =
        ...
        public static final String GET_JWT_ISSUER_TENANT_MSSQL_TAIL = "IDP.TENANT_ID =? AND NAME != '" + RESIDENT_IDP + "' ORDER BY %s OFFSET ? ROWS FETCH NEXT ?" +
                " ROWS ONLY";
        ...
        public static final String GET_JWT_ISSUER_COUNT_SQL = "SELECT COUNT(DISTINCT IDP.ID) FROM IDP JOIN IDP_METADATA ON IDP.ID = IDP_METADATA.IDP_ID WHERE IDP_METADATA.NAME = 'isJWTIssuer' AND ";

        public static final String GET_IDP_COUNT_SQL_TAIL = "TENANT_ID = ? AND NAME != '" + RESIDENT_IDP + "'";

        public static final String GET_JWT_ISSUER_COUNT_SQL_TAIL = "IDP.TENANT_ID = ? AND NAME != '" + RESIDENT_IDP + "'";
        ...
        public static final String REMOVE_JWT_ISSUER_SQL = "DELETE FROM IDP_METADATA WHERE IDP_ID=? AND NAME=? " +
                "AND TENANT_ID=?";
