...
public class CacheBackedIdPMgtDAO {
     ...
     * @throws IdentityProviderManagementClientException Error when append the filer string.
     */
    public List<IdentityProvider> getPaginatedJwtIssuersSearch(int tenantId, List<ExpressionNode> expressionConditions,
                                                               int limit, int offset, String sortOrder, String sortBy,
                                                               List<String> requiredAttributes)
            throws IdentityProviderManagementServerException, IdentityProviderManagementClientException {

        return idPMgtDAO.getJwtIssuerSearch(tenantId, expressionConditions, limit, offset, sortOrder,
     ...
     * @throws IdentityProviderManagementClientException Error when append the filer string.
     */
    public int getTotalJwtIssuerCount(int tenantId, List<ExpressionNode> expressionConditions)
            throws IdentityProviderManagementServerException, IdentityProviderManagementClientException {
    ...
    /**
     * Add Identity Provider as a JWT Issuer.
     *
     * @param identityProvider  Identity Provider information.
     * @throws IdentityProviderManagementException IdentityProviderManagementException
     */
    public void addAsAJWTIssuer(IdentityProvider identityProvider, int tenantId) throws IdentityProviderManagementException {

        idPMgtDAO.addJWTIssuer(identityProvider, tenantId);
    }

    /**
     * Remove Identity Provider as a JWT Issuer.
     *
     * @param identityProvider  Identity Provider information.
     * @throws IdentityProviderManagementException IdentityProviderManagementException
     */
    public void removeAsAJWTIssuer(IdentityProvider identityProvider, int tenantId) throws IdentityProviderManagementException {

        idPMgtDAO.removeJWTIssuer(identityProvider, tenantId);
    }
