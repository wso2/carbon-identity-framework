...
//            String message = "Could not find Resident Identity Provider for tenant ";
...
//        return identityProvider;
     ...
     */
    @Override
    public void addResidentIdP(IdentityProvider identityProvider)
            throws IdentityProviderManagementException {
...
//        return dao.getIdPs(null, tenantId, tenantDomain);
    ...
    public List<IdentityProvider> getEnabledIdPs()
        ...
        List<IdentityProvider> identityProviers = getIdPs();
...
//        }
    ...
    public IdentityProvider getIdPByName(String idPName)
            throws IdentityProviderManagementException {
        return getIdPByName(idPName, false);
    }
...
//        }
    ...
    public IdentityProvider getEnabledIdPByName(String idPName)
        ...
        IdentityProvider idp = getIdPByName(idPName);
        if (idp != null && idp.isEnable()) {
            return idp;
        }
        return null;
     ...
     */
    @Override
    public IdentityProvider getIdPByRealmId(String realmId)
            throws IdentityProviderManagementException {
        // TODO : C5
...
//        }
     ...
     */
    @Override
    public Set<ClaimMapping> getMappedLocalClaims(String idPName,
...
//        }
     ...
     */
    @Override
    public Map<String, String> getMappedLocalClaimsMap(String idPName,
                                                       List<String> idPClaimURIs) throws
            IdentityProviderManagementException {

        Set<ClaimMapping> claimMappings = getMappedLocalClaims(idPName, idPClaimURIs);
...
//        }
     ...
     */
    @Override
    public Set<ClaimMapping> getMappedIdPClaims(String idPName,
...
//        }
     ...
     */
    @Override
    public Map<String, String> getMappedIdPClaimsMap(String idPName,
                                                     List<String> localClaimURIs) throws
            IdentityProviderManagementException {

        Set<ClaimMapping> claimMappings = getMappedIdPClaims(idPName, localClaimURIs);
        Map<String, String> returnMap = new HashMap<String, String>();
        for (ClaimMapping claimMapping : claimMappings) {
     ...
     */
    @Override
    public Set<RoleMapping> getMappedLocalRoles(String idPName,
...
//        }
     ...
     */
    @Override
    public Map<String, LocalRole> getMappedLocalRolesMap(String idPName,
                                                         String[] idPRoles) throws IdentityProviderManagementException {

        Set<RoleMapping> roleMappings = getMappedLocalRoles(idPName, idPRoles);
     ...
     */
    @Override
    public Set<RoleMapping> getMappedIdPRoles(String idPName,
...
//        }
     ...
     */
    @Override
    public Map<LocalRole, String> getMappedIdPRolesMap(String idPName,
...
//        Collection<IdentityProviderMgtListener> listeners = IdPManagementServiceComponent.getIdpMgtListeners();
//        for (IdentityProviderMgtListener listener : listeners) {
//            if (listener.isEnable() && !listener.doPreAddIdP(identityProvider)) {
//                return;
//            }
//        }
//
...
//        }
     ...
     */
    @Override
    public void updateIdP(String oldIdPName, IdentityProvider newIdentityProvider) throws
            IdentityProviderManagementException {
