...
public class IdPManagementDAO {
     ...
     */
    public List<IdentityProvider> getIdPs(Connection dbConnection)
            throws IdentityProviderManagementException {
...
//        }
    ...
    private FederatedAuthenticatorConfig[] getFederatedAuthenticatorConfigs(
            Connection dbConnection, String idPName, IdentityProvider federatedIdp)
...
//        }
    ...
    private void updateFederatedAuthenticatorConfigs(
            ...
            Connection dbConnection, int idpId)
            throws IdentityProviderManagementException, SQLException {
...
//                } else {
//                    addFederatedAuthenticatorConfig(fedAuthenticator, dbConnection, idpId);
//                }
//            }
//        }
    }
    ...
    private void updateFederatedAuthenticatorConfig(FederatedAuthenticatorConfig newFederatedAuthenticatorConfig,
                                                    ...
                                                    Connection dbConnection, int idpId) throws
...
//        }
    ...
    public void addFederatedAuthenticatorConfigs(FederatedAuthenticatorConfig[] authnConfigs,
        ...
        for (FederatedAuthenticatorConfig authnConfig : authnConfigs) {
            addFederatedAuthenticatorConfig(authnConfig, dbConnection, idpId);
        }
    }
...
//    }
     ...
     * @throws IdentityProviderManagementException
     */
    public IdentityProvider getIdPByName(Connection dbConnection, String idPName) throws IdentityProviderManagementException {
...
//        }
    ...
    public boolean isIdpReferredBySP(String idPName)
            throws IdentityProviderManagementException {
...
//    }
     ...
     * @throws IdentityProviderManagementException
     */
    public void renameClaimURI(String newClaimURI, String oldClaimURI) throws IdentityProviderManagementException {
//
//        Connection dbConnection = IdentityDatabaseUtil.getDBConnection();
//        ;
//        PreparedStatement prepStmt = null;
