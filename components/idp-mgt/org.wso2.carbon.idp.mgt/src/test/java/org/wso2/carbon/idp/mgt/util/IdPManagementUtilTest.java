...
public class IdPManagementUtilTest extends PowerMockTestCase {
    ...
    public void testGetResidentIdPEntityId(String localEntityId , String expectedEntityId) throws Exception {
    ...
    public void testGetIdleSessionTimeOut(String tenetDomain, boolean validity, String value, int timeOut) throws Exception {
        ...
        if (validity) {
            when(IdentityApplicationManagementUtil.getProperty(mockedIdentityProvider.getIdpProperties(), SESSION_IDLE_TIME_OUT)).thenReturn(mockedIdentityProviderProperty);
        }else{
            when(IdentityApplicationManagementUtil.getProperty(mockedIdentityProvider.getIdpProperties(), SESSION_IDLE_TIME_OUT)).thenReturn(null);
        }
    ...
    public void testGetRememberMeTimeout (String tenetDomain, boolean validity, String value, int timeOut) throws Exception {
        mockStatic(IdentityProviderManager.class);
        mockStatic(IdentityUtil.class);
        mockStatic(IdentityApplicationManagementUtil.class);
        ...
        if (validity) {
            when(IdentityApplicationManagementUtil.getProperty(mockedIdentityProvider.getIdpProperties(), REMEMBER_ME_TIME_OUT)).thenReturn(mockedIdentityProviderProperty);
        }else{
            when(IdentityApplicationManagementUtil.getProperty(mockedIdentityProvider.getIdpProperties(), REMEMBER_ME_TIME_OUT)).thenReturn(null);
        }
    ...
    public void testSetTenantSpecifiers(String tenantDomain , String tenantContext, String tenantParameter) throws Exception {
    ...
    public void testHandleClientException(){
        IdentityProviderManagementClientException exception1 = IdPManagementUtil.handleClientException(ErrorMessage.ERROR_CODE_ADD_IDP , "");
        ...
        IdentityProviderManagementClientException exception2 = IdPManagementUtil.handleClientException(ErrorMessage.ERROR_CODE_ADD_IDP , "test2",t);
