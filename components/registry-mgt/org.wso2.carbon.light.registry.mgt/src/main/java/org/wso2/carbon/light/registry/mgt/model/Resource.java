 ...
 * metadata and content. Resources can also have properties.
 */
public interface Resource {
    ...
    /**
     * Get the username of the resource author.
     *
     * @return the username of the resource author.
     */
     ...
     * will append to the value. If not this will create a new property value for the key.
     *
     * @param key   the property key.
     * @param value the property value.
     */
     ...
     */
    Object getContent() throws LightRegistryException;
     ...
     * @throws LightRegistryException throws if the operation fail.
     */
    void setContent(Object content) throws LightRegistryException;
