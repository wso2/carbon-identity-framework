...
public class CollectionImpl extends ResourceImpl implements Collection {
    ...
    /**
     * Construct a collection with the provided path and the resource object.
     *
     ...
     * loaded on demand to increase performance. Calling this method will load all child paths.
     *
