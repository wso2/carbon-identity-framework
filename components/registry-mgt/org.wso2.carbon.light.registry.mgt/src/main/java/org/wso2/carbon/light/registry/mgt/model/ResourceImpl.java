...
public class ResourceImpl implements Resource {
    ...
    /**
     * If collection - id of the path of the collection, if non-collection - id of the path
     ...
     * If collection - NULL, non-collection - the name of the resource.
     */
    ...
    /**
     * Construct a resource with given path and resource object.
     *
    ...
    public ResourceImpl(String path, Resource resource) {
        ...
        this.tenantId = ((ResourceImpl) resource).getTenantId();
