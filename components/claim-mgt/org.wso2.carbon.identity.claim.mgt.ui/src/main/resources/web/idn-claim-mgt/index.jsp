    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <table style="width: 100%" class="styledLeft">
                <thead>
                    <tr>
                        <th><fmt:message key='default.claim.dialect'/></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <a href="claim-view.jsp?store=<%=UserCoreConstants.INTERNAL_USERSTORE%>&dialect=<%=UserCoreConstants.DEFAULT_CARBON_DIALECT%>"><%=UserCoreConstants.DEFAULT_CARBON_DIALECT%></a>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="width: 100%" class="styledLeft">
                <thead>
                    <tr>
                        <th colspan="2"><fmt:message key='available.claim.dialctes.for.internal.user.stores'/></th>
                    </tr>
                </thead>
                <tbody>
                <%
                    if (claimDialectDTO != null && claimDialectDTO.length > 0) {
                        for (int i = 0; i < claimDialectDTO.length; i++) {
                            if (!UserCoreConstants.DEFAULT_CARBON_DIALECT.equals(claimDialectDTO[i].getDialectURI())) {
                %>
                <tr>
                    <td width="50%"><a
