...
<%
    ...
    try {
        ...
        client.removeExternalClaim(externalClaimDialectURI, externalClaimURI);
        ...
        String unformatted = resourceBundle.getString("error.removing.external.claim");
        String message = MessageFormat.format(unformatted, new Object[]{Encode.forHtmlContent(externalClaimURI),
                Encode.forHtmlContent(externalClaimDialectURI)});
