...
public class SQLConstants {
    ...
    public static final String GET_CLAIM_MAPPING = "SELECT CLAIM_URI FROM IDN_CLAIM WHERE ID=(SELECT " +
            "LOCAL_CLAIM_ID FROM IDN_CLAIM_MAPPING WHERE EXT_CLAIM_ID=? AND TENANT_ID=?) AND TENANT_ID=?";
    public static final String ADD_CLAIM_MAPPING = "INSERT INTO IDN_CLAIM_MAPPING (LOCAL_CLAIM_ID, EXT_CLAIM_ID, " +
            "TENANT_ID) VALUES (?, ?, ?)";
    public static final String UPDATE_CLAIM_MAPPING = "UPDATE IDN_CLAIM_MAPPING SET LOCAL_CLAIM_ID=? WHERE " +
            "EXT_CLAIM_ID=? AND TENANT_ID=?";
    public static final String IS_CLAIM_MAPPING = "SELECT LOCAL_CLAIM_ID FROM IDN_CLAIM_MAPPING WHERE " +
            "LOCAL_CLAIM_ID=(SELECT ID FROM IDN_CLAIM WHERE DIALECT_ID=(SELECT ID FROM IDN_CLAIM_DIALECT WHERE " +
