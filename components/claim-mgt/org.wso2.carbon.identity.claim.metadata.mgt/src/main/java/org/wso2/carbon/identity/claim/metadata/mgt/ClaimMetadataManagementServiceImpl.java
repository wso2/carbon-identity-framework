...
import static org.wso2.carbon.identity.claim.metadata.mgt.util.ClaimConstants.ErrorMessage.ERROR_CODE_EXISTING_EXTERNAL_CLAIM;
...
public class ClaimMetadataManagementServiceImpl implements ClaimMetadataManagementService {
    ...
    public void renameClaimDialect(ClaimDialect oldClaimDialect, ClaimDialect newClaimDialect, String tenantDomain)
        ...
        boolean isSystemDefaultClaimDialect = this.unifiedClaimMetadataManager.isSystemDefaultClaimDialect(
                oldClaimDialect.getClaimDialectURI(), tenantId);
        if (isSystemDefaultClaimDialect) {
            throw new ClaimMetadataClientException(ERROR_CODE_NO_RENAME_SYSTEM_DIALECT.getCode(),
                    String.format(ERROR_CODE_NO_RENAME_SYSTEM_DIALECT.getMessage(), oldClaimDialect.getClaimDialectURI()));
        }
    ...
    public void removeLocalClaim(String localClaimURI, String tenantDomain) throws ClaimMetadataException {
        ...
        boolean isSystemDefaultClaim = this.unifiedClaimMetadataManager.isSystemDefaultLocalClaim(localClaimURI, tenantId);
    ...
    public void addExternalClaim(ExternalClaim externalClaim, String tenantDomain) throws ClaimMetadataException {
        ...
        if (isExistingExternalClaim(externalClaim.getClaimDialectURI(), externalClaim.getClaimURI(), tenantId)) {
            throw new ClaimMetadataClientException(ERROR_CODE_EXISTING_EXTERNAL_CLAIM.getCode(),
                    String.format(ERROR_CODE_EXISTING_EXTERNAL_CLAIM.getMessage(), externalClaim.getClaimURI(),
                            externalClaim.getClaimDialectURI()));
        }
    ...
    public void removeExternalClaim(String externalClaimDialectURI, String externalClaimURI, String tenantDomain)
        ...
        boolean isSystemDefaultClaim = this.unifiedClaimMetadataManager.isSystemDefaultExternalClaim(externalClaimDialectURI, externalClaimURI, tenantId);
        if (isSystemDefaultClaim) {
            throw new ClaimMetadataClientException(ERROR_CODE_NO_DELETE_SYSTEM_CLAIM.getCode(),
