...
public class MappedAttributeCacheEntry extends CacheEntry{

    private String mappedAttribute;

    public MappedAttributeCacheEntry(String identityProvider) {
        this.mappedAttribute = identityProvider;
    }
