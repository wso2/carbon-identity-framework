...
public class ClaimAdminService {
     ...
     */
    public ClaimDialectDTO[] getClaimMappings() throws ClaimManagementException, org.wso2.carbon.user.api
            .UserStoreException {
        ...
        claimMappings = ((IdentityMgtClaimManager) ((UserRealm) CarbonContext.getThreadLocalCarbonContext()
                .getUserRealm()).getClaimManager()).getAllClaimMappings();
    ...
    public ClaimDialectDTO getClaimMappingByDialect(String dialectUri) throws ClaimManagementException,
        ...
        claimMappings = ((IdentityMgtClaimManager) ((UserRealm) CarbonContext.getThreadLocalCarbonContext()
                .getUserRealm()).getClaimManager()).getAllClaimMappings(dialectUri);
     ...
     * @throws ClaimManagementException
     */
    public void updateClaimMapping(ClaimMappingDTO claimMappingDTO) throws ClaimManagementException,
            UserStoreException, IdentityException {
        ...
        ((IdentityMgtClaimManager) ((UserRealm) CarbonContext.getThreadLocalCarbonContext().getUserRealm())
    ...
    public void addNewClaimMapping(ClaimMappingDTO claimMappingDTO) throws ClaimManagementException,
        ...
        of ClaimMapping which is used in the back end. */
        ClaimMapping claimMapping = convertClaimMappingDTOToClaimMapping(claimMappingDTO);
        IdentityMgtClaimManager handler = ((IdentityMgtClaimManager) ((UserRealm) CarbonContext
                .getThreadLocalCarbonContext().getUserRealm()).getClaimManager());
    ...
    private ClaimMapping[] convertClaimMappingDTOArrayToClaimMappingArray(
        ...
        List<org.wso2.carbon.user.api.ClaimMapping> claimMappings = new ArrayList<>();
        for (ClaimMappingDTO claimMappingDTO : claimMappingDTOs) {
            org.wso2.carbon.user.api.ClaimMapping claimMapping = convertClaimMappingDTOToClaimMapping(claimMappingDTO);
    ...
    private ClaimMapping convertClaimMappingDTOToClaimMapping(ClaimMappingDTO
                                                                      claimMappingDTO) {
