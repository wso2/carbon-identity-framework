...
public class ClaimDBConstants {
    ...
    public static final String GET_LOCAL_CLAIMS = "SELECT CLAIM_IN_DIALECT.IDN_DIALECT_URI IDN_DIALECT_URI, " +
            ...
            ".IDN_ID IDN_CLAIM_ID FROM IDN_DIALECT, IDN_CLAIM WHERE IDN_DIALECT.IDN_TENANT_ID =? AND IDN_CLAIM" +
            ".IDN_TENANT_ID=? AND IDN_DIALECT.IDN_ID=IDN_CLAIM.IDN_DIALECT_ID) CLAIM_IN_DIALECT INNER JOIN " +
            "IDN_CLAIM_MAPPED_ATTRIBUTE ON CLAIM_IN_DIALECT.IDN_CLAIM_ID=IDN_CLAIM_MAPPED_ATTRIBUTE.IDN_CLAIM_ID";
    ...
    public static final String GET_ADDITIONAL_CLAIMS = "SELECT IDN_DIALECT.IDN_DIALECT_URI IDN_DIALECT_URI, IDN_CLAIM" +
            ...
            "IDN_CLAIM_MAPPING CM WHERE IDN_DIALECT.IDN_ID=IDN_CLAIM.IDN_DIALECT_ID AND IDN_DIALECT.IDN_TENANT_ID =? " +
            "AND IDN_CLAIM.IDN_TENANT_ID=? AND IDN_CLAIM.IDN_ID = CM.IDN_ADDITIONAL_CLAIM_ID";

    public static final String GET_ADDITIONAL_CLAIMS_DIALECT = "SELECT IDN_CLAIM" +
            ".IDN_CLAIM_URI IDN_CLAIM_URI, IDN_CLAIM.IDN_ID IDN_CLAIM_ID, (SELECT IDN_CLAIM_URI FROM IDN_CLAIM WHERE " +
            "IDN_CLAIM.IDN_ID = CM.IDN_LOCAL_CLAIM_ID) IDN_MAPPED_ATTRIBUTE FROM IDN_DIALECT ,IDN_CLAIM, " +
            "IDN_CLAIM_MAPPING CM WHERE IDN_DIALECT.IDN_ID=IDN_CLAIM.IDN_DIALECT_ID AND IDN_DIALECT.IDN_TENANT_ID =? " +
            "AND IDN_CLAIM.IDN_TENANT_ID=? AND IDN_CLAIM.IDN_ID = CM.IDN_ADDITIONAL_CLAIM_ID AND IDN_DIALECT_URI=?";

    public static final String GET_CLAIM_ID_SQL = "SELECT IDN_ID FROM IDN_CLAIM WHERE " +
            "IDN_CLAIM_URI=? AND IDN_TENANT_ID=?";

    public static final String GET_CLAIMS_FOR_DIALECT_SQL = "SELECT IDN_CLAIM_URI FROM " +
    ...
    public static final String GET_CLAIM_METADATA = "SELECT IDN_KEY, IDN_VALUE  FROM IDN_CLAIM_META_DATA WHERE " +
            "IDN_CLAIM_ID = (SELECT  IDN_ID FROM IDN_CLAIM WHERE IDN_CLAIM_URI = ? AND IDN_TENANT_ID = ?)";
