...
public class IdentityFrameworkDataHolder {
    private static IdentityFrameworkDataHolder instance = new IdentityFrameworkDataHolder();
    ...
    private IdentityFrameworkDataHolder() {
        setNanoTimeReference(System.nanoTime());
        setUnixTimeReference(System.currentTimeMillis());
    }

    public static IdentityFrameworkDataHolder getInstance() {
        return instance;
    }
