...
package org.wso2.carbon.identity.framework.servlet;
...
public class IdentityGateway extends HttpServlet {
    ...
    private HttpIdentityRequestFactory getIdentityRequestFactory(HttpServletRequest request,
        ...
        List<HttpIdentityRequestFactory> factories =
                IdentityFrameworkDataHolder.getInstance().getHttpIdentityRequestFactories();
    ...
    private HttpIdentityResponseFactory getIdentityResponseFactory(IdentityResponse identityResponse) {
        ...
        List<HttpIdentityResponseFactory> factories = IdentityFrameworkDataHolder.getInstance()
