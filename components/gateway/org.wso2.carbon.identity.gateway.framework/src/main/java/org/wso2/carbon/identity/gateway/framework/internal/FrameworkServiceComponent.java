...
package org.wso2.carbon.identity.gateway.framework.internal;
...
import org.wso2.carbon.identity.gateway.framework.servlet.IdentityGateway;
 ...
 * interface="org.wso2.carbon.identity.gateway.framework.IdentityProcessor"
 ...
 * interface="org.wso2.carbon.identity.gateway.framework.request.factory.HttpIdentityRequestFactory"
 ...
 * interface="org.wso2.carbon.identity.gateway.framework.response.factory.HttpIdentityResponseFactory"
...
public class FrameworkServiceComponent {
    ...
    protected void addHttpIdentityRequestFactory(HttpIdentityRequestFactory factory) {
        ...
        Collections.sort(dataHolder.getHttpIdentityRequestFactories(),
                httpIdentityRequestFactoryComparator);
        if (log.isDebugEnabled()) {
    ...
    protected void addHttpIdentityResponseFactory(HttpIdentityResponseFactory factory) {
        ...
        Collections.sort(dataHolder.getHttpIdentityResponseFactories(),
                httpIdentityResponseFactoryComparator);
        if (log.isDebugEnabled()) {
