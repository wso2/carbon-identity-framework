...
package org.wso2.carbon.identity.gateway.framework.context;
...
public class IdentityMessageContext<T1 extends Serializable, T2 extends Serializable, T3 extends IdentityRequest> extends MessageContext
