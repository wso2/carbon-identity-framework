 ...
 */
public class CallbackProcessorAbstract extends AbstractGatewayProcessor {


    private Logger logger = LoggerFactory.getLogger(CallbackProcessorAbstract.class);
    ...
    public String getName() {
        return "CallbackProcessorAbstract";
    }
