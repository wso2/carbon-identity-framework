...
public class GatewayDataHolder {
    private static GatewayDataHolder instance = new GatewayDataHolder();
    //Authenticators
    private List<RequestPathApplicationAuthenticator> requestPathApplicationAuthenticators = new ArrayList<>();
    private List<LocalApplicationAuthenticator> localApplicationAuthenticators = new ArrayList<>();
    private List<FederatedApplicationAuthenticator> federatedApplicationAuthenticators = new ArrayList<>();
    //SequenceBuilder
    private List<AbstractSequenceBuildFactory> sequenceBuildFactories = new ArrayList<>();
    private List<SequenceManager> sequenceManagers = new ArrayList<>();
    private List<StepHandler> stepHandlers = new ArrayList<>();
    private List<RequestPathHandler> requestPathHandlers = new ArrayList<>();
