...
public class IdentityEventConstants {
    ...
    public class Event {
        ...
        public static final String PRE_GET_ROLES = "PRE_GET_ROLES";
        public static final String POST_GET_ROLES = "POST_GET_ROLES";
        public static final String PRE_GET_ROLE = "PRE_GET_ROLE";
        public static final String POST_GET_ROLE = "POST_GET_ROLE";
        public static final String PRE_UPDATE_ROLE_NAME = "PRE_UPDATE_ROLE_NAME";
        public static final String POST_UPDATE_ROLE_NAME = "POST_UPDATE_ROLE_NAME";
        public static final String PRE_DELETE_ROLE= "PRE_DELETE_ROLE";
        public static final String POST_DELETE_ROLE= "POST_DELETE_ROLE";
        public static final String PRE_GET_USER_LIST_OF_ROLE = "PRE_GET_USER_LIST_OF_ROLE";
        public static final String POST_GET_USER_LIST_OF_ROLE = "POST_GET_USER_LIST_OF_ROLE";
        ...
        public static final String POST_SET_PERMISSIONS_FOR_ROLE = "POST_SET_PERMISSIONS_FOR_ROLE";
