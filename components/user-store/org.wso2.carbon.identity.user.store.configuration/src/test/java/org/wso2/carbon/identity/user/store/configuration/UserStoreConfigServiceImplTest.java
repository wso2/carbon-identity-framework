...
public class UserStoreConfigServiceImplTest {
    ...
    private UserStoreDTO buildUserStoreDTO(String disabled) {
        ...
        PropertyDTO propertyDTO = new PropertyDTO("Disabled", disabled);
        dto.setProperties(new PropertyDTO[]{propertyDTO});
        return dto;
    }
    ...
    public void testUpdateUserStore() throws Exception {
        ...
        UserStoreDTO updatedDto = buildUserStoreDTO("false");
    ...
    public void testUpdateDisabledUserStore() throws Exception {
        ...
        UserStoreDTO updatedDto = buildUserStoreDTO("true");
