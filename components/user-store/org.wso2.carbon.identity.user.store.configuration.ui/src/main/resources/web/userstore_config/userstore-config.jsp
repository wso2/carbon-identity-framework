...
%>
    ...
    <script type="text/javascript">
        ...
        function removeRow(link) {
            link.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.removeChild(link.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode);
        }

        function createNewPropertyRow(name, value) {
            var rowIndex = jQuery(document.getElementById('propertiesTable').rows[document.getElementById('propertiesTable').rows.length - 1]).attr('data-value');
        ...
        function createNewMandatoryPropertyRow() {
            var rowIndex = jQuery(document.getElementById('mandatoryPropertiesTable').rows[document.getElementById('mandatoryPropertiesTable').rows.length - 1]).attr('data-value');
            var index = parseInt(rowIndex, 10) + 1;
                    ...
                    <table id="mainTable">
                        ...
                        <tr>
                            ...
                            <td><textarea name="description" id="description"
                                          class="text-box-big"><%=Encode.forHtmlContent(description)%>
            </textarea>
                            </td>
                            <%
                            } else {
                        ...
                        <tr data-value="0">
                            <td>
                                <table class="oneline-listing" style="width: 100%;margin-top:10px;">
                                    ...
                                    %>
                                    <td class="leftCol-med" width="50%" style="display:none;"
                                        id="<%=name%>"><%=propertyName%>
                                    </td>
                                    <input type="hidden" name=<%=name%>
                                            id=<%=name%>
