...
public enum DevicePolicyErrorMessage {
    ...
    // Client errors.
    ERROR_DEVICE_TOKEN_PARSE_FAILED("DPM-60001", "Device token invalid.",
            "Failed to parse X-Device-Token JWT."),
    ERROR_DEVICE_TOKEN_MISSING_DEVICE_ID("DPM-60002", "Device token invalid.",
            "deviceId is missing from the JWT header."),
    ERROR_DEVICE_TOKEN_SIGNATURE_INVALID("DPM-60003",
            "Device token signature invalid.",
            "JWT signature verification failed for deviceId: %s."),
    ERROR_DEVICE_TOKEN_MISSING_JTI("DPM-60004", "Device token invalid.",
            "jti claim is missing from the device token."),
    ERROR_DEVICE_TOKEN_MISSING_IAT("DPM-60005", "Device token invalid.",
            "iat claim is missing from the device token."),
    ERROR_DEVICE_TOKEN_EXPIRED("DPM-60006", "Device token expired.",
            "Device token is outside the allowed %s-second freshness window."),
    ERROR_DEVICE_TOKEN_REPLAYED("DPM-60007", "Device token replayed.",
            "Device token with jti %s has already been used."),
    ERROR_DEVICE_NOT_ACTIVE("DPM-60008", "Device not active.",
    ...
    ERROR_DEVICE_POLICY_NOT_FOUND("DPM-60010", "Device policy not found.",
            "No device policy found for: %s in tenant: %s."),
