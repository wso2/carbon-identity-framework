...
/**
 * Resolves verified device data from an authentication initiation request. Consumed directly by
 * {@code application.authentication.framework}'s request coordinator as an optional OSGi service
 * reference — device data resolution is best-effort and must never block authentication when this
