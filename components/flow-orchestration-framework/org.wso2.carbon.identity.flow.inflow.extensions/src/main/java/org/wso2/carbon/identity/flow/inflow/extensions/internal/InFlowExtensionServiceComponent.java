...
import org.wso2.carbon.identity.flow.inflow.extensions.executor.InFlowExtensionResponseProcessor;
import org.wso2.carbon.identity.flow.inflow.extensions.management.InFlowExtensionActionConverter;
import org.wso2.carbon.identity.flow.inflow.extensions.management.InFlowExtensionActionDTOModelResolver;

/**
 * OSGi declarative services component which registers the In-Flow Extension services.
 */
@Component(
        name = "flow.inflow.extensions.component",
        immediate = true)
