...
/**
 * Unit tests for {@link FlowExtensionPathUtil}.
 */
public class FlowExtensionPathUtilTest {
    ...
    public void testIsReadOnly(String path, boolean expected) {
        ...
        assertEquals(FlowExtensionPathUtil.isReadOnly(path), expected);
    }
    ...
    public void testAnyExposedUnderMatchesLeafUnderPrefix() {
        ...
        assertTrue(FlowExtensionPathUtil.anyExposedUnder("/user/claims/", leafPaths));
        assertTrue(FlowExtensionPathUtil.anyExposedUnder("/properties/", leafPaths));
    }
    ...
    public void testAnyExposedUnderNoMatch() {
        ...
        assertFalse(FlowExtensionPathUtil.anyExposedUnder("/user/claims/", leafPaths));
        assertFalse(FlowExtensionPathUtil.anyExposedUnder("/properties/", leafPaths));
    }

    @Test
    public void testAnyExposedUnderNullPrefix() {

        assertFalse(FlowExtensionPathUtil.anyExposedUnder(null,
    ...
    public void testAnyExposedUnderNullList() {
        ...
        assertFalse(FlowExtensionPathUtil.anyExposedUnder("/user/claims/", null));
    }

    @Test
    public void testAnyExposedUnderEmptyList() {

        assertFalse(FlowExtensionPathUtil.anyExposedUnder("/user/claims/",
    ...
    public void testAnyExposedUnderMultipleLeafsOneMatches() {
        ...
        assertTrue(FlowExtensionPathUtil.anyExposedUnder("/user/credentials/", leafPaths));
    }
    ...
    public void testIsExposedPathExactMatch() {
        ...
        List<String> leafPaths = Arrays.asList(
                ...
                "/flow/tenantDomain",
                "/user/userId");
        assertTrue(FlowExtensionPathUtil.isExposedPath(
                "/user/claims/http://wso2.org/claims/email", leafPaths));
        assertTrue(FlowExtensionPathUtil.isExposedPath("/flow/tenantDomain", leafPaths));
        assertTrue(FlowExtensionPathUtil.isExposedPath("/user/userId", leafPaths));
    }
    ...
    public void testIsExposedPathNoMatch() {
        ...
        assertFalse(FlowExtensionPathUtil.isExposedPath(
                "/user/claims/http://wso2.org/claims/email", leafPaths));
    }
    ...
    public void testIsExposedPathNullPath() {
        ...
        assertFalse(FlowExtensionPathUtil.isExposedPath(null,
    ...
    public void testIsExposedPathNullList() {
        ...
        assertFalse(FlowExtensionPathUtil.isExposedPath("/user/userId", null));
    }

    @Test
    public void testIsExposedPathEmptyList() {

        assertFalse(FlowExtensionPathUtil.isExposedPath("/user/userId",
                Collections.emptyList()));
    }
    ...
    public void testIsExposedPathPrefixNotSufficient() {
        ...
        assertFalse(FlowExtensionPathUtil.isExposedPath("/user/claims/", leafPaths));
    }
}
