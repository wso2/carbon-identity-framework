...
public class InFlowExtensionExecutorTest {
    ...
    public void testExecuteDisabledExecution() throws Exception {
        ...
        when(actionExecutorService.isExecutionEnabled(ActionType.FLOW_EXTENSION)).thenReturn(false);
    ...
    public void testExecuteSuccess() throws Exception {
        ...
        when(actionExecutorService.isExecutionEnabled(ActionType.FLOW_EXTENSION)).thenReturn(true);
        ...
        when(actionExecutorService.execute(
                eq(ActionType.FLOW_EXTENSION), eq("test-action-001"),
