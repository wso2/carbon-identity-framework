...
public class UserChoiceDecisionNode implements Node {
    ...
    @Override
    public Response execute(FlowContext context, NodeConfig config) throws FlowEngineException {
    ...
    @Override
    public Response rollback(FlowContext context, NodeConfig nodeConfig)
