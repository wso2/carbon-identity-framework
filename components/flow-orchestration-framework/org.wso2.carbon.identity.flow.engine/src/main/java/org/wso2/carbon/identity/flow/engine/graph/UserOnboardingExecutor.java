...
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_INVALID_USERNAME;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_USERNAME_ALREADY_EXISTS;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_USERNAME_NOT_PROVIDED;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_USERSTORE_MANAGER_FAILURE;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_USER_ONBOARD_FAILURE;
import static org.wso2.carbon.identity.flow.engine.Constants.ExecutorStatus.STATUS_USER_CREATED;
import static org.wso2.carbon.identity.flow.engine.Constants.ExecutorStatus.USER_ALREADY_EXISTING_USERNAME;
import static org.wso2.carbon.identity.flow.engine.Constants.PASSWORD_KEY;
import static org.wso2.carbon.identity.flow.engine.Constants.SELF_REGISTRATION_DEFAULT_USERSTORE_CONFIG;
import static org.wso2.carbon.identity.flow.engine.Constants.USERNAME_CLAIM_URI;
import static org.wso2.carbon.identity.flow.engine.util.FlowEngineUtils.handleClientException;
...
public class UserOnboardingExecutor implements Executor {
    ...
    private FlowUser updateUserProfile(FlowContext context) throws FlowEngineException {
