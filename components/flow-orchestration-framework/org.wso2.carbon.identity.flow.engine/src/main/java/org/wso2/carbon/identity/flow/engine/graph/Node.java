...
public interface Node {
     ...
     */
    Response execute(FlowContext context, NodeConfig nodeConfig) throws FlowEngineException;
     ...
     * @return The response of the node.
     */
    Response rollback(FlowContext context, NodeConfig nodeConfig) throws FlowEngineException;
}
