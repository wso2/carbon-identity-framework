...
package org.wso2.carbon.identity.flow.engine.util;
...
import org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages;
import org.wso2.carbon.identity.flow.engine.cache.FlowContextCache;
import org.wso2.carbon.identity.flow.engine.cache.FlowContextCacheEntry;
import org.wso2.carbon.identity.flow.engine.cache.FlowContextCacheKey;
...
public class FlowEngineUtils {
    ...
    private static final Log LOG = LogFactory.getLog(FlowEngineUtils.class);
    ...
    public static void addFlowContextToCache(FlowContext context) {
        ...
        FlowContextCache.getInstance().addToCache(cacheKey, cacheEntry);
    ...
    public static void removeFlowContextFromCache(String contextId) {
        ...
        FlowContextCache.getInstance().clearCacheEntry(new FlowContextCacheKey(contextId));
        if (LOG.isDebugEnabled()) {
     ...
     */
    public static FlowContext initiateContext(String tenantDomain, String callbackUrl, String applicationId,
                                              String flowType)
        ...
        try {
            ...
            GraphConfig graphConfig =
                    FlowEngineDataHolder.getInstance().getFlowMgtService()
     ...
     */
    public static String resolveCompletionRedirectionUrl(FlowContext context)
    ...
    private static String getApplicationAccessUrlByAppId(String tenantDomain, String applicationId)
        ...
        ApplicationManagementService applicationManagementService =
                FlowEngineDataHolder.getInstance().getApplicationManagementService();
        try {
