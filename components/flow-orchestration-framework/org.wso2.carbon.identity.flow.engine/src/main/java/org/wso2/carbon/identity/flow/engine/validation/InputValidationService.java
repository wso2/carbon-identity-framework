...
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_GET_INPUT_VALIDATION_CONFIG_FAILURE;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_INVALID_ACTION_ID;
import static org.wso2.carbon.identity.flow.engine.Constants.ErrorMessages.ERROR_CODE_INVALID_USER_INPUT;
import static org.wso2.carbon.identity.flow.engine.Constants.IDENTIFIER;
import static org.wso2.carbon.identity.flow.engine.Constants.LENGTH_CONFIG;
import static org.wso2.carbon.identity.flow.engine.Constants.OTP_LENGTH;
import static org.wso2.carbon.identity.flow.engine.Constants.OTP_VARIANT;
import static org.wso2.carbon.identity.flow.engine.Constants.PASSWORD_KEY;
import static org.wso2.carbon.identity.flow.engine.Constants.REQUIRED;
import static org.wso2.carbon.identity.flow.engine.Constants.USERNAME_CLAIM_URI;
import static org.wso2.carbon.identity.flow.engine.Constants.VALIDATIONS;
...
public class InputValidationService {
     ...
     */
    public void validateInputs(FlowContext context) throws FlowEngineException {
        ...
        if (context.getCurrentStepInputs().get(actionId) == null) {
            throw FlowEngineUtils.handleClientException(ERROR_CODE_INVALID_ACTION_ID, actionId);
        }
     ...
     */
    public void prepareStepInputs(DataDTO dataDTO, FlowContext context)
     ...
     * @param context Flow context.
     */
    public void handleUserInputs(FlowContext context) {
     ...
     * @param context Flow context.
     */
    public void clearUserInputs(FlowContext context) {
     ...
     * @param context Flow context.
     */
    private void processStepInputs(DataDTO dataDTO, FlowContext context) {
     ...
     */
    private void processValidations(DataDTO dataDTO, FlowContext context)
            throws FlowEngineServerException {
    ...
    private ArrayList<ValidationDTO> getValidationDTOs(String tenantDomain, String key)
        ...
        try {
            List<ValidationConfiguration> validationConfigurations = FlowEngineDataHolder.getInstance()
