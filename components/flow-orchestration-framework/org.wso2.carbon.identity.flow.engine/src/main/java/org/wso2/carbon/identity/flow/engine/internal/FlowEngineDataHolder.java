 ...
 */
public class FlowEngineDataHolder {

    private static final Map<String, Executor> executors = new HashMap<>();
    private static final FlowEngineDataHolder instance = new FlowEngineDataHolder();
    ...
    private List<FlowListener> flowExecutionListeners = new ArrayList<>();

    private FlowEngineDataHolder() {

    }

    public static FlowEngineDataHolder getInstance() {
     ...
     */
    public List<FlowListener> getFlowListeners() {
     ...
     */
    public void addFlowExecutionListeners(FlowListener flowExecutionListeners) {
