...
/**
 * Unit tests for FlowEngineUtils.
 */
@WithCarbonHome
...
public class FlowEngineUtilsTest {
    ...
    public void testResolveCompletionRedirectionUrl(String appAccessUrl, boolean appFound, String expectedUrl)
        ...
        try (MockedStatic<FlowEngineDataHolder> dataHolderMockedStatic = mockStatic(
            ...
            String redirectUrl = FlowEngineUtils.resolveCompletionRedirectionUrl(context);
    ...
    public void testResolveCompletionRedirectionUrlWithException() throws Exception {
        ...
        try (MockedStatic<FlowEngineDataHolder> dataHolderMockedStatic = mockStatic(
            ...
            try {
                FlowEngineUtils.resolveCompletionRedirectionUrl(context);
