...
public interface FlowContextStoreDAO {
    ...
    /**
     * Clean up expired FlowExecutionContexts.
     *
     * @throws FlowEngineException if an error occurs while cleaning up expired contexts.
     */
    void cleanupExpiredContexts(int cleanupLimit) throws FlowEngineException;
}
