...
package org.wso2.carbon.identity.flow.extensions.internal;
...
import org.wso2.carbon.identity.flow.extensions.executor.InFlowExtensionExecutor;
import org.wso2.carbon.identity.flow.extensions.executor.InFlowExtensionRequestBuilder;
import org.wso2.carbon.identity.flow.extensions.executor.InFlowExtensionResponseProcessor;
import org.wso2.carbon.identity.flow.extensions.management.InFlowExtensionActionConverter;
import org.wso2.carbon.identity.flow.extensions.management.InFlowExtensionActionDTOModelResolver;

/**
 * OSGi declarative services component which registers the In-Flow Extension services.
 */
@Component(
        name = "flow.extensions.component",
        immediate = true)
public class InFlowExtensionServiceComponent {

    private static final Log LOG = LogFactory.getLog(InFlowExtensionServiceComponent.class);
        ...
        try {
            ...
            bundleContext.registerService(ActionDTOModelResolver.class.getName(),
                    new InFlowExtensionActionDTOModelResolver(
                            InFlowExtensionDataHolder.getInstance().getCertificateManagementService()),
                    null);
    ...
    protected void setActionManagementService(ActionManagementService actionManagementService) {
        ...
        InFlowExtensionDataHolder.getInstance().setActionManagementService(actionManagementService);
    }
