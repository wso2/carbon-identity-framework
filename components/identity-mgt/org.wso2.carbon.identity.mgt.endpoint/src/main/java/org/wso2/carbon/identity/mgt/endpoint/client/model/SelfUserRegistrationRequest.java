 ...
 * This document specifies a **RESTful API** for WSO2 **Identity Server** .  It is written with [swagger 2]
 * (http://swagger.io/).
 * <p/>
...
public class SelfUserRegistrationRequest {
    ...
    public SelfUserRegistrationRequest user(SelfRegistrationUser user) {
        this.user = user;
        return this;
    }
    ...
    public void setUser(SelfRegistrationUser user) {
        this.user = user;
    }
