 ...
 * This class holds the authenticated user entity details for a given flow.
 */
public class UserEntity implements InitiatingEntity {
    ...
    public static class Builder {
        ...
        public Builder(UserEntity userEntity) {
            ...
            this.loginIdentifier = userEntity.loginIdentifier;
        }
