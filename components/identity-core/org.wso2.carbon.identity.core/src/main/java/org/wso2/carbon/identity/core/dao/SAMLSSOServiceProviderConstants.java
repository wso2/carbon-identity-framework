    ...
    public static class SQLQueries {
        ...
        public static final String ADD_SAML2_SSO_CONFIG =
                "INSERT INTO IDN_SAML2_SERVICE_PROVIDER " +
                        "(ISSUER, NAME_ID_FORMAT, CERT_ALIAS, REQ_SIG_VALIDATION, SIGN_RESPONSE, SIGNING_ALGO, " +
                        "DIGEST_ALGO, ENCRYPT_ASSERTION, ASSERTION_ENCRYPTION_ALGO, KEY_ENCRYPTION_ALGO, " +
                        ...
                        "VALUES (:ISSUER;, :NAME_ID_FORMAT;, :CERT_ALIAS;, :REQ_SIG_VALIDATION;, :SIGN_RESPONSE;, " +
                        ":SIGNING_ALGO;, :DIGEST_ALGO;, :ENCRYPT_ASSERTION;, :ASSERTION_ENCRYPTION_ALGO;, " +
                        ":KEY_ENCRYPTION_ALGO;, :ATTR_PROFILE_ENABLED;, :ATTR_SERVICE_INDEX;, " +
                        ":SLO_PROFILE_ENABLED;, :SLO_METHOD;, :SLO_RESPONSE_URL;, :SLO_REQUEST_URL;, " +
                        ":IDP_INIT_SSO_ENABLED;, :IDP_INIT_SLO_ENABLED;, :QUERY_REQUEST_PROFILE_ENABLED;, " +
                        ":ECP_ENABLED;, :ARTIFACT_BINDING_ENABLED;, :ARTIFACT_RESOLVE_REQ_SIG_VALIDATION;, " +
                        ":IDP_ENTITY_ID_ALIAS;, :ISSUER_QUALIFIER;, :SUPPORTED_ASSERTION_QUERY_REQUEST_TYPES;, " +
                        ":TENANT_ID;)";

        public static final String UPDATE_SAML2_SSO_CONFIG =
                "UPDATE IDN_SAML2_SERVICE_PROVIDER " +
                        "SET ISSUER = :ISSUER;, NAME_ID_FORMAT = :NAME_ID_FORMAT;, CERT_ALIAS = :CERT_ALIAS;, " +
                        ...
                        "ATTR_SERVICE_INDEX = :ATTR_SERVICE_INDEX;, " +
                        "SLO_PROFILE_ENABLED = :SLO_PROFILE_ENABLED;, SLO_METHOD = :SLO_METHOD;, " +
                        "SLO_RESPONSE_URL = :SLO_RESPONSE_URL;, SLO_REQUEST_URL = :SLO_REQUEST_URL;, " +
        ...
        public static final String GET_SAML2_SSO_CONFIG_BY_ISSUER =
                "SELECT ID, ISSUER, NAME_ID_FORMAT, CERT_ALIAS, REQ_SIG_VALIDATION, SIGN_RESPONSE, SIGNING_ALGO, " +
                        "DIGEST_ALGO, ENCRYPT_ASSERTION, ASSERTION_ENCRYPTION_ALGO, KEY_ENCRYPTION_ALGO, " +
                        "ATTR_PROFILE_ENABLED, ATTR_SERVICE_INDEX, SLO_PROFILE_ENABLED, SLO_METHOD, " +
                        "SLO_RESPONSE_URL, SLO_REQUEST_URL, IDP_INIT_SSO_ENABLED, IDP_INIT_SLO_ENABLED, " +
                        "QUERY_REQUEST_PROFILE_ENABLED, ECP_ENABLED, ARTIFACT_BINDING_ENABLED, " +
        ...
        public static final String ADD_SAML_SSO_ATTR =
                "INSERT INTO IDN_SAML2_SP_PROPERTIES " +
                        "(PROPERTY_NAME, PROPERTY_VALUE, DEFAULT_FLAG, SP_ID, TENANT_ID) " +
                        "VALUES (:PROPERTY_NAME;, :PROPERTY_VALUE;, :DEFAULT_FLAG;, :SP_ID;, :TENANT_ID;)";
        ...
        public static final String GET_SAML_SSO_ATTR_BY_ID =
                "SELECT ID, PROPERTY_NAME, PROPERTY_VALUE, DEFAULT_FLAG " +
