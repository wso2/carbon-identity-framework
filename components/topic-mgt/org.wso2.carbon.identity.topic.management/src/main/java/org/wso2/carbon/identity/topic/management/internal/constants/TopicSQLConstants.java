...
package org.wso2.carbon.identity.topic.management.internal.constants;
...
public class TopicSQLConstants {
    ...
    public static class Query {
        ...
        public static final String ADD_TOPIC = "INSERT INTO IDN_WEBHOOK_TOPIC (TOPIC, CHANNEL_VERSION, TENANT_ID) " +
                "VALUES (:TOPIC;, :CHANNEL_VERSION;, :TENANT_ID;)";
        public static final String DELETE_TOPIC = "DELETE FROM IDN_WEBHOOK_TOPIC WHERE TOPIC = :TOPIC; " +
                "AND CHANNEL_VERSION = :CHANNEL_VERSION; AND TENANT_ID = :TENANT_ID;";
        public static final String CHECK_TOPIC_EXISTS = "SELECT 1 FROM IDN_WEBHOOK_TOPIC WHERE TOPIC = :TOPIC; " +
                "AND CHANNEL_VERSION = :CHANNEL_VERSION; AND TENANT_ID = :TENANT_ID;";
        public static final String GET_TOPIC_BY_TOPIC_STRING =
                "SELECT TOPIC FROM IDN_WEBHOOK_TOPIC WHERE TOPIC = :TOPIC; " +
                        "AND CHANNEL_VERSION = :CHANNEL_VERSION; AND TENANT_ID = :TENANT_ID;";
