 ...
 * under the License.
 */
package org.wso2.carbon.identity.fraud.detectors.core.service;
...
import org.wso2.carbon.identity.fraud.detectors.core.model.FraudDetectionConfigDTO;
...
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.ErrorMessages.ERROR_CODE_ADDING_FRAUD_DETECTOR_CONFIG;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.ErrorMessages.ERROR_CODE_GETTING_FRAUD_DETECTOR_CONFIG;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.ErrorMessages.ERROR_CODE_UPDATING_FRAUD_DETECTOR_CONFIG;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.LOGIN_EVENT_PROP_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.LOGOUT_EVENT_PROP_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.NOTIFICATION_BASED_VERIFICATION_EVENT_PROP_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.PUBLISH_DEVICE_METADATA_ATTR_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.PUBLISH_USER_INFO_ATTR_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.RESOURCE_NAME;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.RESOURCE_TYPE;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.UPDATE_CREDENTIAL_EVENT_PROP_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.UPDATE_PROFILE_EVENT_PROP_KEY;
import static org.wso2.carbon.identity.fraud.detectors.core.constant.FraudDetectorConstants.USER_REGISTRATION_EVENT_PROP_KEY;
...
public class FraudDetectionConfigsService {
    ...
    private Resource getResource(String tenantDomain) throws FraudDetectionConfigServerException {
        ...
        try {
            ...
            resource = IdentityFraudDetectorDataHolder.getInstance().getConfigurationManager()
    ...
    private Resource addResource(Resource resource, String tenantDomain)
        ...
        try {
            return IdentityFraudDetectorDataHolder.getInstance().getConfigurationManager()
    ...
    private void createResourceType(String tenantDomain) throws FraudDetectionConfigServerException {
        ...
        try {
            ...
            IdentityFraudDetectorDataHolder.getInstance().getConfigurationManager().addResourceType(resourceType);
        } catch (ConfigurationManagementException e) {
            throw handleServerException(ERROR_CODE_ADDING_FRAUD_DETECTOR_CONFIG, e, tenantDomain);
        }
    }
    ...
    private int getPrimaryTenantId(String tenantDomain) throws OrganizationManagementException {
        ...
        OrganizationManager organizationManager = IdentityFraudDetectorDataHolder.getInstance()
     ...
     */
    private FraudDetectionConfigServerException handleServerException(FraudDetectorConstants.ErrorMessages error,
