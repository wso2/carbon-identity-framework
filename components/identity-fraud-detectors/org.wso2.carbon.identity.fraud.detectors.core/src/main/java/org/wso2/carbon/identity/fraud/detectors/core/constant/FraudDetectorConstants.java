...
/**
 * Constants for the Identity Fraud Detectors component.
 */
public class FraudDetectorConstants {
    ...
    public static final String IS_LOGGING_ENABLED = "IdentityFraudDetectorEventHandler.properties.logs_enabled";
