...
public interface IdentityFraudDetector {
     ...
     * @throws IdentityFraudDetectorException If an error occurs while building the request.
     */
    HttpUriRequest buildRequest(FraudDetectorRequestDTO requestDTO) throws IdentityFraudDetectorException;
     ...
     * @throws IdentityFraudDetectorException If an error occurs while handling the response.
     */
     ...
     * @throws IdentityFraudDetectorException If an error occurs while masking the payload.
     */
    String getMaskedRequestPayload(String payload) throws IdentityFraudDetectorException;
}
