...
/**
 * Data holder for Identity Fraud Detectors component.
 */
public class IdentityFraudDetectorDataHolder {

    private static final IdentityFraudDetectorDataHolder instance = new IdentityFraudDetectorDataHolder();
     ...
     */
    private IdentityFraudDetectorDataHolder() {
     ...
     */
    public static IdentityFraudDetectorDataHolder getInstance() {
