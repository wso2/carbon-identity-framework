 ...
 * under the License.
 */
package org.wso2.carbon.identity.fraud.detectors.core.model;
...
public class FraudDetectorResponseDTO implements Serializable {
    ...
    private FraudDetectorConstants.ExecutionStatus status;
    private FraudDetectorConstants.ErrorType errorType;
    private String errorReason;
    private FraudDetectorConstants.FraudDetectionEvents eventName;
     ...
     */
    public FraudDetectorResponseDTO(FraudDetectorConstants.ExecutionStatus status,
     ...
     */
    public FraudDetectorConstants.ExecutionStatus getStatus() {
     ...
     */
    public void setErrorType(FraudDetectorConstants.ErrorType errorReason) {
     ...
     */
    public FraudDetectorConstants.ErrorType getErrorType() {
     ...
     */
    public FraudDetectorConstants.FraudDetectionEvents getEventName() {
