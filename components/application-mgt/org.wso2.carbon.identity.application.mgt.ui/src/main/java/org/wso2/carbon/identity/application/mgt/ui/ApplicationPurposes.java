...
/**
 * This class represents model used for management console to hold application specific purposes and general purposes
...
public class ApplicationPurposes {
    ...
    public List<ApplicationPurpose> getAppGeneralPurposes() {

        return appGeneralPurposes;
    }

    public void setAppGeneralPurposes(List<ApplicationPurpose> appGeneralPurposes) {

        this.appGeneralPurposes = appGeneralPurposes;
    }
}
