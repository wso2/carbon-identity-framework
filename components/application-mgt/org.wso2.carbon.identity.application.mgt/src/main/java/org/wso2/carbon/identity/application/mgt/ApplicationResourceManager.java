...
public interface ApplicationResourceManager {
    ...
    Application getApplication(String applicationResourceId,
                               String tenantDomain) throws IdentityApplicationManagementException;

    Application updateApplication(String applicationResourceId,
                                  String tenantDomain,
                                  Application updatedApplication) throws IdentityApplicationManagementException;

    void deleteApplication(String applicationResourceId,
                           String tenantDomain) throws IdentityApplicationManagementException;
}
