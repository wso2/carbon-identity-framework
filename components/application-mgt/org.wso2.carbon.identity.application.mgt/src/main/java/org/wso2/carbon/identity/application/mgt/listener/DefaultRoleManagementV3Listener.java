...
/**
 * Default Role Management Listener implementation of Role Management V3 Listener,
 * and application based role management.
 */
public class DefaultRoleManagementV3Listener extends AbstractApplicationMgtListener implements RoleManagementListener {
    ...
    @Override
    public void preAddRole(String roleName, List<Permission> permissions, String audience, String audienceId,
                           String tenantDomain)
    ...
    @Override
    public void postAddRole(RoleBasicInfo roleBasicInfo, String roleName, List<Permission> permissions, String audience,
    ...
    public void preUpdateRoleName(String roleID, String newRoleName, String tenantDomain)
        ...
        try {
            Role role = ApplicationManagementServiceComponentHolder.getInstance().getRoleManagementServiceV3()
