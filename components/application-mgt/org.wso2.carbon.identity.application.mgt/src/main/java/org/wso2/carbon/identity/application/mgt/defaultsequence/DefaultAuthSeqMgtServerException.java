 ...
 */
public class DefaultAuthSeqMgtServerException extends DefaultAuthSeqMgtException {

    private String message;

    private static final long serialVersionUID = -1982152066401023165L;

    public DefaultAuthSeqMgtServerException(String message) {

        super(message);
        this.message = message;
    }

    public DefaultAuthSeqMgtServerException(String message, Throwable e) {
