...
public class ApplicationManagementAdminService extends AbstractAdmin {
    ...
    /**
     * Remove sensitive information from the federated authenticator configs if the
     * user is not authorized to view them.
     *
     * @param idp Identity provider object
     * @return Identity provider object with sensitive information removed
     * @throws IdentityApplicationManagementException if an error occurs while
    ...
    /**
     * Check whether the user is authorized to perform the operation.
     *
     * @return true if the user is authorized to perform the operation, false
     *         otherwise
     * @throws IdentityApplicationManagementException if an error occurs while
     *                                                checking the authorization
     */
     ...
     * Check whether the user is authorized to perform the operation.
     *
     * @param realm           User realm of the user
     * @param currentUserName Username of the user
     * @return true if the user is authorized to perform the operation, false
     *         otherwise
     * @throws UserStoreException if an error occurs while checking the
     *                            authorization
     */
     ...
     *
     * @param idP IdentityProvider object to be cloned
     * @return Cloned IdentityProvider object
