...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_APP_NAME_AND_TENANT = "SELECT DISTINCT COUNT(UUID) " +
            "FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_TENANT = "SELECT DISTINCT COUNT(UUID) FROM SP_APP " +
    ...
    public static final String IS_APP_BY_TENANT_AND_UUID_DISCOVERABLE = "SELECT DISTINCT COUNT(UUID) FROM SP_APP " +
