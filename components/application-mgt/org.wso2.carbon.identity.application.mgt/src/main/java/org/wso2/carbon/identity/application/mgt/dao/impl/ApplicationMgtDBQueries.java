...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MYSQL = "SELECT SP_APP.ID, APP_NAME, VERSION, " +
            "DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM SP_APP " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_ORACLE = "SELECT ID, APP_NAME, VERSION, " +
            "DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM " +
            "(SELECT ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID" +
            ", GROUP_ID, rownum AS rnum FROM " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MSSQL = "SELECT SP_APP.ID, APP_NAME, VERSION, " +
            ...
            "WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1' ORDER BY ID " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_POSTGRESQL = "SELECT SP_APP.ID, " +
            ...
            "GROUP_ID FROM SP_APP LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_DB2SQL = "SELECT ID, " +
            "APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, "
            + "GROUP_ID FROM (SELECT ROW_NUMBER() OVER(ORDER BY SP_APP.ID DESC) AS rn, SP_APP.*, GROUP_ID FROM " +
            "SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1') WHERE rn BETWEEN :ONE_BASED_START_INDEX; AND " +
            ":END_INDEX;";
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_INFORMIX = "SELECT SKIP :OFFSET; FIRST " +
            ...
            "APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1' ORDER BY ID DESC";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_MYSQL =
            "SELECT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION" +
                    " , UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM SP_APP " +
                    "LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = " +
                    ":TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1' ORDER BY ID DESC LIMIT " +
                    ":OFFSET;, :LIMIT;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_ORACLE = "SELECT ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM " +
            "(SELECT ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
            "TENANT_ID, GROUP_ID, rownum AS rnum FROM " +
            "(SELECT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
            "TENANT_ID, GROUP_ID FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = " +
            "APP_GROUP_ASSOCIATION.APP_ID ORDER BY ID DESC) WHERE TENANT_ID = :TENANT_ID; AND APP_NAME LIKE " +
            ":APP_NAME; AND rownum <= :END_INDEX; AND IS_DISCOVERABLE = '1') WHERE rnum > :ZERO_BASED_START_INDEX;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_MSSQL = "SELECT SP_APP.ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM " +
            "SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1' ORDER BY ID " +
            "DESC OFFSET :OFFSET; ROWS FETCH NEXT :LIMIT; ROWS ONLY";
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_POSTGRESQL = "SELECT SP_APP.ID, " +
            ...
            ":TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1' ORDER BY ID " +
            "DESC LIMIT :LIMIT; OFFSET :OFFSET;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_DB2 = "SELECT ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, GROUP_ID FROM "
            + "(SELECT ROW_NUMBER() OVER(ORDER BY SP_APP.ID DESC) AS rn, SP_APP.*, GROUP_ID FROM SP_APP LEFT OUTER " +
    ...
    public static final String LOAD_DISCOVERABLE_APP_BY_TENANT_AND_UUID = "SELECT SP_APP.ID, APP_NAME, VERSION, " +
            "DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, IS_DISCOVERABLE, USERNAME, USER_STORE, TENANT_ID, GROUP_ID " +
            "FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND UUID = :UUID;";

    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_APP_NAME_AND_TENANT = "SELECT GROUP_ID FROM SP_APP " +
    ...
    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_TENANT = "SELECT GROUP_ID FROM SP_APP LEFT OUTER " +
            "JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; " +
            "AND IS_DISCOVERABLE = '1'";

    public static final String IS_APP_BY_TENANT_AND_UUID_DISCOVERABLE = "SELECT GROUP_ID FROM SP_APP LEFT OUTER " +
