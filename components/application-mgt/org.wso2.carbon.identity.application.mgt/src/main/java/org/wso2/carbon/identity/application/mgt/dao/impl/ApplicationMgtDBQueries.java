...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_DISCOVERABLE_APP_BY_TENANT_AND_UUID = "SELECT SP_APP.ID, APP_NAME, VERSION, " +
            "DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, IS_DISCOVERABLE, USERNAME, USER_STORE, TENANT_ID " +
    ...
    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_TENANT = "SELECT COUNT(UUID) FROM SP_APP LEFT OUTER " +
            "JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; " +
            "AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String IS_APP_BY_TENANT_AND_UUID_DISCOVERABLE = "SELECT COUNT(UUID) FROM SP_APP LEFT OUTER " +
            "JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
