...
public class ApplicationMgtDBQueries {
    ...
    public static final String GET_REQUESTED_SP_CLAIM_USAGES = "SELECT COUNT(*) FROM SP_CLAIM_MAPPING " +
            "WHERE TENANT_ID = ? AND IDP_CLAIM = ? AND IS_REQUESTED = 1 OR IS_MANDATORY = 1";
