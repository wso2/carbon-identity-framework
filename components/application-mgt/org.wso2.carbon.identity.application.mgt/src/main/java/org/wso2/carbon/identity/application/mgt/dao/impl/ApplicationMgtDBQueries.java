...
public class ApplicationMgtDBQueries {
    ...
    public static final String DELETE_AUTHORIZED_SCOPE = "DELETE FROM AUTHORIZED_SCOPE LEFT JOIN SCOPE ON " +
            "AUTHORIZED_SCOPE.SCOPE_ID = SCOPE.ID WHERE APP_ID = ? AND API_ID = ? AND SCOPE.NAME = ? AND TENANT_ID = ?";
