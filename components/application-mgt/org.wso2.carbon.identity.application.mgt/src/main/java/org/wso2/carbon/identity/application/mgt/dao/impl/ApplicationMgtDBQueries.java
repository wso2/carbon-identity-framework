...
public class ApplicationMgtDBQueries {
    ...
    public static final String STORE_BASIC_APPINFO = "INSERT INTO SP_APP (TENANT_ID, APP_NAME, USER_STORE, USERNAME, " +
            ...
            "VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    public static final String STORE_BASIC_APPINFO_WITH_APPID = "INSERT INTO SP_APP (TENANT_ID, APP_NAME, " +
            "USER_STORE, USERNAME, DESCRIPTION, AUTH_TYPE, IS_USE_TENANT_DOMAIN_SUBJECT, ENABLE_AUTHORIZATION, " +
            "IS_USE_USER_DOMAIN_SUBJECT, UUID, IMAGE_URL, ACCESS_URL, ID) " +
            "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
