...
public class ApplicationMgtDBQueries {
    ...
    public static final String STORE_BASIC_APPINFO = "INSERT INTO SP_APP (TENANT_ID, APP_NAME, USER_STORE, USERNAME, " +
            ...
            "UUID, IMAGE_URL, ACCESS_URL, APP_VERSION) " +
            "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    public static final String UPDATE_BASIC_APPINFO = "UPDATE SP_APP SET APP_NAME=:APP_NAME;, " +
            ...
            "IMAGE_URL=:IMAGE_URL;, ACCESS_URL=:ACCESS_URL;, APP_VERSION=:APP_VERSION; " +
    ...
    public static final String UPDATE_BASIC_APPINFO_WITH_OWNER_UPDATE = "UPDATE SP_APP SET APP_NAME=:APP_NAME;, " +
            ...
            "ACCESS_URL=:ACCESS_URL;, APP_VERSION=:APP_VERSION; WHERE TENANT_ID=:TENANT_ID; AND ID=:ID;";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION FROM SP_APP " +
            "WHERE TENANT_ID = ? AND APP_NAME != ? ORDER BY ID DESC";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME = "SELECT ID, APP_NAME, APP_VERSION, " +
    ...
    public static final String LOAD_APP_BY_TENANT_AND_NAME = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_MYSQL = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MYSQL = "SELECT DISTINCT SP_APP.ID," +
            " SP_APP.APP_NAME, SP_APP.APP_VERSION, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL," +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_ORACLE = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "(SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_ORACLE = "SELECT DISTINCT ID, APP_NAME " +
            "APP_VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "(SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, INBOUND_AUTH_KEY, " +
            "INBOUND_AUTH_TYPE, USERNAME, USER_STORE, TENANT_ID, ROWNUM AS rn from " +
            "(SELECT SP_APP.ID, SP_APP.APP_NAME, SP_APP.APP_VERSION, SP_APP.DESCRIPTION, SP_APP.UUID, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_DB2SQL = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_MSSQL = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MSSQL = "SELECT DISTINCT SP_APP.ID, " +
            "SP_APP.APP_NAME, SP_APP.APP_VERSION, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, " +
            "SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID FROM SP_APP LEFT JOIN SP_INBOUND_AUTH ON " +
            "SP_APP.ACCESS_URL, SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? AND " +
            "SP_APP.APP_NAME != ? AND (%s) ORDER BY SP_APP.ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";

    public static final String LOAD_APP_NAMES_BY_TENANT_POSTGRESQL = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_INFORMIX = "SELECT SKIP ? FIRST ? ID, APP_NAME, APP_VERSION, " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_INFORMIX = "SELECT SKIP ? FIRST ? DISTINCT " +
            "SP_APP.ID, SP_APP.APP_NAME, SP_APP.APP_VERSION, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, " +
            "SP_APP.ACCESS_URL, SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID FROM SP_APP " +
    ...
    public static final String LOAD_BASIC_APP_INFO_BY_APP_ID = "SELECT ID, TENANT_ID, APP_NAME, APP_VERSION, " +
    ...
    public static final String LOAD_APP_BY_TENANT_AND_UUID = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, " +
            "IMAGE_URL, ACCESS_URL, IS_DISCOVERABLE, USERNAME, USER_STORE, TENANT_ID FROM SP_APP WHERE " +
    ...
    public static final String LOAD_APP_BY_NAME_AND_TENANT = "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MYSQL = "SELECT ID, APP_NAME, APP_VERSION, " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_ORACLE = "SELECT ID, APP_NAME, APP_VERSION, " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MSSQL = "SELECT ID, APP_NAME, APP_VERSION, " +
            "DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_POSTGRESQL = "SELECT ID, " +
            "APP_NAME, APP_VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1' ORDER BY ID " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_INFORMIX = "SELECT SKIP :OFFSET; FIRST " +
            ":LIMIT; ID, APP_NAME, APP_VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_MYSQL =
            "SELECT ID, APP_NAME, APP_VERSION, DESCRIPTION" +
