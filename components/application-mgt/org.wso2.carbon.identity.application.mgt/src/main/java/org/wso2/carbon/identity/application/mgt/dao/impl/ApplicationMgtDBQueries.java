...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_COUNT_BY_TENANT_AND_FILTER_TAGS = "SELECT COUNT(DISTINCT SP_APP.APP_NAME) " +
            "FROM SP_APP LEFT JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID LEFT JOIN SP_TAG ON " +
            "SP_APP.ID = SP_TAG.APP_ID LEFT JOIN TAG ON SP_TAG.TAG_UUID = TAG.UUID WHERE SP_APP.TENANT_ID = ? " +
            "AND SP_APP.APP_NAME != ? AND (%s)";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MYSQL = "SELECT DISTINCT SP_APP.ID, " +
            ...
            "SP_INBOUND_AUTH.INBOUND_AUTH_KEY, SP_INBOUND_AUTH.INBOUND_AUTH_TYPE, SP_APP.USERNAME, SP_APP.USER_STORE," +
            " SP_APP.TENANT_ID FROM SP_APP LEFT JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID LEFT JOIN" +
            " SP_TAG ON SP_APP.ID = SP_TAG.APP_ID LEFT JOIN TAG ON SP_TAG.TAG_UUID = TAG.UUID WHERE" +
            " SP_APP.TENANT_ID = ? AND SP_APP.APP_NAME != ? AND (%s) ORDER BY SP_APP.ID DESC LIMIT ?, ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_ORACLE = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, INBOUND_AUTH_KEY, INBOUND_AUTH_TYPE, USERNAME, USER_STORE, TENANT_ID FROM " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MSSQL = "SELECT SP_APP.ID, SP_APP.APP_NAME, " +
            "SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_INBOUND_AUTH.INBOUND_AUTH_KEY, " +
            "SP_INBOUND_AUTH.INBOUND_AUTH_TYPE, SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID FROM SP_APP " +
            "LEFT JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? AND " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_POSTGRESQL = "SELECT SP_APP.ID, " +
            "SP_APP.APP_NAME, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, " +
            "SP_INBOUND_AUTH.INBOUND_AUTH_KEY, SP_INBOUND_AUTH.INBOUND_AUTH_TYPE, SP_APP.USERNAME, " +
    ...
    public static final String LOAD_APP_TAGS_INFO_BY_APP_ID_AND_TENANT_ID = "SELECT TAG.UUID AS TAG_ID, TAG.NAME AS " +
            "TAG_NAME, TAG.COLOUR AS TAG_COLOUR FROM TAG LEFT JOIN SP_TAG ON TAG.UUID = SP_TAG.TAG_UUID WHERE " +
            "SP_TAG.APP_ID = ? AND TAG.TENANT_ID = ?";
