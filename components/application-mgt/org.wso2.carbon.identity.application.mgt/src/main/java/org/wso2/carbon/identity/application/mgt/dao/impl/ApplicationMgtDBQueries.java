...
public class ApplicationMgtDBQueries {
    ...
    // %s is replaced at runtime with the generated list of ID parameters.
    public static final String LOAD_APP_BASIC_INFO_BY_IDS =
            "SELECT ID, APP_NAME, UUID FROM SP_APP WHERE ID IN (%s)";

    // %s is replaced at runtime with the filter clause of the caller.
    public static final String LOAD_APP_BASIC_INFO_BY_FILTER =
            "SELECT ID, APP_NAME, UUID FROM SP_APP %s";
    ...
    public static final String GET_AUTHORIZED_AUTHORIZATION_DETAILS_TYPES =
            ...
            " FROM AUTHORIZED_API " +
            "INNER JOIN AUTHORIZED_AUTHORIZATION_DETAILS_TYPES AADT ON AUTHORIZED_API.APP_ID = AADT.APP_ID " +
