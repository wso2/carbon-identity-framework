...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_MYSQL = "SELECT ID, APP_NAME, VERSION, DESCRIPTION, " +
            ...
            "APP_NAME != ? %s ORDER BY ID DESC LIMIT ?, ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MYSQL = "SELECT DISTINCT SP_APP.ID," +
            ...
            " SP_APP.APP_NAME != ? %s AND (%s) ORDER BY SP_APP.ID DESC LIMIT ?, ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_DB2SQL = "SELECT ID, APP_NAME, VERSION, DESCRIPTION, " +
            ...
            "ROW_NUMBER() OVER(ORDER BY ID DESC) AS rn,SP_APP.* FROM SP_APP WHERE TENANT_ID = ? " +
            "AND APP_NAME != ? %s ) WHERE rn BETWEEN ? AND ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_DB2SQL = "SELECT DISTINCT ID, APP_NAME, " +
            ...
            "SP_APP.APP_NAME <> ? %s AND (%s) ORDER BY SP_APP.ID DESC ) WHERE rn BETWEEN ? AND ?";

    public static final String LOAD_APP_NAMES_BY_TENANT_MSSQL = "SELECT ID, APP_NAME, VERSION, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP WHERE TENANT_ID = ? AND APP_NAME != ? %s ORDER BY ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_MSSQL = "SELECT DISTINCT SP_APP.ID, " +
            ...
            "SP_APP.APP_NAME != ? %s AND (%s) ORDER BY SP_APP.ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";

    public static final String LOAD_APP_NAMES_BY_TENANT_POSTGRESQL = "SELECT ID, APP_NAME, VERSION, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP WHERE TENANT_ID = ? AND APP_NAME != ? %s ORDER BY ID DESC LIMIT ? OFFSET ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_POSTGRESQL = "SELECT DISTINCT SP_APP.ID, " +
            ...
            "AND SP_APP.APP_NAME != ? %s AND (%s) ORDER BY SP_APP.ID DESC LIMIT ? OFFSET ?";
    ...
    public static final String LOAD_IDP_AND_AUTHENTICATOR_NAMES = "SELECT A.NAME, B.NAME, B.DISPLAY_NAME," +
            " B.DEFINED_BY, B.AMR_VALUE FROM IDP A JOIN IDP_AUTHENTICATOR B ON A.ID = B.IDP_ID WHERE B.ID =? AND ((A" +
            ".TENANT_ID =?" +
    ...
    public static final String STORE_LOCAL_AUTHENTICATOR = "INSERT INTO IDP_AUTHENTICATOR (TENANT_ID, IDP_ID, NAME," +
            "IS_ENABLED, DISPLAY_NAME, DEFINED_BY, AUTHENTICATION_TYPE, AMR_VALUE) VALUES " +
            "(?, (SELECT ID FROM IDP WHERE IDP.NAME=? AND IDP.TENANT_ID =?), ?, ?, ?, ?, ?, ?)";
    public static final String STORE_LOCAL_AUTHENTICATOR_2 = "INSERT INTO IDP_AUTHENTICATOR (NAME, DISPLAY_NAME, " +
            "IS_ENABLED, DEFINED_BY, AUTHENTICATION_TYPE, AMR_VALUE) VALUES(?, ?, ?, ?, ?, ?)";
    public static final String AMR_VALUE_EXISTS = "SELECT AMR_VALUE FROM IDP_AUTHENTICATOR WHERE NAME = ?";
    public static final String UPDATE_AMR_VALUE = "UPDATE IDP_AUTHENTICATOR SET AMR_VALUE = ? WHERE NAME = ?";
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MYSQL = "SELECT DISTINCT SP_APP.ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM SP_APP " +
            "LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_ORACLE = "SELECT ID, APP_NAME, VERSION, " +
            ...
            "(SELECT DISTINCT ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, " +
            "USER_STORE, TENANT_ID, rownum AS rnum FROM " +
            "(SELECT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
            "TENANT_ID, IS_DISCOVERABLE, GROUP_ID FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = " +
            "APP_GROUP_ASSOCIATION.APP_ID ORDER BY ID DESC) WHERE TENANT_ID = :TENANT_ID; AND " +
            "rownum <= :END_INDEX; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
            ") WHERE rnum > :ZERO_BASED_START_INDEX;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_MSSQL = "SELECT DISTINCT SP_APP.ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID " +
            "WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
            "ORDER BY ID DESC OFFSET :OFFSET; ROWS FETCH NEXT :LIMIT; ROWS ONLY";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_POSTGRESQL = "SELECT DISTINCT SP_APP.ID, " +
            "APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID " +
            "FROM SP_APP LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID " +
            "WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1' ORDER BY ID DESC LIMIT :LIMIT; OFFSET :OFFSET;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_DB2SQL = "SELECT ID, " +
            "APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID "
            + "FROM (SELECT DISTINCT ROW_NUMBER() OVER(ORDER BY SP_APP.ID DESC) AS rn, SP_APP.* FROM " +
            "SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_INFORMIX = "SELECT SKIP :OFFSET; FIRST " +
            ":LIMIT; DISTINCT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, " +
            "USER_STORE, TENANT_ID FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = " +
            "APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID DESC";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_MYSQL = "SELECT DISTINCT SP_APP.ID, " +
            "APP_NAME, VERSION, DESCRIPTION , UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = " +
            ":TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID DESC LIMIT :OFFSET;, :LIMIT;";
    ...
    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_ORACLE = "SELECT ID, APP_NAME, " +
            ...
            "USER_STORE, TENANT_ID, rownum AS rnum FROM " +
            "(SELECT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
            "TENANT_ID, GROUP_ID FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = " +
            "APP_GROUP_ASSOCIATION.APP_ID ORDER BY ID DESC) WHERE TENANT_ID = :TENANT_ID; AND APP_NAME LIKE " +
            ":APP_NAME; AND rownum <= :END_INDEX; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + ") WHERE rnum > :ZERO_BASED_START_INDEX;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_MSSQL = "SELECT DISTINCT SP_APP.ID, " +
            "APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM " +
            "SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID DESC OFFSET :OFFSET; ROWS FETCH NEXT " +
            ":LIMIT; ROWS ONLY";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_POSTGRESQL = "SELECT DISTINCT " +
            "SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, " +
            "TENANT_ID FROM SP_APP LEFT JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID " +
            "WHERE TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID DESC LIMIT :LIMIT; OFFSET :OFFSET;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_DB2 = "SELECT ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID FROM "
            + "(SELECT DISTINCT ROW_NUMBER() OVER(ORDER BY SP_APP.ID DESC) AS rn, SP_APP.* FROM SP_APP LEFT OUTER " +
            "JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; " +
            "AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER +
            ") WHERE rn BETWEEN :ONE_BASED_START_INDEX; AND :END_INDEX;";

    public static final String LOAD_DISCOVERABLE_APPS_BY_TENANT_AND_APP_NAME_INFORMIX = "SELECT SKIP :OFFSET; FIRST " +
            ":LIMIT; DISTINCT SP_APP.ID, APP_NAME, VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, " +
            "USER_STORE, TENANT_ID FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = " +
            "APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND " +
            "IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER + "ORDER BY ID " +
            "DESC";

    public static final String LOAD_DISCOVERABLE_APP_BY_TENANT_AND_UUID = "SELECT DISTINCT SP_APP.ID, APP_NAME, " +
            "VERSION, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, IS_DISCOVERABLE, USERNAME, USER_STORE, TENANT_ID " +
            "FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND UUID = :UUID;" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_APP_NAME_AND_TENANT = "SELECT COUNT(DISTINCT(UUID)) " +
            "FROM SP_APP LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND APP_NAME LIKE :APP_NAME; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String LOAD_DISCOVERABLE_APP_COUNT_BY_TENANT = "SELECT COUNT(DISTINCT(UUID)) FROM SP_APP " +
            "LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE TENANT_ID = " +
            ":TENANT_ID; AND IS_DISCOVERABLE = '1'" + SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String IS_APP_BY_TENANT_AND_UUID_DISCOVERABLE = "SELECT COUNT(DISTINCT(UUID)) FROM SP_APP " +
            "LEFT OUTER JOIN APP_GROUP_ASSOCIATION ON SP_APP.ID = APP_GROUP_ASSOCIATION.APP_ID WHERE " +
            "TENANT_ID = :TENANT_ID; AND UUID = :UUID; AND IS_DISCOVERABLE = '1'" +
            SQLPlaceholders.GROUP_ID_CONDITION_PLACEHOLDER;

    public static final String DISCOVERABLE_BY_ANY_USER = " AND GROUP_ID IS NULL ";

    public static final String DISCOVERABLE_BY_USER_GROUPS = " AND (GROUP_ID IS NULL OR GROUP_ID IN (" +
            SQLPlaceholders.GROUP_ID_LIST_PLACEHOLDER + ")) ";
