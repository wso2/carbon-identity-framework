...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_IDP_AND_AUTHENTICATOR_NAMES_WITH_AMR = "SELECT A.NAME, B.NAME, B.DISPLAY_NAME," +
    ...
    public static final String STORE_LOCAL_AUTHENTICATOR_WITH_AMR = "INSERT INTO IDP_AUTHENTICATOR (TENANT_ID, " +
            "IDP_ID, NAME, IS_ENABLED, DISPLAY_NAME, DEFINED_BY, AUTHENTICATION_TYPE, AMR_VALUE) VALUES " +
            "(?, (SELECT ID FROM IDP WHERE IDP.NAME=? AND IDP.TENANT_ID =?), ?, ?, ?, ?, ?, ?)";
