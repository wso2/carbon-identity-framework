...
public class ApplicationMgtDBQueries {
    ...
    public static final String GET_AUTHORIZED_APIS = "SELECT AUTHORIZED_API.APP_ID, AUTHORIZED_API.API_ID, " +
            "POLICY_ID, SCOPE.NAME FROM AUTHORIZED_API LEFT JOIN AUTHORIZED_SCOPE ON " +
    ...
    public static final String GET_AUTHORIZED_SCOPES = "SELECT POLICY_ID, SCOPE.NAME FROM AUTHORIZED_API JOIN" +
            " AUTHORIZED_SCOPE ON AUTHORIZED_API.APP_ID = AUTHORIZED_SCOPE.APP_ID AND AUTHORIZED_API.API_ID " +
            "= AUTHORIZED_SCOPE.API_ID LEFT JOIN SCOPE ON AUTHORIZED_SCOPE.SCOPE_ID = SCOPE.ID WHERE" +
            " AUTHORIZED_API.APP_ID = ?";
