...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_ORACLE = "SELECT ID, APP_NAME, DESCRIPTION FROM SP_APP " +
            "WHERE TENANT_ID = ? ORDER BY ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_ORACLE = "SELECT ID, APP_NAME, DESCRIPTION FROM " +
            "SP_APP WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
    public static final String LOAD_APP_NAMES_BY_TENANT_DB2SQL = "SELECT ID, APP_NAME, DESCRIPTION FROM SP_APP " +
            "WHERE TENANT_ID = ? ORDER BY ID DESC LIMIT ? OFFSET ?";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_DB2SQL = "SELECT ID, APP_NAME, DESCRIPTION FROM SP_APP " +
    ...
    public static final String LOAD_CLAIM_MAPPING_BY_APP_NAME = "SELECT IDP_CLAIM, SP_CLAIM, IS_REQUESTED, IS_MANDATORY, DEFAULT_VALUE "
                                                                + "FROM SP_CLAIM_MAPPING WHERE APP_ID = (SELECT ID "
