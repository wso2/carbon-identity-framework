...
public class ApplicationMgtDBQueries {
    ...
    public static final String STORE_BASIC_APPINFO = "INSERT INTO SP_APP (TENANT_ID, APP_NAME, USER_STORE, USERNAME, " +
                                                     "DESCRIPTION, AUTH_TYPE, IS_USE_TENANT_DOMAIN_SUBJECT, ENABLE_AUTHORIZATION,IS_USE_USER_DOMAIN_SUBJECT, UUID) " +
                                                     "VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public static final String UPDATE_EXTENDED_BASIC_APPINFO = "UPDATE SP_APP SET APP_NAME=:APP_NAME;, " +
            "DESCRIPTION=:DESCRIPTION;, IS_SAAS_APP=:IS_SAAS_APP;, LOGIN_URL=:LOGIN_URL;, IMAGE_URL=:IMAGE_URL; WHERE TENANT_ID=:TENANT_ID; AND ID=:ID;";
    public static final String UPDATE_EXTENDED_BASIC_APPINFO_WITH_OWNER_UPDATE = "UPDATE SP_APP SET APP_NAME=:APP_NAME;," +
            " DESCRIPTION=:DESCRIPTION;, LOGIN_URL=:LOGIN_URL;, IMAGE_URL=:IMAGE_URL;, IS_SAAS_APP=:IS_SAAS_APP;, " +
            "USERNAME=:USERNAME;, USER_STORE=:USERNAME; WHERE TENANT_ID=:TENANT_ID; AND ID=:ID;";
    ...
    // TODO : fix this query
    public static final String LOAD_APP_NAMES_BY_TENANT = "SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, " +
            "LOGIN_URL FROM SP_APP WHERE TENANT_ID = ? ORDER BY ID DESC";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_MYSQL = "SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, " +
            "LOGIN_URL FROM SP_APP WHERE TENANT_ID = ? ORDER BY ID DESC LIMIT ?, ?";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_MYSQL = "SELECT ID, APP_NAME, DESCRIPTION , UUID, " +
            "IMAGE_URL, LOGIN_URL FROM SP_APP WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC LIMIT ?, ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_ORACLE =
            "SELECT ID, APP_NAME, DESCRIPTION , UUID, IMAGE_URL, LOGIN_URL FROM " +
                    "(SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, LOGIN_URL, TENANT_ID, rownum AS rnum FROM " +
                    "(SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, LOGIN_URL, TENANT_ID FROM SP_APP ORDER BY ID" +
                    " DESC) WHERE TENANT_ID = ? AND APP_NAME LIKE ? AND rownum <= ?) WHERE rnum > ?";

    public static final String LOAD_APP_NAMES_BY_TENANT_DB2SQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, LOGIN_URL FROM (SELECT ROW_NUMBER() OVER(ORDER BY ID DESC) AS rn,SP_APP.* " +
            "FROM SP_APP WHERE TENANT_ID = ?)WHERE rn BETWEEN ? AND ?";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_DB2SQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, LOGIN_URL FROM (SELECT ROW_NUMBER() OVER(ORDER BY ID DESC) AS rn,SP_APP.* " +
            "FROM SP_APP WHERE TENANT_ID = ? AND APP_NAME LIKE ?)WHERE rn BETWEEN ? AND ?";

    public static final String LOAD_APP_NAMES_BY_TENANT_MSSQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, LOGIN_URL FROM SP_APP " +
            "WHERE TENANT_ID = ? ORDER BY ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_MSSQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, LOGIN_URL FROM SP_APP " +
            "WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";

    public static final String LOAD_APP_NAMES_BY_TENANT_POSTGRESQL = "SELECT ID, APP_NAME, DESCRIPTION, UUID, " +
            "IMAGE_URL, LOGIN_URL FROM SP_APP " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_POSTGRESQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, LOGIN_URL FROM SP_APP " +
            "WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC LIMIT ? OFFSET ?";

    public static final String LOAD_APP_NAMES_BY_TENANT_INFORMIX = "SELECT SKIP ? FIRST ? ID, APP_NAME, " +
            "DESCRIPTION, UUID, IMAGE_URL, LOGIN_URL FROM SP_APP " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_INFORMIX = "SELECT SKIP ? FIRST ? ID, APP_NAME, " +
            "DESCRIPTION, UUID, IMAGE_URL, LOGIN_URL FROM SP_APP " +
            "WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC";
