...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT = "SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, " +
            "LOGIN_URL, TIME_CREATED, TIME_LAST_MODIFIED FROM SP_APP WHERE TENANT_ID = ? ORDER BY ID DESC";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME = "SELECT ID, APP_NAME, DESCRIPTION, UUID, " +
            "IMAGE_URL, LOGIN_URL, TIME_CREATED, TIME_LAST_MODIFIED FROM SP_APP " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_MYSQL = "SELECT ID, APP_NAME, DESCRIPTION, UUID, IMAGE_URL, " +
            "LOGIN_URL, TIME_CREATED, TIME_LAST_MODIFIED FROM SP_APP WHERE TENANT_ID = ? ORDER BY ID DESC LIMIT ?, ?";
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_MYSQL = "SELECT ID, APP_NAME, DESCRIPTION , UUID, " +
            "IMAGE_URL, LOGIN_URL, TIME_CREATED, TIME_LAST_MODIFIED FROM SP_APP " +
            "WHERE TENANT_ID = ? AND APP_NAME LIKE ? ORDER BY ID DESC LIMIT ?, ?";

    // TODO: fix for other DBs
