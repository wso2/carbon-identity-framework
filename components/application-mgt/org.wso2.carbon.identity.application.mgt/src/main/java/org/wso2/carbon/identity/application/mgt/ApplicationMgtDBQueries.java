...
public class ApplicationMgtDBQueries {
     ...
     */
    public static final String ADD_DEFAULT_SEQ = "INSERT INTO SP_DEFAULT_AUTH_SEQ(NAME, SEQ_CONTENT, TENANT_ID) " +
            "VALUES (?, ?, ?)";
    public static final String GET_DEFAULT_SEQ = "SELECT NAME, SEQ_CONTENT FROM SP_DEFAULT_AUTH_SEQ WHERE " +
            "TENANT_ID = ?";
    public static final String GET_DEFAULT_SEQ_INFO = "SELECT NAME FROM SP_DEFAULT_AUTH_SEQ WHERE " +
            "TENANT_ID = ?";
    public static final String GET_DEFAULT_SEQ_ID = "SELECT ID FROM SP_DEFAULT_AUTH_SEQ WHERE TENANT_ID = ?";
    public static final String UPDATE_DEFAULT_SEQ = "UPDATE SP_DEFAULT_AUTH_SEQ SET NAME = ?,SEQ_CONTENT = ? WHERE " +
            "TENANT_ID = ?";
