...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_ORACLE = "SELECT ID, APP_NAME, DESCRIPTION, " +
            ...
            "APP_NAME, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, INBOUND_AUTH_KEY, INBOUND_AUTH_TYPE, USERNAME, " +
            "USER_STORE, TENANT_ID, ROWNUM AS rn from (SELECT SP_APP.ID, SP_APP.APP_NAME, SP_APP.DESCRIPTION, " +
            "SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_INBOUND_AUTH.INBOUND_AUTH_KEY, " +
