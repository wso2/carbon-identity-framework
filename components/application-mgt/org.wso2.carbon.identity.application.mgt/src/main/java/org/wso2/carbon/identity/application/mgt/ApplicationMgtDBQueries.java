...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER = "SELECT SP_APP.ID, SP_APP.APP_NAME, " +
            "SP_APP.DESCRIPTION FROM SP_APP INNER JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_FILTER_INFORMIX = "SELECT SKIP ? FIRST ? SP_APP.ID, " +
            ...
            "SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP " +
            "JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? " +
