...
public class ApplicationMgtDBQueries {
    ...
    public static final String LOAD_APP_COUNT_BY_TENANT_AND_APP_NAME = "SELECT COUNT(SP_APP.APP_NAME) FROM SP_APP " +
            "INNER JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? " +
            "AND (%s) AND SP_APP.APP_NAME != ? ";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_MYSQL = "SELECT SP_APP.ID, SP_APP.APP_NAME, " +
            "SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_APP.USERNAME, " +
            "SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP " +
            "INNER JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? " +
            "AND (%s) AND SP_APP.APP_NAME != ? ORDER BY SP_APP.ID DESC LIMIT ?, ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_ORACLE = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, INBOUND_AUTH_KEY FROM (SELECT ID, " +
            "APP_NAME, DESCRIPTION, UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, INBOUND_AUTH_KEY, " +
            "ROWNUM AS rn from (SELECT SP_APP.ID, SP_APP.APP_NAME, SP_APP.DESCRIPTION, SP_APP.UUID, " +
            "SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID, " +
            "SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP JOIN SP_INBOUND_AUTH on SP_APP.ID = SP_INBOUND_AUTH.APP_ID " +
            "WHERE SP_APP.TENANT_ID = ? AND (%s) AND SP_APP.APP_NAME <> ? ORDER BY SP_APP.ID DESC) " +
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_DB2SQL = "SELECT ID, APP_NAME, DESCRIPTION, " +
            "UUID, IMAGE_URL, ACCESS_URL, USERNAME, USER_STORE, TENANT_ID, INBOUND_AUTH_KEY FROM (SELECT " +
            "SP_APP.ID, SP_APP.APP_NAME, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, " +
            "SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY, " +
            "ROW_NUMBER() OVER (ORDER BY SP_APP.ID DESC) AS rn FROM SP_APP JOIN SP_INBOUND_AUTH ON " +
            "SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? AND " +
            "(%s) AND SP_APP.APP_NAME <> ? ORDER BY SP_APP.ID DESC ) WHERE rn > ? AND rn <= ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_MSSQL = "SELECT SP_APP.ID, SP_APP.APP_NAME, " +
            "SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_APP.USERNAME, " +
            "SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP INNER JOIN " +
            "SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? AND " +
            "(%s) AND SP_APP.APP_NAME != ? ORDER BY SP_APP.ID DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_POSTGRESQL = "SELECT SP_APP.ID, " +
            "SP_APP.APP_NAME, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, " +
            "SP_APP.USERNAME, SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP " +
            "INNER JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? " +
            "AND (%s) AND SP_APP.APP_NAME != ? ORDER BY SP_APP.ID DESC LIMIT ? OFFSET ?";
    ...
    public static final String LOAD_APP_NAMES_BY_TENANT_AND_APP_NAME_INFORMIX = "SELECT SKIP ? FIRST ? SP_APP.ID, " +
            "SP_APP.APP_NAME, SP_APP.DESCRIPTION, SP_APP.UUID, SP_APP.IMAGE_URL, SP_APP.ACCESS_URL, SP_APP.USERNAME, " +
            "SP_APP.USER_STORE, SP_APP.TENANT_ID, SP_INBOUND_AUTH.INBOUND_AUTH_KEY FROM SP_APP " +
            "JOIN SP_INBOUND_AUTH ON SP_APP.ID = SP_INBOUND_AUTH.APP_ID WHERE SP_APP.TENANT_ID = ? AND (%s) " +
            "AND SP_APP.APP_NAME <> ? ORDER BY SP_APP.ID desc";
