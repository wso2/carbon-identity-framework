...
INSERT INTO IDP (TENANT_ID,NAME,IS_ENABLED,IS_PRIMARY,HOME_REALM_ID,IMAGE,CERTIFICATE,ALIAS,INBOUND_PROV_ENABLED,
    INBOUND_PROV_USER_STORE_ID,USER_CLAIM_URI,ROLE_CLAIM_URI,DESCRIPTION,DEFAULT_AUTHENTICATOR_NAME,
    DEFAULT_PRO_CONNECTOR_NAME,PROVISIONING_ROLE,IS_FEDERATION_HUB,IS_LOCAL_CLAIM_DIALECT,DISPLAY_NAME,IMAGE_URL,"UUID") VALUES
    (-1234,'LOCAL','1','1','localhost',NULL,0x5B5D,NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0','0',NULL,NULL,'8e193e0c-01bd-4100-88cd-bd4a5359bca5');
