...
public class AuthenticatorMgtExceptionBuilder {
    ...
    public enum AuthenticatorMgtError {
        ...
        ERROR_CODE_INVALID_DEFINED_BY_AUTH_PROVIDED("65005", "Error while adding local authenticator.",
                "Only system defined authenticators are allowed to add via this method."),
        ERROR_CODE_NO_AUTHENTICATOR_FOUND("65006", "No authenticator found.",
                "No authenticator found by given authenticator name: %s."),
        ERROR_CODE_NO_ACTION_ID_FOUND("65007", "No action id found.",
                "No action id found for the authenticator: %s."),
        ERROR_CODE_ADDING_ENDPOINT_CONFIG("65008", "Error while adding endpoint configurations.",
                "Error while adding endpoint configurations for the user defined local authenticator %s."),
        ERROR_CODE_UPDATING_ENDPOINT_CONFIG("65009", "Error while updating endpoint configurations.",
