...
public class ClusterCacheInvalidationRequest extends ClusteringMessage {
    ...
    public void execute(ConfigurationContext configurationContext) throws ClusteringFault {
        try {
            ...
            CacheInvalidationThreadLocal.setIsOriginatedFromAnotherNode(Boolean.TRUE);
            ...
            cache.remove(cacheInfo.cacheKey);
        } finally {
            CacheInvalidationThreadLocal.removeIsOriginatedFromAnotherNode();
