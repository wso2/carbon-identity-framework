...
public class IdentityApplicationConstants {
    ...
    public static final String APPLICATION_ENABLED_PROPERTY_NAME = "applicationEnabled";
    public static final String APPLICATION_ENABLED_DISPLAY_NAME = "Application Enabled";
