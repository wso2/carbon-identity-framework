...
public class IdentityApplicationConstants {
    ...
    public static final String APPLICATION_ACCESS_ENABLED_PROPERTY_NAME = "applicationAccessEnabled";
    public static final String APPLICATION_ACCESS_ENABLED_DISPLAY_NAME = "Application Access Enabled";
