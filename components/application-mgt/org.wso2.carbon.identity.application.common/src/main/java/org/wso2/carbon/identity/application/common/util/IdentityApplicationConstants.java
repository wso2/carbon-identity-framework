...
public class IdentityApplicationConstants {
    ...
    public static final String IS_ENHANCED_B2B_LOGIN_ENABLED_SP_PROPERTY_NAME = "isEnhancedB2BLoginEnabled";
    public static final String IS_ENHANCED_B2B_LOGIN_ENABLED_SP_PROPERTY_DISPLAY_NAME = "Is Enhanced B2B Login Enabled";
